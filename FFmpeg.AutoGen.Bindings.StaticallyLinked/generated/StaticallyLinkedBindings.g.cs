...
public static unsafe partial class StaticallyLinkedBindings
{
    ...
    public static extern int av_add_index_entry(_AVStream* @st, long @pos, long @timestamp, int @size, int @distance, int @flags);
    
    /// <summary>Add two rationals.</summary>
    /// <param name="b">First rational</param>
    /// <param name="c">Second rational</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVRational av_add_q(_AVRational @b, _AVRational @c);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern long av_add_stable(_AVRational @ts_tb, long @ts, _AVRational @inc_tb, long @inc);
    
    /// <summary>Returns the AVAlphaMode value for name or an AVError if not found.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVAlphaMode av_alpha_mode_from_name(    
    ...
    public static extern string av_alpha_mode_name(_AVAlphaMode @mode);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_append_packet(_AVIOContext* @s, _AVPacket* @pkt, int @size);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVAudioFifo* av_audio_fifo_alloc(_AVSampleFormat @sample_fmt, int @channels, int @nb_samples);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_audio_fifo_drain(_AVAudioFifo* @af, int @nb_samples);
    
    /// <summary>Free an AVAudioFifo.</summary>
    /// <param name="af">AVAudioFifo to free</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void av_audio_fifo_free(_AVAudioFifo* @af);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_audio_fifo_peek(_AVAudioFifo* @af, void** @data, int @nb_samples);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_audio_fifo_peek_at(_AVAudioFifo* @af, void** @data, int @nb_samples, int @offset);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_audio_fifo_read(_AVAudioFifo* @af, void** @data, int @nb_samples);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_audio_fifo_realloc(_AVAudioFifo* @af, int @nb_samples);
    
    /// <summary>Reset the AVAudioFifo buffer.</summary>
    /// <param name="af">AVAudioFifo to reset</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void av_audio_fifo_reset(_AVAudioFifo* @af);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_audio_fifo_size(_AVAudioFifo* @af);
    
    /// <summary>Get the current number of samples in the AVAudioFifo available for writing.</summary>
    /// <param name="af">the AVAudioFifo to query</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_audio_fifo_space(_AVAudioFifo* @af);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_audio_fifo_write(_AVAudioFifo* @af, void** @data, int @nb_samples);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVBSFList* av_bsf_list_alloc();
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_bsf_list_append(_AVBSFList* @lst, _AVBSFContext* @bsf);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_bsf_list_append2(_AVBSFList* @lst,     
    #if NETSTANDARD2_1_OR_GREATER
    [MarshalAs(UnmanagedType.LPUTF8Str)]
    #else
    [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))]
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_bsf_list_finalize(_AVBSFList** @lst, _AVBSFContext** @bsf);
    
    /// <summary>Free list of bitstream filters.</summary>
    /// <param name="lst">Pointer to pointer returned by av_bsf_list_alloc()</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void av_bsf_list_free(_AVBSFList** @lst);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_bsf_receive_packet(_AVBSFContext* @ctx, _AVPacket* @pkt);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVBufferRef* av_buffer_alloc(ulong @size);
    
    /// <summary>Same as av_buffer_alloc(), except the returned buffer will be initialized to zero.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVBufferRef* av_buffer_allocz(ulong @size);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVBufferRef* av_buffer_create(byte* @data, ulong @size, av_buffer_create_free_func @free, void* @opaque, int @flags);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void* av_buffer_get_opaque(_AVBufferRef* @buf);
    
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_buffer_get_ref_count(_AVBufferRef* @buf);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_buffer_is_writable(_AVBufferRef* @buf);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_buffer_make_writable(_AVBufferRef** @buf);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void* av_buffer_pool_buffer_get_opaque(_AVBufferRef* @ref);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVBufferRef* av_buffer_pool_get(_AVBufferPool* @pool);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVBufferPool* av_buffer_pool_init(ulong @size, av_buffer_pool_init_alloc_func @alloc);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVBufferPool* av_buffer_pool_init2(ulong @size, void* @opaque, av_buffer_pool_init2_alloc_func @alloc, av_buffer_pool_init2_pool_free_func @pool_free);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void av_buffer_pool_uninit(_AVBufferPool** @pool);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_buffer_realloc(_AVBufferRef** @buf, ulong @size);
    
    /// <summary>Create a new reference to an AVBuffer.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVBufferRef* av_buffer_ref(_AVBufferRef* @buf);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_buffer_replace(_AVBufferRef** @dst, _AVBufferRef* @src);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void av_buffer_unref(_AVBufferRef** @buf);
    
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVAlphaMode av_buffersink_get_alpha_mode(_AVFilterContext* @ctx);
    
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_buffersink_get_ch_layout(_AVFilterContext* @ctx, _AVChannelLayout* @ch_layout);
    
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_buffersink_get_channels(_AVFilterContext* @ctx);
    
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVColorRange av_buffersink_get_color_range(_AVFilterContext* @ctx);
    
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVColorSpace av_buffersink_get_colorspace(_AVFilterContext* @ctx);
    
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_buffersink_get_format(_AVFilterContext* @ctx);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_buffersink_get_frame(_AVFilterContext* @ctx, _AVFrame* @frame);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_buffersink_get_frame_flags(_AVFilterContext* @ctx, _AVFrame* @frame, int @flags);
    
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVRational av_buffersink_get_frame_rate(_AVFilterContext* @ctx);
    
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_buffersink_get_h(_AVFilterContext* @ctx);
    
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVBufferRef* av_buffersink_get_hw_frames_ctx(_AVFilterContext* @ctx);
    
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVRational av_buffersink_get_sample_aspect_ratio(_AVFilterContext* @ctx);
    
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_buffersink_get_sample_rate(_AVFilterContext* @ctx);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_buffersink_get_samples(_AVFilterContext* @ctx, _AVFrame* @frame, int @nb_samples);
    
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVFrameSideData** av_buffersink_get_side_data(_AVFilterContext* @ctx, int* @nb_side_data);
    
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVRational av_buffersink_get_time_base(_AVFilterContext* @ctx);
    
    /// <summary>Get the properties of the stream @{</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVMediaType av_buffersink_get_type(_AVFilterContext* @ctx);
    
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_buffersink_get_w(_AVFilterContext* @ctx);
    
    /// <summary>Set the frame size for an audio buffer sink.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void av_buffersink_set_frame_size(_AVFilterContext* @ctx, uint @frame_size);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_buffersrc_add_frame(_AVFilterContext* @ctx, _AVFrame* @frame);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_buffersrc_add_frame_flags(_AVFilterContext* @buffer_src, _AVFrame* @frame, int @flags);
    
    /// <summary>Close the buffer source after EOF.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_buffersrc_close(_AVFilterContext* @ctx, long @pts, uint @flags);
    
    /// <summary>Get the number of failed requests.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern uint av_buffersrc_get_nb_failed_requests(_AVFilterContext* @buffer_src);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_buffersrc_get_status(_AVFilterContext* @ctx);
    
    /// <summary>Allocate a new AVBufferSrcParameters instance. It should be freed by the caller with av_free().</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVBufferSrcParameters* av_buffersrc_parameters_alloc();
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_buffersrc_parameters_set(_AVFilterContext* @ctx, _AVBufferSrcParameters* @param);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_buffersrc_write_frame(_AVFilterContext* @ctx, _AVFrame* @frame);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_channel_description(byte* @buf, ulong @buf_size, _AVChannel @channel);
    
    /// <summary>bprint variant of av_channel_description().</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void av_channel_description_bprint(_AVBPrint* @bp, _AVChannel @channel_id);
    
    /// <summary>This is the inverse function of av_channel_name().</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVChannel av_channel_from_string(    
    #if NETSTANDARD2_1_OR_GREATER
    [MarshalAs(UnmanagedType.LPUTF8Str)]
    #else
    [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))]
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_channel_layout_ambisonic_order(_AVChannelLayout* @channel_layout);
    
    /// <summary>Get the channel with the given index in a channel layout.</summary>
    /// <param name="channel_layout">input channel layout</param>
    /// <param name="idx">index of the channel</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVChannel av_channel_layout_channel_from_index(_AVChannelLayout* @channel_layout, uint @idx);
    
    /// <summary>Get a channel described by the given string.</summary>
    /// <param name="channel_layout">input channel layout</param>
    /// <param name="name">string describing the channel to obtain</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVChannel av_channel_layout_channel_from_string(_AVChannelLayout* @channel_layout,     
    #if NETSTANDARD2_1_OR_GREATER
    [MarshalAs(UnmanagedType.LPUTF8Str)]
    #else
    [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))]
    ...
    /// <param name="channel_layout">input channel layout</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_channel_layout_check(_AVChannelLayout* @channel_layout);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_channel_layout_compare(_AVChannelLayout* @chl, _AVChannelLayout* @chl1);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_channel_layout_copy(_AVChannelLayout* @dst, _AVChannelLayout* @src);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_channel_layout_custom_init(_AVChannelLayout* @channel_layout, int @nb_channels);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void av_channel_layout_default(_AVChannelLayout* @ch_layout, int @nb_channels);
    ...
    /// <param name="buf_size">size in bytes of the buffer.</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_channel_layout_describe(_AVChannelLayout* @channel_layout, byte* @buf, ulong @buf_size);
    
    /// <summary>bprint variant of av_channel_layout_describe().</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_channel_layout_describe_bprint(_AVChannelLayout* @channel_layout, _AVBPrint* @bp);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_channel_layout_from_mask(_AVChannelLayout* @channel_layout, ulong @mask);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_channel_layout_from_string(_AVChannelLayout* @channel_layout,     
    #if NETSTANDARD2_1_OR_GREATER
    [MarshalAs(UnmanagedType.LPUTF8Str)]
    #else
    [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))]
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_channel_layout_index_from_channel(_AVChannelLayout* @channel_layout, _AVChannel @channel);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_channel_layout_index_from_string(_AVChannelLayout* @channel_layout,     
    #if NETSTANDARD2_1_OR_GREATER
    [MarshalAs(UnmanagedType.LPUTF8Str)]
    #else
    [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))]
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_channel_layout_retype(_AVChannelLayout* @channel_layout, _AVChannelOrder @order, int @flags);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVChannelLayout* av_channel_layout_standard(void** @opaque);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern ulong av_channel_layout_subset(_AVChannelLayout* @channel_layout, ulong @mask);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void av_channel_layout_uninit(_AVChannelLayout* @channel_layout);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_channel_name(byte* @buf, ulong @buf_size, _AVChannel @channel);
    
    /// <summary>bprint variant of av_channel_name().</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void av_channel_name_bprint(_AVBPrint* @bp, _AVChannel @channel_id);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_chroma_location_enum_to_pos(int* @xpos, int* @ypos, _AVChromaLocation @pos);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(ConstCharPtrMarshaler))]
    public static extern string av_chroma_location_name(_AVChromaLocation @location);
    
    /// <summary>Converts swscale x/y chroma position to AVChromaLocation.</summary>
    /// <param name="xpos">horizontal chroma sample position</param>
    /// <param name="ypos">vertical   chroma sample position</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVChromaLocation av_chroma_location_pos_to_enum(int @xpos, int @ypos);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVCodecID av_codec_get_id(_AVCodecTag** @tags, uint @tag);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern uint av_codec_get_tag(_AVCodecTag** @tags, _AVCodecID @id);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_codec_get_tag2(_AVCodecTag** @tags, _AVCodecID @id, uint* @tag);
    
    /// <summary>Returns a non-zero number if codec is a decoder, zero otherwise</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_codec_is_decoder(_AVCodec* @codec);
    
    /// <summary>Returns a non-zero number if codec is an encoder, zero otherwise</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_codec_is_encoder(_AVCodec* @codec);
    
    /// <summary>Iterate over all registered codecs.</summary>
    /// <param name="opaque">a pointer where libavcodec will store the iteration state. Must point to NULL to start the iteration.</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVCodec* av_codec_iterate(void** @opaque);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(ConstCharPtrMarshaler))]
    public static extern string av_color_primaries_name(_AVColorPrimaries @primaries);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(ConstCharPtrMarshaler))]
    public static extern string av_color_range_name(_AVColorRange @range);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(ConstCharPtrMarshaler))]
    public static extern string av_color_space_name(_AVColorSpace @space);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(ConstCharPtrMarshaler))]
    public static extern string av_color_transfer_name(_AVColorTransferCharacteristic @transfer);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_compare_ts(long @ts_a, _AVRational @tb_a, long @ts_b, _AVRational @tb_b);
    
    /// <summary>Allocate an AVContainerFifo instance for AVPacket.</summary>
    /// <param name="flags">currently unused</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVContainerFifo* av_container_fifo_alloc_avpacket(uint @flags);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVContentLightMetadata* av_content_light_metadata_alloc(ulong* @size);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVContentLightMetadata* av_content_light_metadata_create_side_data(_AVFrame* @frame);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVCPBProperties* av_cpb_properties_alloc(ulong* @size);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVRational av_d2q(double @d, int @max);
    
    /// <summary>Allocate an AVD3D11VAContext.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVD3D11VAContext* av_d3d11va_alloc_context();
    
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVClassCategory av_default_get_category(void* @ptr);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVInputFormat* av_demuxer_iterate(void** @opaque);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_dict_copy(_AVDictionary** @dst, _AVDictionary* @src, int @flags);
    
    /// <summary>Get number of entries in dictionary.</summary>
    /// <param name="m">dictionary</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_dict_count(_AVDictionary* @m);
    
    /// <summary>Free all the memory allocated for an AVDictionary struct and all keys and values.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void av_dict_free(_AVDictionary** @m);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVDictionaryEntry* av_dict_get(_AVDictionary* @m,     
    #if NETSTANDARD2_1_OR_GREATER
    [MarshalAs(UnmanagedType.LPUTF8Str)]
    #else
    [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))]
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_dict_get_string(_AVDictionary* @m, byte** @buffer, byte @key_val_sep, byte @pairs_sep);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVDictionaryEntry* av_dict_iterate(_AVDictionary* @m, _AVDictionaryEntry* @prev);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_dict_parse_string(_AVDictionary** @pm,     
    #if NETSTANDARD2_1_OR_GREATER
    [MarshalAs(UnmanagedType.LPUTF8Str)]
    #else
    [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))]
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_dict_set(_AVDictionary** @pm,     
    #if NETSTANDARD2_1_OR_GREATER
    [MarshalAs(UnmanagedType.LPUTF8Str)]
    #else
    [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))]
    ...
    /// <param name="c">Second rational</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVRational av_div_q(_AVRational @b, _AVRational @c);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void av_dump_format(_AVFormatContext* @ic, int @index,     
    #if NETSTANDARD2_1_OR_GREATER
    [MarshalAs(UnmanagedType.LPUTF8Str)]
    #else
    [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))]
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVDynamicHDRPlus* av_dynamic_hdr_plus_alloc(ulong* @size);
    
    /// <summary>Allocate a complete AVDynamicHDRPlus and add it to the frame.</summary>
    /// <param name="frame">The frame which side data is added to.</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVDynamicHDRPlus* av_dynamic_hdr_plus_create_side_data(_AVFrame* @frame);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_dynamic_hdr_plus_from_t35(_AVDynamicHDRPlus* @s, byte* @data, ulong @size);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVFilter* av_filter_iterate(void** @opaque);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVPixelFormat av_find_best_pix_fmt_of_2(_AVPixelFormat @dst_pix_fmt1, _AVPixelFormat @dst_pix_fmt2, _AVPixelFormat @src_pix_fmt, int @has_alpha, int* @loss_ptr);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_find_best_stream(_AVFormatContext* @ic, _AVMediaType @type, int @wanted_stream_nb, int @related_stream, _AVCodec** @decoder_ret, int @flags);
    
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_find_default_stream_index(_AVFormatContext* @s);
    
    /// <summary>Find AVInputFormat based on the short name of the input format.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVInputFormat* av_find_input_format(    
    #if NETSTANDARD2_1_OR_GREATER
    [MarshalAs(UnmanagedType.LPUTF8Str)]
    #else
    [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))]
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_find_nearest_q_idx(_AVRational @q, _AVRational* @q_list);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVProgram* av_find_program_from_stream(_AVFormatContext* @ic, _AVProgram* @last, int @s);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVFrame* av_frame_alloc();
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_frame_apply_cropping(_AVFrame* @frame, int @flags);
    
    /// <summary>Create a new frame that references the same data as src.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVFrame* av_frame_clone(_AVFrame* @src);
    
    /// <summary>Copy the frame data from src to dst.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_frame_copy(_AVFrame* @dst, _AVFrame* @src);
    
    /// <summary>Copy only &quot;metadata&quot; fields from src to dst.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_frame_copy_props(_AVFrame* @dst, _AVFrame* @src);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void av_frame_free(_AVFrame** @frame);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_frame_get_buffer(_AVFrame* @frame, int @align);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVBufferRef* av_frame_get_plane_buffer(_AVFrame* @frame, int @plane);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVFrameSideData* av_frame_get_side_data(_AVFrame* @frame, _AVFrameSideDataType @type);
    
    /// <summary>Check if the frame data is writable.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_frame_is_writable(_AVFrame* @frame);
    
    /// <summary>Ensure that the frame data is writable, avoiding data copy if possible.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_frame_make_writable(_AVFrame* @frame);
    
    /// <summary>Move everything contained in src to dst and reset src.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void av_frame_move_ref(_AVFrame* @dst, _AVFrame* @src);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVFrameSideData* av_frame_new_side_data(_AVFrame* @frame, _AVFrameSideDataType @type, ulong @size);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVFrameSideData* av_frame_new_side_data_from_buf(_AVFrame* @frame, _AVFrameSideDataType @type, _AVBufferRef* @buf);
    
    /// <summary>Set up a new reference to the data described by the source frame.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_frame_ref(_AVFrame* @dst, _AVFrame* @src);
    
    /// <summary>Remove and free all side data instances of the given type.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void av_frame_remove_side_data(_AVFrame* @frame, _AVFrameSideDataType @type);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_frame_replace(_AVFrame* @dst, _AVFrame* @src);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVFrameSideData* av_frame_side_data_add(_AVFrameSideData*** @sd, int* @nb_sd, _AVFrameSideDataType @type, _AVBufferRef** @buf, uint @flags);
    ...
    /// <param name="flags">Some combination of AV_FRAME_SIDE_DATA_FLAG_* flags, or 0.</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_frame_side_data_clone(_AVFrameSideData*** @sd, int* @nb_sd, _AVFrameSideData* @src, uint @flags);
    
    /// <summary>Returns side data descriptor corresponding to a given side data type, NULL when not available.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVSideDataDescriptor* av_frame_side_data_desc(_AVFrameSideDataType @type);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void av_frame_side_data_free(_AVFrameSideData*** @sd, int* @nb_sd);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVFrameSideData* av_frame_side_data_get_c(_AVFrameSideData** @sd, int @nb_sd, _AVFrameSideDataType @type);
    
    /// <summary>Returns a string identifying the side data type</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(ConstCharPtrMarshaler))]
    public static extern string av_frame_side_data_name(_AVFrameSideDataType @type);
    ...
    /// <param name="flags">Some combination of AV_FRAME_SIDE_DATA_FLAG_* flags, or 0.</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVFrameSideData* av_frame_side_data_new(_AVFrameSideData*** @sd, int* @nb_sd, _AVFrameSideDataType @type, ulong @size, uint @flags);
    
    /// <summary>Remove and free all side data instances of the given type from an array.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void av_frame_side_data_remove(_AVFrameSideData*** @sd, int* @nb_sd, _AVFrameSideDataType @type);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void av_frame_side_data_remove_by_props(_AVFrameSideData*** @sd, int* @nb_sd, int @props);
    
    /// <summary>Unreference all the buffers referenced by frame and reset the frame fields.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void av_frame_unref(_AVFrame* @frame);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVRational av_gcd_q(_AVRational @a, _AVRational @b, int @max_den, _AVRational @def);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVSampleFormat av_get_alt_sample_fmt(_AVSampleFormat @sample_fmt, int @planar);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_get_bits_per_pixel(_AVPixFmtDescriptor* @pixdesc);
    
    /// <summary>Return codec bits per sample.</summary>
    /// <param name="codec_id">the codec</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_get_bits_per_sample(_AVCodecID @codec_id);
    
    /// <summary>Return number of bytes per sample.</summary>
    /// <param name="sample_fmt">the sample format</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_get_bytes_per_sample(_AVSampleFormat @sample_fmt);
    ...
    /// <param name="codec_id">the codec</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_get_exact_bits_per_sample(_AVCodecID @codec_id);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(ConstCharPtrMarshaler))]
    public static extern string av_get_media_type_string(_AVMediaType @media_type);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_get_output_timestamp(_AVFormatContext* @s, int @stream, long* @dts, long* @wall);
    
    /// <summary>Get the packed alternative form of the given sample format.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVSampleFormat av_get_packed_sample_fmt(_AVSampleFormat @sample_fmt);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_get_packet(_AVIOContext* @s, _AVPacket* @pkt, int @size);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_get_padded_bits_per_pixel(_AVPixFmtDescriptor* @pixdesc);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVCodecID av_get_pcm_codec(_AVSampleFormat @fmt, int @be);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern byte av_get_picture_type_char(_AVPictureType @pict_type);
    
    /// <summary>Return the pixel format corresponding to name.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVPixelFormat av_get_pix_fmt(    
    #if NETSTANDARD2_1_OR_GREATER
    [MarshalAs(UnmanagedType.LPUTF8Str)]
    #else
    [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))]
    ...
    /// <param name="has_alpha">Whether the source pixel format alpha channel is used.</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_get_pix_fmt_loss(_AVPixelFormat @dst_pix_fmt, _AVPixelFormat @src_pix_fmt, int @has_alpha);
    
    /// <summary>Return the short name for a pixel format, NULL in case pix_fmt is unknown.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(ConstCharPtrMarshaler))]
    public static extern string av_get_pix_fmt_name(_AVPixelFormat @pix_fmt);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern byte* av_get_pix_fmt_string(byte* @buf, int @buf_size, _AVPixelFormat @pix_fmt);
    
    /// <summary>Get the planar alternative form of the given sample format.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVSampleFormat av_get_planar_sample_fmt(_AVSampleFormat @sample_fmt);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(ConstCharPtrMarshaler))]
    public static extern string av_get_profile_name(_AVCodec* @codec, int @profile);
    
    /// <summary>Return a sample format corresponding to name, or AV_SAMPLE_FMT_NONE on error.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVSampleFormat av_get_sample_fmt(    
    #if NETSTANDARD2_1_OR_GREATER
    [MarshalAs(UnmanagedType.LPUTF8Str)]
    #else
    [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))]
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(ConstCharPtrMarshaler))]
    public static extern string av_get_sample_fmt_name(_AVSampleFormat @sample_fmt);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern byte* av_get_sample_fmt_string(byte* @buf, int @buf_size, _AVSampleFormat @sample_fmt);
    
    /// <summary>Return the fractional representation of the internal time base.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVRational av_get_time_base_q();
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_grow_packet(_AVPacket* @pkt, int @grow_by);
    
    /// <summary>Guess the codec ID based upon muxer and filename.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVCodecID av_guess_codec(_AVOutputFormat* @fmt,     
    #if NETSTANDARD2_1_OR_GREATER
    [MarshalAs(UnmanagedType.LPUTF8Str)]
    #else
    [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))]
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVOutputFormat* av_guess_format(    
    #if NETSTANDARD2_1_OR_GREATER
    [MarshalAs(UnmanagedType.LPUTF8Str)]
    #else
    [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))]
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVRational av_guess_frame_rate(_AVFormatContext* @ctx, _AVStream* @stream, _AVFrame* @frame);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVRational av_guess_sample_aspect_ratio(_AVFormatContext* @format, _AVStream* @stream, _AVFrame* @frame);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void av_hex_dump(__iobuf* @f, byte* @buf, int @size);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVBufferRef* av_hwdevice_ctx_alloc(_AVHWDeviceType @type);
    ...
    /// <param name="flags">currently unused</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_hwdevice_ctx_create(_AVBufferRef** @device_ctx, _AVHWDeviceType @type,     
    #if NETSTANDARD2_1_OR_GREATER
    [MarshalAs(UnmanagedType.LPUTF8Str)]
    #else
    [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))]
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_hwdevice_ctx_create_derived(_AVBufferRef** @dst_ctx, _AVHWDeviceType @type, _AVBufferRef* @src_ctx, int @flags);
    ...
    /// <param name="flags">Currently unused; should be set to zero.</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_hwdevice_ctx_create_derived_opts(_AVBufferRef** @dst_ctx, _AVHWDeviceType @type, _AVBufferRef* @src_ctx, _AVDictionary* @options, int @flags);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_hwdevice_ctx_init(_AVBufferRef* @ref);
    
    /// <summary>Look up an AVHWDeviceType by name.</summary>
    /// <param name="name">String name of the device type (case-insensitive).</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVHWDeviceType av_hwdevice_find_type_by_name(    
    #if NETSTANDARD2_1_OR_GREATER
    [MarshalAs(UnmanagedType.LPUTF8Str)]
    #else
    [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))]
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVHWFramesConstraints* av_hwdevice_get_hwframe_constraints(_AVBufferRef* @ref, void* @hwconfig);
    
    /// <summary>Get the string name of an AVHWDeviceType.</summary>
    /// <param name="type">Type from enum AVHWDeviceType.</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(ConstCharPtrMarshaler))]
    public static extern string av_hwdevice_get_type_name(_AVHWDeviceType @type);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void* av_hwdevice_hwconfig_alloc(_AVBufferRef* @device_ctx);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVHWDeviceType av_hwdevice_iterate_types(_AVHWDeviceType @prev);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void av_hwframe_constraints_free(_AVHWFramesConstraints** @constraints);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVBufferRef* av_hwframe_ctx_alloc(_AVBufferRef* @device_ctx);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_hwframe_ctx_create_derived(_AVBufferRef** @derived_frame_ctx, _AVPixelFormat @format, _AVBufferRef* @derived_device_ctx, _AVBufferRef* @source_frame_ctx, int @flags);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_hwframe_ctx_init(_AVBufferRef* @ref);
    ...
    /// <param name="flags">currently unused, should be set to zero</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_hwframe_get_buffer(_AVBufferRef* @hwframe_ctx, _AVFrame* @frame, int @flags);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_hwframe_map(_AVFrame* @dst, _AVFrame* @src, int @flags);
    ...
    /// <param name="flags">currently unused, should be set to zero</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_hwframe_transfer_data(_AVFrame* @dst, _AVFrame* @src, int @flags);
    ...
    /// <param name="flags">currently unused, should be set to zero</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_hwframe_transfer_get_formats(_AVBufferRef* @hwframe_ctx, _AVHWFrameTransferDirection @dir, _AVPixelFormat** @formats, int @flags);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_image_alloc(ref byte_ptr4 @pointers, ref int4 @linesizes, int @w, int @h, _AVPixelFormat @pix_fmt, int @align);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_image_check_sar(uint @w, uint @h, _AVRational @sar);
    ...
    /// <param name="log_ctx">the parent logging context, it may be NULL</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_image_check_size2(uint @w, uint @h, long @max_pixels, _AVPixelFormat @pix_fmt, int @log_offset, void* @log_ctx);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void av_image_copy(ref byte_ptr4 @dst_data, in int4 @dst_linesizes, in byte_ptr4 @src_data, in int4 @src_linesizes, _AVPixelFormat @pix_fmt, int @width, int @height);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_image_copy_to_buffer(byte* @dst, int @dst_size, in byte_ptr4 @src_data, in int4 @src_linesize, _AVPixelFormat @pix_fmt, int @width, int @height, int @align);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void av_image_copy_uc_from(ref byte_ptr4 @dst_data, in long4 @dst_linesizes, in byte_ptr4 @src_data, in long4 @src_linesizes, _AVPixelFormat @pix_fmt, int @width, int @height);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_image_fill_arrays(ref byte_ptr4 @dst_data, ref int4 @dst_linesize, byte* @src, _AVPixelFormat @pix_fmt, int @width, int @height, int @align);
    ...
    /// <param name="height">the height of the image in pixels</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_image_fill_black(ref byte_ptr4 @dst_data, in long4 @dst_linesize, _AVPixelFormat @pix_fmt, _AVColorRange @range, int @width, int @height);
    ...
    /// <param name="flags">currently unused</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_image_fill_color(ref byte_ptr4 @dst_data, in long4 @dst_linesize, _AVPixelFormat @pix_fmt, in uint4 @color, int @width, int @height, int @flags);
    ...
    /// <param name="width">width of the image in pixels</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_image_fill_linesizes(ref int4 @linesizes, _AVPixelFormat @pix_fmt, int @width);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void av_image_fill_max_pixsteps(ref int4 @max_pixsteps, ref int4 @max_pixstep_comps, _AVPixFmtDescriptor* @pixdesc);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_image_fill_plane_sizes(ref ulong4 @size, _AVPixelFormat @pix_fmt, int @height, in long4 @linesizes);
    ...
    /// <param name="linesizes">the array containing the linesize for each plane, should be filled by av_image_fill_linesizes()</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_image_fill_pointers(ref byte_ptr4 @data, _AVPixelFormat @pix_fmt, int @height, byte* @ptr, in int4 @linesizes);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_image_get_buffer_size(_AVPixelFormat @pix_fmt, int @width, int @height, int @align);
    
    /// <summary>Compute the size of an image line with format pix_fmt and width width for the plane plane.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_image_get_linesize(_AVPixelFormat @pix_fmt, int @width, int @plane);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_index_search_timestamp(_AVStream* @st, long @timestamp, int @flags);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void av_init_packet(_AVPacket* @pkt);
    
    /// <summary>Audio input devices iterator.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVInputFormat* av_input_audio_device_next(_AVInputFormat* @d);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_interleaved_write_frame(_AVFormatContext* @s, _AVPacket* @pkt);
    
    /// <summary>Write an uncoded frame to an output media file.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_interleaved_write_uncoded_frame(_AVFormatContext* @s, int @stream_index, _AVFrame* @frame);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVMasteringDisplayMetadata* av_mastering_display_metadata_alloc();
    
    /// <summary>Allocate an AVMasteringDisplayMetadata structure and set its fields to default values. The resulting struct can be freed using av_freep().</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVMasteringDisplayMetadata* av_mastering_display_metadata_alloc_size(ulong* @size);
    
    /// <summary>Allocate a complete AVMasteringDisplayMetadata and add it to the frame.</summary>
    /// <param name="frame">The frame which side data is added to.</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVMasteringDisplayMetadata* av_mastering_display_metadata_create_side_data(_AVFrame* @frame);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_mime_codec_str(_AVCodecParameters* @par, _AVRational @frame_rate, _AVBPrint* @out);
    
    /// <summary>Multiply two rationals.</summary>
    /// <param name="b">First rational</param>
    /// <param name="c">Second rational</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVRational av_mul_q(_AVRational @b, _AVRational @c);
    
    /// <summary>Iterate over all registered muxers.</summary>
    /// <param name="opaque">a pointer where libavformat will store the iteration state. Must point to NULL to start the iteration.</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVOutputFormat* av_muxer_iterate(void** @opaque);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_nearer_q(_AVRational @q, _AVRational @q1, _AVRational @q2);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_new_packet(_AVPacket* @pkt, int @size);
    
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVProgram* av_new_program(_AVFormatContext* @s, int @id);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVClass* av_opt_child_class_iterate(_AVClass* @parent, void** @iter);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_opt_eval_double(void* @obj, _AVOption* @o,     
    #if NETSTANDARD2_1_OR_GREATER
    [MarshalAs(UnmanagedType.LPUTF8Str)]
    #else
    [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))]
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_opt_eval_flags(void* @obj, _AVOption* @o,     
    #if NETSTANDARD2_1_OR_GREATER
    [MarshalAs(UnmanagedType.LPUTF8Str)]
    #else
    [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))]
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVOption* av_opt_find(void* @obj,     
    #if NETSTANDARD2_1_OR_GREATER
    [MarshalAs(UnmanagedType.LPUTF8Str)]
    #else
    [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))]
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void av_opt_freep_ranges(_AVOptionRanges** @ranges);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_opt_is_set_to_default(void* @obj, _AVOption* @o);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_opt_query_ranges(_AVOptionRanges** @p0, void* @obj,     
    #if NETSTANDARD2_1_OR_GREATER
    [MarshalAs(UnmanagedType.LPUTF8Str)]
    #else
    [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))]
    ...
    /// <param name="flags">is a bitmask of flags, undefined flags should not be set and should be ignored AV_OPT_SEARCH_FAKE_OBJ indicates that the obj is a double pointer to a AVClass instead of a full instance AV_OPT_MULTI_COMPONENT_RANGE indicates that function may return more than one component,</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_opt_query_ranges_default(_AVOptionRanges** @p0, void* @obj,     
    #if NETSTANDARD2_1_OR_GREATER
    [MarshalAs(UnmanagedType.LPUTF8Str)]
    #else
    [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))]
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_opt_set_dict(void* @obj, _AVDictionary** @options);
    ...
    /// <param name="search_flags">A combination of AV_OPT_SEARCH_*.</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_opt_set_dict2(void* @obj, _AVDictionary** @options, int @search_flags);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVOutputFormat* av_output_audio_device_next(_AVOutputFormat* @d);
    
    /// <summary>Video output devices iterator.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVOutputFormat* av_output_video_device_next(_AVOutputFormat* @d);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_packet_add_side_data(_AVPacket* @pkt, _AVPacketSideDataType @type, byte* @data, ulong @size);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVPacket* av_packet_alloc();
    
    /// <summary>Create a new packet that references the same data as src.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVPacket* av_packet_clone(_AVPacket* @src);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_packet_copy_props(_AVPacket* @dst, _AVPacket* @src);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void av_packet_free(_AVPacket** @pkt);
    
    /// <summary>Convenience function to free all the side data stored. All the other fields stay untouched.</summary>
    /// <param name="pkt">packet</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void av_packet_free_side_data(_AVPacket* @pkt);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_packet_from_data(_AVPacket* @pkt, byte* @data, int @size);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern byte* av_packet_get_side_data(_AVPacket* @pkt, _AVPacketSideDataType @type, ulong* @size);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_packet_make_refcounted(_AVPacket* @pkt);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_packet_make_writable(_AVPacket* @pkt);
    
    /// <summary>Move every field in src to dst and reset src.</summary>
    /// <param name="dst">Destination packet</param>
    /// <param name="src">Source packet, will be reset</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void av_packet_move_ref(_AVPacket* @dst, _AVPacket* @src);
    ...
    /// <param name="size">side information size</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern byte* av_packet_new_side_data(_AVPacket* @pkt, _AVPacketSideDataType @type, ulong @size);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern byte* av_packet_pack_dictionary(_AVDictionary* @dict, ulong* @size);
    ...
    /// <param name="src">Source packet</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_packet_ref(_AVPacket* @dst, _AVPacket* @src);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void av_packet_rescale_ts(_AVPacket* @pkt, _AVRational @tb_src, _AVRational @tb_dst);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_packet_shrink_side_data(_AVPacket* @pkt, _AVPacketSideDataType @type, ulong @size);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVPacketSideData* av_packet_side_data_add(_AVPacketSideData** @sd, int* @nb_sd, _AVPacketSideDataType @type, void* @data, ulong @size, int @flags);
    
    /// <summary>Convenience function to free all the side data stored in an array, and the array itself.</summary>
    /// <param name="sd">pointer to array of side data to free. Will be set to NULL upon return.</param>
    /// <param name="nb_sd">pointer to an integer containing the number of entries in the array. Will be set to 0 upon return.</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void av_packet_side_data_free(_AVPacketSideData** @sd, int* @nb_sd);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_packet_side_data_from_frame(_AVPacketSideData** @sd, int* @nb_sd, _AVFrameSideData* @src, uint @flags);
    ...
    /// <param name="type">desired side information type</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVPacketSideData* av_packet_side_data_get(_AVPacketSideData* @sd, int @nb_sd, _AVPacketSideDataType @type);
    
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(ConstCharPtrMarshaler))]
    public static extern string av_packet_side_data_name(_AVPacketSideDataType @type);
    ...
    /// <param name="flags">currently unused. Must be zero</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVPacketSideData* av_packet_side_data_new(_AVPacketSideData** @psd, int* @pnb_sd, _AVPacketSideDataType @type, ulong @size, int @flags);
    ...
    /// <param name="type">side information type</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void av_packet_side_data_remove(_AVPacketSideData* @sd, int* @nb_sd, _AVPacketSideDataType @type);
    ...
    /// <param name="flags">Some combination of AV_FRAME_SIDE_DATA_FLAG_* flags, or 0.</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_packet_side_data_to_frame(_AVFrameSideData*** @sd, int* @nb_sd, _AVPacketSideData* @src, uint @flags);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_packet_unpack_dictionary(byte* @data, ulong @size, _AVDictionary** @dict);
    
    /// <summary>Wipe the packet.</summary>
    /// <param name="pkt">The packet to be unreferenced.</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void av_packet_unref(_AVPacket* @pkt);
    ...
    /// <param name="opaque">a pointer where libavcodec will store the iteration state. Must point to NULL to start the iteration.</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVCodecParser* av_parser_iterate(void** @opaque);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_parser_parse2(_AVCodecParserContext* @s, _AVCodecContext* @avctx, byte** @poutbuf, int* @poutbuf_size, byte* @buf, int @buf_size, long @pts, long @dts, long @pos);
    
    /// <summary>Returns number of planes in pix_fmt, a negative AVERROR if pix_fmt is not a valid pixel format.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_pix_fmt_count_planes(_AVPixelFormat @pix_fmt);
    
    /// <summary>Returns a pixel format descriptor for provided pixel format or NULL if this pixel format is unknown.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVPixFmtDescriptor* av_pix_fmt_desc_get(_AVPixelFormat @pix_fmt);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVPixelFormat av_pix_fmt_desc_get_id(_AVPixFmtDescriptor* @desc);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVPixFmtDescriptor* av_pix_fmt_desc_next(_AVPixFmtDescriptor* @prev);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_pix_fmt_get_chroma_sub_sample(_AVPixelFormat @pix_fmt, int* @h_shift, int* @v_shift);
    
    /// <summary>Utility function to swap the endianness of a pixel format.</summary>
    /// <param name="pix_fmt">the pixel format</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVPixelFormat av_pix_fmt_swap_endianness(_AVPixelFormat @pix_fmt);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void av_pkt_dump_log2(void* @avcl, int @level, _AVPacket* @pkt, int @dump_payload, _AVStream* @st);
    ...
    /// <param name="st">AVStream that the packet belongs to</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void av_pkt_dump2(__iobuf* @f, _AVPacket* @pkt, int @dump_payload, _AVStream* @st);
    
    /// <summary>Like av_probe_input_buffer2() but returns 0 on success</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_probe_input_buffer(_AVIOContext* @pb, _AVInputFormat** @fmt,     
    #if NETSTANDARD2_1_OR_GREATER
    [MarshalAs(UnmanagedType.LPUTF8Str)]
    #else
    [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))]
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_probe_input_buffer2(_AVIOContext* @pb, _AVInputFormat** @fmt,     
    #if NETSTANDARD2_1_OR_GREATER
    [MarshalAs(UnmanagedType.LPUTF8Str)]
    #else
    [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))]
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVInputFormat* av_probe_input_format(_AVProbeData* @pd, int @is_opened);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVInputFormat* av_probe_input_format2(_AVProbeData* @pd, int @is_opened, int* @score_max);
    
    /// <summary>Guess the file format.</summary>
    /// <param name="is_opened">Whether the file is already opened; determines whether demuxers with or without AVFMT_NOFILE are probed.</param>
    /// <param name="score_ret">The score of the best detection.</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVInputFormat* av_probe_input_format3(_AVProbeData* @pd, int @is_opened, int* @score_ret);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern uint av_q2intfloat(_AVRational @q);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_read_frame(_AVFormatContext* @s, _AVPacket* @pkt);
    
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void av_read_image_line(ushort* @dst, in byte_ptr4 @data, in int4 @linesize, _AVPixFmtDescriptor* @desc, int @x, int @y, int @c, int @w, int @read_pal_component);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void av_read_image_line2(void* @dst, in byte_ptr4 @data, in int4 @linesize, _AVPixFmtDescriptor* @desc, int @x, int @y, int @c, int @w, int @read_pal_component, int @dst_element_size);
    
    /// <summary>Pause a network-based stream (e.g. RTSP stream).</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_read_pause(_AVFormatContext* @s);
    
    /// <summary>Start playing a network-based stream (e.g. RTSP stream) at the current position.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_read_play(_AVFormatContext* @s);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern long av_rescale_delta(_AVRational @in_tb, long @in_ts, _AVRational @fs_tb, int @duration, long* @last, _AVRational @out_tb);
    
    /// <summary>Rescale a 64-bit integer by 2 rational numbers.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern long av_rescale_q(long @a, _AVRational @bq, _AVRational @cq);
    
    /// <summary>Rescale a 64-bit integer by 2 rational numbers with specified rounding.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern long av_rescale_q_rnd(long @a, _AVRational @bq, _AVRational @cq, _AVRounding @rnd);
    
    /// <summary>Rescale a 64-bit integer with specified rounding.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern long av_rescale_rnd(long @a, long @b, long @c, _AVRounding @rnd);
    
    /// <summary>Check if the sample format is planar.</summary>
    /// <param name="sample_fmt">the sample format to inspect</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_sample_fmt_is_planar(_AVSampleFormat @sample_fmt);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_samples_alloc(byte** @audio_data, int* @linesize, int @nb_channels, int @nb_samples, _AVSampleFormat @sample_fmt, int @align);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_samples_alloc_array_and_samples(byte*** @audio_data, int* @linesize, int @nb_channels, int @nb_samples, _AVSampleFormat @sample_fmt, int @align);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_samples_copy(byte** @dst, byte** @src, int @dst_offset, int @src_offset, int @nb_samples, int @nb_channels, _AVSampleFormat @sample_fmt);
    ...
    /// <param name="align">buffer size alignment (0 = default, 1 = no alignment)</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_samples_fill_arrays(byte** @audio_data, int* @linesize, byte* @buf, int @nb_channels, int @nb_samples, _AVSampleFormat @sample_fmt, int @align);
    ...
    /// <param name="align">buffer size alignment (0 = default, 1 = no alignment)</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_samples_get_buffer_size(int* @linesize, int @nb_channels, int @nb_samples, _AVSampleFormat @sample_fmt, int @align);
    ...
    /// <param name="sample_fmt">audio sample format</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_samples_set_silence(byte** @audio_data, int @offset, int @nb_samples, int @nb_channels, _AVSampleFormat @sample_fmt);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_sdp_create(_AVFormatContext** @ac, int @n_files, byte* @buf, int @size);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_seek_frame(_AVFormatContext* @s, int @stream_index, long @timestamp, int @flags);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void av_shrink_packet(_AVPacket* @pkt, int @size);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVClass* av_stream_group_get_class();
    ...
    /// <param name="c">Second rational</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVRational av_sub_q(_AVRational @b, _AVRational @c);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_timecode_check_frame_rate(_AVRational @rate);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern uint av_timecode_get_smpte(_AVRational @rate, int @drop, int @hh, int @mm, int @ss, int @ff);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern uint av_timecode_get_smpte_from_framenum(_AVTimecode* @tc, int @framenum);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_timecode_init(_AVTimecode* @tc, _AVRational @rate, int @flags, int @frame_start, void* @log_ctx);
    ...
    /// <param name="log_ctx">a pointer to an arbitrary struct of which the first field is a pointer to an AVClass struct (used for av_log)</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_timecode_init_from_components(_AVTimecode* @tc, _AVRational @rate, int @flags, int @hh, int @mm, int @ss, int @ff, void* @log_ctx);
    ...
    /// <param name="log_ctx">a pointer to an arbitrary struct of which the first field is a pointer to an AVClass struct (used for av_log).</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_timecode_init_from_string(_AVTimecode* @tc, _AVRational @rate,     
    #if NETSTANDARD2_1_OR_GREATER
    [MarshalAs(UnmanagedType.LPUTF8Str)]
    #else
    [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))]
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern byte* av_timecode_make_smpte_tc_string2(byte* @buf, _AVRational @rate, uint @tcsmpte, int @prevent_df, int @skip_field);
    ...
    /// <param name="framenum">frame number</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern byte* av_timecode_make_string(_AVTimecode* @tc, byte* @buf, int @framenum);
    
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void av_tree_destroy(_AVTreeNode* @t);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void av_tree_enumerate(_AVTreeNode* @t, void* @opaque, av_tree_enumerate_cmp_func @cmp, av_tree_enumerate_enu_func @enu);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void* av_tree_find(_AVTreeNode* @root, void* @key, av_tree_find_cmp_func @cmp, ref void_ptr2 @next);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void* av_tree_insert(_AVTreeNode** @rootp, void* @key, av_tree_insert_cmp_func @cmp, _AVTreeNode** @next);
    
    /// <summary>Allocate an AVTreeNode.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVTreeNode* av_tree_node_alloc();
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_write_frame(_AVFormatContext* @s, _AVPacket* @pkt);
    
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void av_write_image_line(ushort* @src, ref byte_ptr4 @data, in int4 @linesize, _AVPixFmtDescriptor* @desc, int @x, int @y, int @c, int @w);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void av_write_image_line2(void* @src, ref byte_ptr4 @data, in int4 @linesize, _AVPixFmtDescriptor* @desc, int @x, int @y, int @c, int @w, int @src_element_size);
    
    /// <summary>Write the stream trailer to an output media file and free the file private data.</summary>
    /// <param name="s">media file handle</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_write_trailer(_AVFormatContext* @s);
    
    /// <summary>Write an uncoded frame to an output media file.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_write_uncoded_frame(_AVFormatContext* @s, int @stream_index, _AVFrame* @frame);
    
    /// <summary>Test whether a muxer supports uncoded frame.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int av_write_uncoded_frame_query(_AVFormatContext* @s, int @stream_index);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void avcodec_align_dimensions(_AVCodecContext* @s, int* @width, int* @height);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void avcodec_align_dimensions2(_AVCodecContext* @s, int* @width, int* @height, ref int8 @linesize_align);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVCodecContext* avcodec_alloc_context3(_AVCodec* @codec);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avcodec_decode_subtitle2(_AVCodecContext* @avctx, _AVSubtitle* @sub, int* @got_sub_ptr, _AVPacket* @avpkt);
    
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avcodec_default_execute(_AVCodecContext* @c, avcodec_default_execute_func_func @func, void* @arg, int* @ret, int @count, int @size);
    
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avcodec_default_execute2(_AVCodecContext* @c, avcodec_default_execute2_func_func @func, void* @arg, int* @ret, int @count);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avcodec_default_get_buffer2(_AVCodecContext* @s, _AVFrame* @frame, int @flags);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avcodec_default_get_encode_buffer(_AVCodecContext* @s, _AVPacket* @pkt, int @flags);
    
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVPixelFormat avcodec_default_get_format(_AVCodecContext* @s, _AVPixelFormat* @fmt);
    
    /// <summary>Returns descriptor for given codec ID or NULL if no descriptor exists.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVCodecDescriptor* avcodec_descriptor_get(_AVCodecID @id);
    
    /// <summary>Returns codec descriptor with the given name or NULL if no such descriptor exists.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVCodecDescriptor* avcodec_descriptor_get_by_name(    
    #if NETSTANDARD2_1_OR_GREATER
    [MarshalAs(UnmanagedType.LPUTF8Str)]
    #else
    [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))]
    ...
    /// <param name="prev">previous descriptor. NULL to get the first descriptor.</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVCodecDescriptor* avcodec_descriptor_next(_AVCodecDescriptor* @prev);
    
    /// <summary>@{</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avcodec_encode_subtitle(_AVCodecContext* @avctx, byte* @buf, int @buf_size, _AVSubtitle* @sub);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avcodec_fill_audio_frame(_AVFrame* @frame, int @nb_channels, _AVSampleFormat @sample_fmt, byte* @buf, int @buf_size, int @align);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVPixelFormat avcodec_find_best_pix_fmt_of_list(_AVPixelFormat* @pix_fmt_list, _AVPixelFormat @src_pix_fmt, int @has_alpha, int* @loss_ptr);
    
    /// <summary>Find a registered decoder with a matching codec ID.</summary>
    /// <param name="id">AVCodecID of the requested decoder</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVCodec* avcodec_find_decoder(_AVCodecID @id);
    
    /// <summary>Find a registered decoder with the specified name.</summary>
    /// <param name="name">name of the requested decoder</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVCodec* avcodec_find_decoder_by_name(    
    #if NETSTANDARD2_1_OR_GREATER
    [MarshalAs(UnmanagedType.LPUTF8Str)]
    #else
    [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))]
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVCodec* avcodec_find_encoder(_AVCodecID @id);
    
    /// <summary>Find a registered encoder with the specified name.</summary>
    /// <param name="name">name of the requested encoder</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVCodec* avcodec_find_encoder_by_name(    
    #if NETSTANDARD2_1_OR_GREATER
    [MarshalAs(UnmanagedType.LPUTF8Str)]
    #else
    [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))]
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void avcodec_flush_buffers(_AVCodecContext* @avctx);
    
    /// <summary>Free the codec context and everything associated with it and write NULL to the provided pointer.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void avcodec_free_context(_AVCodecContext** @avctx);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVClass* avcodec_get_class();
    
    /// <summary>Retrieve supported hardware configurations for a codec.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVCodecHWConfig* avcodec_get_hw_config(_AVCodec* @codec, int @index);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avcodec_get_hw_frames_parameters(_AVCodecContext* @avctx, _AVBufferRef* @device_ref, _AVPixelFormat @hw_pix_fmt, _AVBufferRef** @out_frames_ref);
    
    /// <summary>Get the name of a codec.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(ConstCharPtrMarshaler))]
    public static extern string avcodec_get_name(_AVCodecID @id);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVClass* avcodec_get_subtitle_rect_class();
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avcodec_get_supported_config(_AVCodecContext* @avctx, _AVCodec* @codec, _AVCodecConfig @config, uint @flags, void** @out_configs, int* @out_num_configs);
    
    /// <summary>Get the type of the given codec.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVMediaType avcodec_get_type(_AVCodecID @codec_id);
    
    /// <summary>Returns a positive value if s is open (i.e. avcodec_open2() was called on it), 0 otherwise.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avcodec_is_open(_AVCodecContext* @s);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avcodec_parameters_from_context(_AVCodecParameters* @par, _AVCodecContext* @codec);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avcodec_parameters_to_context(_AVCodecContext* @codec, _AVCodecParameters* @par);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern uint avcodec_pix_fmt_to_codec_tag(_AVPixelFormat @pix_fmt);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(ConstCharPtrMarshaler))]
    public static extern string avcodec_profile_name(_AVCodecID @codec_id, int @profile);
    
    /// <summary>Alias for `avcodec_receive_frame_flags(avctx, frame, 0)`.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avcodec_receive_frame(_AVCodecContext* @avctx, _AVFrame* @frame);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avcodec_receive_frame_flags(_AVCodecContext* @avctx, _AVFrame* @frame, uint @flags);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avcodec_receive_packet(_AVCodecContext* @avctx, _AVPacket* @avpkt);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avcodec_send_frame(_AVCodecContext* @avctx, _AVFrame* @frame);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avcodec_send_packet(_AVCodecContext* @avctx, _AVPacket* @avpkt);
    
    /// <summary>@}</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void avcodec_string(byte* @buf, int @buf_size, _AVCodecContext* @enc, int @encode);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avdevice_app_to_dev_control_message(_AVFormatContext* @s, _AVAppToDevMessageType @type, void* @data, ulong @data_size);
    ...
    /// <param name="data_size">size of message data.</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avdevice_dev_to_app_control_message(_AVFormatContext* @s, _AVDevToAppMessageType @type, void* @data, ulong @data_size);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void avdevice_free_list_devices(_AVDeviceInfoList** @device_list);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avdevice_list_devices(_AVFormatContext* @s, _AVDeviceInfoList** @device_list);
    ...
    /// <param name="device_list">list of autodetected devices</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avdevice_list_input_sources(_AVInputFormat* @device,     
    #if NETSTANDARD2_1_OR_GREATER
    [MarshalAs(UnmanagedType.LPUTF8Str)]
    #else
    [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))]
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern uint avfilter_filter_pad_count(_AVFilter* @filter, int @is_output);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void avfilter_free(_AVFilterContext* @filter);
    
    /// <summary>Get a filter definition matching the given name.</summary>
    /// <param name="name">the filter name to find</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVFilter* avfilter_get_by_name(    
    #if NETSTANDARD2_1_OR_GREATER
    [MarshalAs(UnmanagedType.LPUTF8Str)]
    #else
    [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))]
    ...
    /// <summary>Allocate a filter graph.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVFilterGraph* avfilter_graph_alloc();
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVFilterContext* avfilter_graph_alloc_filter(_AVFilterGraph* @graph, _AVFilter* @filter,     
    #if NETSTANDARD2_1_OR_GREATER
    [MarshalAs(UnmanagedType.LPUTF8Str)]
    #else
    [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))]
    ...
    /// <param name="log_ctx">context used for logging</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avfilter_graph_config(_AVFilterGraph* @graphctx, void* @log_ctx);
    ...
    /// <param name="graph_ctx">the filter graph</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avfilter_graph_create_filter(_AVFilterContext** @filt_ctx, _AVFilter* @filt,     
    #if NETSTANDARD2_1_OR_GREATER
    [MarshalAs(UnmanagedType.LPUTF8Str)]
    #else
    [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))]
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern byte* avfilter_graph_dump(_AVFilterGraph* @graph,     
    #if NETSTANDARD2_1_OR_GREATER
    [MarshalAs(UnmanagedType.LPUTF8Str)]
    #else
    [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))]
    ...
    /// <summary>Free a graph, destroy its links, and set *graph to NULL. If *graph is NULL, do nothing.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void avfilter_graph_free(_AVFilterGraph** @graph);
    
    /// <summary>Get a filter instance identified by instance name from graph.</summary>
    /// <param name="graph">filter graph to search through.</param>
    /// <param name="name">filter instance name (should be unique in the graph).</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVFilterContext* avfilter_graph_get_filter(_AVFilterGraph* @graph,     
    #if NETSTANDARD2_1_OR_GREATER
    [MarshalAs(UnmanagedType.LPUTF8Str)]
    #else
    [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))]
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avfilter_graph_parse(_AVFilterGraph* @graph,     
    #if NETSTANDARD2_1_OR_GREATER
    [MarshalAs(UnmanagedType.LPUTF8Str)]
    #else
    [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))]
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avfilter_graph_parse_ptr(_AVFilterGraph* @graph,     
    #if NETSTANDARD2_1_OR_GREATER
    [MarshalAs(UnmanagedType.LPUTF8Str)]
    #else
    [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))]
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avfilter_graph_parse2(_AVFilterGraph* @graph,     
    #if NETSTANDARD2_1_OR_GREATER
    [MarshalAs(UnmanagedType.LPUTF8Str)]
    #else
    [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))]
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avfilter_graph_queue_command(_AVFilterGraph* @graph,     
    #if NETSTANDARD2_1_OR_GREATER
    [MarshalAs(UnmanagedType.LPUTF8Str)]
    #else
    [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))]
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avfilter_graph_request_oldest(_AVFilterGraph* @graph);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avfilter_graph_segment_apply(_AVFilterGraphSegment* @seg, int @flags, _AVFilterInOut** @inputs, _AVFilterInOut** @outputs);
    
    /// <summary>Apply parsed options to filter instances in a graph segment.</summary>
    /// <param name="seg">the filtergraph segment to process</param>
    /// <param name="flags">reserved for future use, caller must set to 0 for now</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avfilter_graph_segment_apply_opts(_AVFilterGraphSegment* @seg, int @flags);
    
    /// <summary>Create filters specified in a graph segment.</summary>
    /// <param name="seg">the filtergraph segment to process</param>
    /// <param name="flags">reserved for future use, caller must set to 0 for now</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avfilter_graph_segment_create_filters(_AVFilterGraphSegment* @seg, int @flags);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void avfilter_graph_segment_free(_AVFilterGraphSegment** @seg);
    
    /// <summary>Initialize all filter instances in a graph segment.</summary>
    /// <param name="seg">the filtergraph segment to process</param>
    /// <param name="flags">reserved for future use, caller must set to 0 for now</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avfilter_graph_segment_init(_AVFilterGraphSegment* @seg, int @flags);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avfilter_graph_segment_link(_AVFilterGraphSegment* @seg, int @flags, _AVFilterInOut** @inputs, _AVFilterInOut** @outputs);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avfilter_graph_segment_parse(_AVFilterGraph* @graph,     
    #if NETSTANDARD2_1_OR_GREATER
    [MarshalAs(UnmanagedType.LPUTF8Str)]
    #else
    [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))]
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avfilter_graph_send_command(_AVFilterGraph* @graph,     
    #if NETSTANDARD2_1_OR_GREATER
    [MarshalAs(UnmanagedType.LPUTF8Str)]
    #else
    [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))]
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void avfilter_graph_set_auto_convert(_AVFilterGraph* @graph, uint @flags);
    
    /// <summary>Initialize a filter with the supplied dictionary of options.</summary>
    /// <param name="ctx">uninitialized filter context to initialize</param>
    /// <param name="options">An AVDictionary filled with options for this filter. On return this parameter will be destroyed and replaced with a dict containing options that were not found. This dictionary must be freed by the caller. May be NULL, then this function is equivalent to avfilter_init_str() with the second parameter set to NULL.</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avfilter_init_dict(_AVFilterContext* @ctx, _AVDictionary** @options);
    
    /// <summary>Initialize a filter with the supplied parameters.</summary>
    /// <param name="ctx">uninitialized filter context to initialize</param>
    /// <param name="args">Options to initialize the filter with. This must be a &apos;:&apos;-separated list of options in the &apos;key=value&apos; form. May be NULL if the options have been set directly using the AVOptions API or there are no options that need to be set.</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avfilter_init_str(_AVFilterContext* @ctx,     
    #if NETSTANDARD2_1_OR_GREATER
    [MarshalAs(UnmanagedType.LPUTF8Str)]
    #else
    [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))]
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVFilterInOut* avfilter_inout_alloc();
    
    /// <summary>Free the supplied list of AVFilterInOut and set *inout to NULL. If *inout is NULL, do nothing.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void avfilter_inout_free(_AVFilterInOut** @inout);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avfilter_insert_filter(_AVFilterLink* @link, _AVFilterContext* @filt, uint @filt_srcpad_idx, uint @filt_dstpad_idx);
    ...
    /// <param name="dstpad">index of the input pad on the destination filter</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avfilter_link(_AVFilterContext* @src, uint @srcpad, _AVFilterContext* @dst, uint @dstpad);
    
    /// <summary>Get the hardware frames context of a filter link.</summary>
    /// <param name="link">an AVFilterLink</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVBufferRef* avfilter_link_get_hw_frames_ctx(_AVFilterLink* @link);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    [return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(ConstCharPtrMarshaler))]
    public static extern string avfilter_pad_get_name(_AVFilterPad* @pads, int @pad_idx);
    
    /// <summary>Get the type of an AVFilterPad.</summary>
    /// <param name="pads">an array of AVFilterPads</param>
    /// <param name="pad_idx">index of the pad in the array; it is the caller&apos;s responsibility to ensure the index is valid</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVMediaType avfilter_pad_get_type(_AVFilterPad* @pads, int @pad_idx);
    
    /// <summary>Make the filter instance process a command. It is recommended to use avfilter_graph_send_command().</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avfilter_process_command(_AVFilterContext* @filter,     
    #if NETSTANDARD2_1_OR_GREATER
    [MarshalAs(UnmanagedType.LPUTF8Str)]
    #else
    [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))]
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVFormatContext* avformat_alloc_context();
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avformat_alloc_output_context2(_AVFormatContext** @ctx, _AVOutputFormat* @oformat,     
    #if NETSTANDARD2_1_OR_GREATER
    [MarshalAs(UnmanagedType.LPUTF8Str)]
    #else
    [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))]
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void avformat_close_input(_AVFormatContext** @s);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avformat_find_stream_info(_AVFormatContext* @ic, _AVDictionary** @options);
    ...
    /// <param name="s">media file handle</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avformat_flush(_AVFormatContext* @s);
    
    /// <summary>Free an AVFormatContext and all its streams.</summary>
    /// <param name="s">context to free</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void avformat_free_context(_AVFormatContext* @s);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVCodecTag* avformat_get_riff_video_tags();
    
    /// <summary>Get the index entry count for the given AVStream.</summary>
    /// <param name="st">stream</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avformat_index_get_entries_count(_AVStream* @st);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVIndexEntry* avformat_index_get_entry(_AVStream* @st, int @idx);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVIndexEntry* avformat_index_get_entry_from_timestamp(_AVStream* @st, long @wanted_timestamp, int @flags);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avformat_init_output(_AVFormatContext* @s, _AVDictionary** @options);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avformat_match_stream_specifier(_AVFormatContext* @s, _AVStream* @st,     
    #if NETSTANDARD2_1_OR_GREATER
    [MarshalAs(UnmanagedType.LPUTF8Str)]
    #else
    [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))]
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVStream* avformat_new_stream(_AVFormatContext* @s, _AVCodec* @c);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avformat_open_input(_AVFormatContext** @ps,     
    #if NETSTANDARD2_1_OR_GREATER
    [MarshalAs(UnmanagedType.LPUTF8Str)]
    #else
    [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))]
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avformat_query_codec(_AVOutputFormat* @ofmt, _AVCodecID @codec_id, int @std_compliance);
    
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avformat_queue_attached_pictures(_AVFormatContext* @s);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avformat_receive_command_reply(_AVFormatContext* @s, _AVFormatCommandID @id, void** @data_out);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avformat_seek_file(_AVFormatContext* @s, int @stream_index, long @min_ts, long @ts, long @max_ts, int @flags);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avformat_send_command(_AVFormatContext* @s, _AVFormatCommandID @id, void* @data);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avformat_stream_group_add_stream(_AVStreamGroup* @stg, _AVStream* @st);
    
    /// <summary>Add a new empty stream group to a media file.</summary>
    /// <param name="s">media file handle</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVStreamGroup* avformat_stream_group_create(_AVFormatContext* @s, _AVStreamGroupParamsType @type, _AVDictionary** @options);
    ...
    /// <param name="options">An ::AVDictionary filled with AVFormatContext and muxer-private options. On return this parameter will be destroyed and replaced with a dict containing options that were not found. May be NULL.</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avformat_write_header(_AVFormatContext* @s, _AVDictionary** @options);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avio_accept(_AVIOContext* @s, _AVIOContext** @c);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVIOContext* avio_alloc_context(byte* @buffer, int @buffer_size, int @write_flag, void* @opaque, avio_alloc_context_read_packet_func @read_packet, avio_alloc_context_write_packet_func @write_packet, avio_alloc_context_seek_func @seek);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avio_close_dir(_AVIODirContext** @s);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avio_close_dyn_buf(_AVIOContext* @s, byte** @pbuffer);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avio_closep(_AVIOContext** @s);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void avio_context_free(_AVIOContext** @s);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avio_feof(_AVIOContext* @s);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void avio_free_directory_entry(_AVIODirEntry** @entry);
    ...
    /// <param name="pbuffer">pointer to a byte buffer</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avio_get_dyn_buf(_AVIOContext* @s, byte** @pbuffer);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avio_get_str(_AVIOContext* @pb, int @maxlen, byte* @buf, int @buflen);
    
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avio_get_str16be(_AVIOContext* @pb, int @maxlen, byte* @buf, int @buflen);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avio_get_str16le(_AVIOContext* @pb, int @maxlen, byte* @buf, int @buflen);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avio_handshake(_AVIOContext* @c);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avio_open(_AVIOContext** @s,     
    #if NETSTANDARD2_1_OR_GREATER
    [MarshalAs(UnmanagedType.LPUTF8Str)]
    #else
    [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))]
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avio_open_dir(_AVIODirContext** @s,     
    #if NETSTANDARD2_1_OR_GREATER
    [MarshalAs(UnmanagedType.LPUTF8Str)]
    #else
    [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))]
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avio_open_dyn_buf(_AVIOContext** @s);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avio_open2(_AVIOContext** @s,     
    #if NETSTANDARD2_1_OR_GREATER
    [MarshalAs(UnmanagedType.LPUTF8Str)]
    #else
    [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))]
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avio_pause(_AVIOContext* @h, int @pause);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void avio_print_string_array(_AVIOContext* @s, byte*[] @strings);
    
    /// <summary>Writes a formatted string to the context.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avio_printf(_AVIOContext* @s,     
    #if NETSTANDARD2_1_OR_GREATER
    [MarshalAs(UnmanagedType.LPUTF8Str)]
    #else
    [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))]
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avio_put_str16be(_AVIOContext* @s,     
    #if NETSTANDARD2_1_OR_GREATER
    [MarshalAs(UnmanagedType.LPUTF8Str)]
    #else
    [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))]
    ...
    /// <param name="str">NULL-terminated UTF-8 string</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avio_put_str16le(_AVIOContext* @s,     
    #if NETSTANDARD2_1_OR_GREATER
    [MarshalAs(UnmanagedType.LPUTF8Str)]
    #else
    [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))]
    ...
    /// <summary>@{</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avio_r8(_AVIOContext* @s);
    
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern uint avio_rb16(_AVIOContext* @s);
    
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern uint avio_rb24(_AVIOContext* @s);
    
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern uint avio_rb32(_AVIOContext* @s);
    
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern ulong avio_rb64(_AVIOContext* @s);
    
    /// <summary>Read size bytes from AVIOContext into buf.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avio_read(_AVIOContext* @s, byte* @buf, int @size);
    
    /// <summary>Get next directory entry.</summary>
    /// <param name="s">directory read context.</param>
    /// <param name="next">next entry or NULL when no more entries.</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avio_read_dir(_AVIODirContext* @s, _AVIODirEntry** @next);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avio_read_partial(_AVIOContext* @s, byte* @buf, int @size);
    
    /// <summary>Read contents of h into print buffer, up to max_size bytes, or up to EOF.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avio_read_to_bprint(_AVIOContext* @h, _AVBPrint* @pb, ulong @max_size);
    
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern uint avio_rl16(_AVIOContext* @s);
    
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern uint avio_rl24(_AVIOContext* @s);
    
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern uint avio_rl32(_AVIOContext* @s);
    
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern ulong avio_rl64(_AVIOContext* @s);
    
    /// <summary>fseek() equivalent for AVIOContext.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern long avio_seek(_AVIOContext* @s, long @offset, int @whence);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern long avio_seek_time(_AVIOContext* @h, int @stream_index, long @timestamp, int @flags);
    
    /// <summary>Get the filesize.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern long avio_size(_AVIOContext* @s);
    
    /// <summary>Skip given number of bytes forward</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern long avio_skip(_AVIOContext* @s, long @offset);
    
    /// <summary>Writes a formatted string to the context taking a va_list.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int avio_vprintf(_AVIOContext* @s,     
    #if NETSTANDARD2_1_OR_GREATER
    [MarshalAs(UnmanagedType.LPUTF8Str)]
    #else
    [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(UTF8Marshaler))]
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void avio_wb16(_AVIOContext* @s, uint @val);
    
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void avio_wb24(_AVIOContext* @s, uint @val);
    
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void avio_wb32(_AVIOContext* @s, uint @val);
    
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void avio_wb64(_AVIOContext* @s, ulong @val);
    
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void avio_wl16(_AVIOContext* @s, uint @val);
    
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void avio_wl24(_AVIOContext* @s, uint @val);
    
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void avio_wl32(_AVIOContext* @s, uint @val);
    
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void avio_wl64(_AVIOContext* @s, ulong @val);
    
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void avio_write(_AVIOContext* @s, byte* @buf, int @size);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void avio_write_marker(_AVIOContext* @s, long @time, _AVIODataMarkerType @type);
    
    /// <summary>Free all allocated data in the given subtitle struct.</summary>
    /// <param name="sub">AVSubtitle to free.</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void avsubtitle_free(_AVSubtitle* @sub);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _SwrContext* swr_alloc();
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int swr_alloc_set_opts2(_SwrContext** @ps, _AVChannelLayout* @out_ch_layout, _AVSampleFormat @out_sample_fmt, int @out_sample_rate, _AVChannelLayout* @in_ch_layout, _AVSampleFormat @in_sample_fmt, int @in_sample_rate, int @log_offset, void* @log_ctx);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int swr_build_matrix2(_AVChannelLayout* @in_layout, _AVChannelLayout* @out_layout, double @center_mix_level, double @surround_mix_level, double @lfe_mix_level, double @maxval, double @rematrix_volume, double* @matrix, long @stride, _AVMatrixEncoding @matrix_encoding, void* @log_context);
    
    /// <summary>Closes the context so that swr_is_initialized() returns 0.</summary>
    /// <param name="s">Swr context to be closed</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void swr_close(_SwrContext* @s);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int swr_config_frame(_SwrContext* @swr, _AVFrame* @out, _AVFrame* @in);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int swr_convert(_SwrContext* @s, byte** @out, int @out_count, byte** @in, int @in_count);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int swr_convert_frame(_SwrContext* @swr, _AVFrame* @output, _AVFrame* @input);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int swr_drop_output(_SwrContext* @s, int @count);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void swr_free(_SwrContext** @s);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVClass* swr_get_class();
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern long swr_get_delay(_SwrContext* @s, long @base);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern long swr_next_pts(_SwrContext* @s, long @pts);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int swr_set_channel_mapping(_SwrContext* @s, int* @channel_map);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int swr_set_compensation(_SwrContext* @s, int @sample_delta, int @compensation_distance);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int swr_set_matrix(_SwrContext* @s, double* @matrix, int @stride);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _SwsContext* sws_alloc_context();
    
    /// <summary>Allocate and return an uninitialized vector with length coefficients.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _SwsVector* sws_allocVec(int @length);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void sws_frame_end(_SwsContext* @c);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int sws_frame_setup(_SwsContext* @ctx, _AVFrame* @dst, _AVFrame* @src);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int sws_frame_start(_SwsContext* @c, _AVFrame* @dst, _AVFrame* @src);
    
    /// <summary>Free the context and everything associated with it, and write NULL to the provided pointer.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void sws_free_context(_SwsContext** @ctx);
    
    /// <summary>Free the swscaler context swsContext. If swsContext is NULL, then does nothing.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void sws_freeContext(_SwsContext* @swsContext);
    
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void sws_freeFilter(_SwsFilter* @filter);
    
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void sws_freeVec(_SwsVector* @a);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _AVClass* sws_get_class();
    
    /// <summary>Check if context can be reused, otherwise reallocate a new one.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _SwsContext* sws_getCachedContext(_SwsContext* @context, int @srcW, int @srcH, _AVPixelFormat @srcFormat, int @dstW, int @dstH, _AVPixelFormat @dstFormat, int @flags, _SwsFilter* @srcFilter, _SwsFilter* @dstFilter, double* @param);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int sws_getColorspaceDetails(_SwsContext* @c, int** @inv_table, int* @srcRange, int** @table, int* @dstRange, int* @brightness, int* @contrast, int* @saturation);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _SwsContext* sws_getContext(int @srcW, int @srcH, _AVPixelFormat @srcFormat, int @dstW, int @dstH, _AVPixelFormat @dstFormat, int @flags, _SwsFilter* @srcFilter, _SwsFilter* @dstFilter, double* @param);
    
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _SwsFilter* sws_getDefaultFilter(float @lumaGBlur, float @chromaGBlur, float @lumaSharpen, float @chromaSharpen, float @chromaHShift, float @chromaVShift, int @verbose);
    
    /// <summary>Return a normalized Gaussian curve used to filter stuff quality = 3 is high quality, lower is lower quality.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern _SwsVector* sws_getGaussianVec(double @variance, double @quality);
    
    /// <summary>Initialize the swscaler context sws_context.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int sws_init_context(_SwsContext* @sws_context, _SwsFilter* @srcFilter, _SwsFilter* @dstFilter);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int sws_receive_slice(_SwsContext* @c, uint @slice_start, uint @slice_height);
    ...
    /// <param name="c">The scaling context</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern uint sws_receive_slice_alignment(_SwsContext* @c);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int sws_scale(_SwsContext* @c, byte*[] @srcSlice, int[] @srcStride, int @srcSliceY, int @srcSliceH, byte*[] @dst, int[] @dstStride);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int sws_scale_frame(_SwsContext* @c, _AVFrame* @dst, _AVFrame* @src);
    
    /// <summary>Scale all the coefficients of a by the scalar value.</summary>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern void sws_scaleVec(_SwsVector* @a, double @scalar);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int sws_send_slice(_SwsContext* @c, uint @slice_start, uint @slice_height);
    ...
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int sws_setColorspaceDetails(_SwsContext* @c, in int4 @inv_table, int @srcRange, in int4 @table, int @dstRange, int @brightness, int @contrast, int @saturation);
    ...
    /// <param name="output">If 0, test if compatible with the source/input frame; otherwise, with the destination/output frame.</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int sws_test_format(_AVPixelFormat @format, int @output);
    ...
    /// <param name="output">If 0, test if compatible with the source/input frame; otherwise, with the destination/output frame.</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int sws_test_primaries(_AVColorPrimaries @primaries, int @output);
    ...
    /// <param name="output">If 0, test if compatible with the source/input frame; otherwise, with the destination/output frame.</param>
    [DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
    public static extern int sws_test_transfer(_AVColorTransferCharacteristic @trc, int @output);
