...
public unsafe struct _AVRational_array2 : IFixedArray<_AVRational>
{
    ...
    public static implicit operator Span<_AVRational>(_AVRational_array2 array) => array.AsSpan();
    public static implicit operator ReadOnlySpan<_AVRational>(_AVRational_array2 array) => array.AsReadOnlySpan();
...
public unsafe struct double_array2 : IFixedArray<double>
{
    ...
    public static implicit operator Span<double>(double_array2 array) => array.AsSpan();
    public static implicit operator ReadOnlySpan<double>(double_array2 array) => array.AsReadOnlySpan();
    private static void CheckIndex(int index)
    {
        if ((uint)index >= 2) throw new ArgumentOutOfRangeException();
    }
...
public unsafe struct short_array2 : IFixedArray<short>
{
    ...
    public static implicit operator Span<short>(short_array2 array) => array.AsSpan();
    public static implicit operator ReadOnlySpan<short>(short_array2 array) => array.AsReadOnlySpan();
    private static void CheckIndex(int index)
    {
        if ((uint)index >= 2) throw new ArgumentOutOfRangeException();
    }
...
[StructLayout(LayoutKind.Sequential)]
public unsafe struct void_ptrArray2 : IFixedPtrArray
{
    public static readonly int Size = 2;
    public readonly int Length => 2;
    #pragma warning disable CS9084
    ...
    #pragma warning restore CS9084
    public static implicit operator Span<IntPtr>(void_ptrArray2 array) => array.AsSpan();
    public static implicit operator ReadOnlySpan<IntPtr>(void_ptrArray2 array) => array.AsReadOnlySpan();
    private static void CheckIndex(int index)
    {
        if ((uint)index >= 2) throw new ArgumentOutOfRangeException();
    }
...
public unsafe struct _AVHDRPlusColorTransformParams_array3 : IFixedArray<_AVHDRPlusColorTransformParams>
{
    ...
    public static implicit operator Span<_AVHDRPlusColorTransformParams>(_AVHDRPlusColorTransformParams_array3 array) => array.AsSpan();
    public static implicit operator ReadOnlySpan<_AVHDRPlusColorTransformParams>(_AVHDRPlusColorTransformParams_array3 array) => array.AsReadOnlySpan();
    private static void CheckIndex(int index)
    {
...
public unsafe struct _AVRational_array3 : IFixedArray<_AVRational>
{
    ...
    public static implicit operator Span<_AVRational>(_AVRational_array3 array) => array.AsSpan();
    public static implicit operator ReadOnlySpan<_AVRational>(_AVRational_array3 array) => array.AsReadOnlySpan();
    private static void CheckIndex(int index)
    {
        if ((uint)index >= 3) throw new ArgumentOutOfRangeException();
    }
...
public unsafe struct _AVRational_array3x2 : IFixedArray<_AVRational_array2>
{
    ...
    public readonly int Length => 3;
    #pragma warning disable CS9084
    _AVRational_array2 _0,_1,_2;
    
    public ref _AVRational_array2 this[int i] 
    {
        get { CheckIndex(i); return ref Unsafe.Add(ref _0, i); }
    }
    public ref _AVRational_array2 this[uint i] 
    {
        get {  CheckIndex(i); return ref Unsafe.Add(ref _0, i); }
    }
    public _AVRational_array2[] ToArray()
    {
        var a = new _AVRational_array2[3];
        for (int i = 0; i < 3; i++) a[i] = this[i];
        return a;
    }
    ...
    [EditorBrowsable(EditorBrowsableState.Never)]
    public ref _AVRational_array2 GetPinnableReference() => ref _0;
    #pragma warning restore CS9084
    public Span<_AVRational_array2> AsSpan() { fixed(void* ptr = &_0) return new Span<_AVRational_array2>(ptr, 3); }
    public ReadOnlySpan<_AVRational_array2> AsReadOnlySpan() { fixed(void* ptr = &_0) return new ReadOnlySpan<_AVRational_array2>(ptr, 3); }
    public static implicit operator Span<_AVRational_array2>(_AVRational_array3x2 array) => array.AsSpan();
    public static implicit operator ReadOnlySpan<_AVRational_array2>(_AVRational_array3x2 array) => array.AsReadOnlySpan();
    private static void CheckIndex(int index)
    {
        if ((uint)index >= 3) throw new ArgumentOutOfRangeException();
    }
...
public unsafe struct short_array3x2 : IFixedArray<short_array2>
{
    ...
    [EditorBrowsable(EditorBrowsableState.Never)]
    public ref short_array2 GetPinnableReference() => ref _0;
    #pragma warning restore CS9084
    public Span<short_array2> AsSpan() { fixed(void* ptr = &_0) return new Span<short_array2>(ptr, 3); }
    public ReadOnlySpan<short_array2> AsReadOnlySpan() { fixed(void* ptr = &_0) return new ReadOnlySpan<short_array2>(ptr, 3); }
    public static implicit operator Span<short_array2>(short_array3x2 array) => array.AsSpan();
    public static implicit operator ReadOnlySpan<short_array2>(short_array3x2 array) => array.AsReadOnlySpan();
    private static void CheckIndex(int index)
    {
        if ((uint)index >= 3) throw new ArgumentOutOfRangeException();
    }
...
public unsafe struct _AVComponentDescriptor_array4 : IFixedArray<_AVComponentDescriptor>
{
    ...
    public static implicit operator Span<_AVComponentDescriptor>(_AVComponentDescriptor_array4 array) => array.AsSpan();
    public static implicit operator ReadOnlySpan<_AVComponentDescriptor>(_AVComponentDescriptor_array4 array) => array.AsReadOnlySpan();
    private static void CheckIndex(int index)
    {
...
[StructLayout(LayoutKind.Sequential)]
public unsafe struct byte_ptrArray4 : IFixedPtrArray<byte>
{
    public static readonly int Size = 4;
    public readonly int Length => 4;
    #pragma warning disable CS9084
    ...
    #pragma warning restore CS9084
    public static implicit operator Span<IntPtr>(byte_ptrArray4 array) => array.AsSpan();
    public static implicit operator ReadOnlySpan<IntPtr>(byte_ptrArray4 array) => array.AsReadOnlySpan();
    private static void CheckIndex(int index)
    {
        if ((uint)index >= 4) throw new ArgumentOutOfRangeException();
    }
...
public unsafe struct byte_array4 : IFixedArray<byte>
{
    ...
    public static implicit operator Span<byte>(byte_array4 array) => array.AsSpan();
    public static implicit operator ReadOnlySpan<byte>(byte_array4 array) => array.AsReadOnlySpan();
    private static void CheckIndex(int index)
    {
        if ((uint)index >= 4) throw new ArgumentOutOfRangeException();
    }
...
public unsafe struct byte_array4x6 : IFixedArray<byte_array6>
{
    ...
    public readonly int Length => 4;
    #pragma warning disable CS9084
    byte_array6 _0,_1,_2,_3;
    
    public ref byte_array6 this[int i] 
    {
        get { CheckIndex(i); return ref Unsafe.Add(ref _0, i); }
    }
    public ref byte_array6 this[uint i] 
    {
        get {  CheckIndex(i); return ref Unsafe.Add(ref _0, i); }
    }
    public byte_array6[] ToArray()
    {
        var a = new byte_array6[4];
        for (int i = 0; i < 4; i++) a[i] = this[i];
        return a;
    }
    ...
    [EditorBrowsable(EditorBrowsableState.Never)]
    public ref byte_array6 GetPinnableReference() => ref _0;
    #pragma warning restore CS9084
    public Span<byte_array6> AsSpan() { fixed(void* ptr = &_0) return new Span<byte_array6>(ptr, 4); }
    public ReadOnlySpan<byte_array6> AsReadOnlySpan() { fixed(void* ptr = &_0) return new ReadOnlySpan<byte_array6>(ptr, 4); }
    public static implicit operator Span<byte_array6>(byte_array4x6 array) => array.AsSpan();
    public static implicit operator ReadOnlySpan<byte_array6>(byte_array4x6 array) => array.AsReadOnlySpan();
    private static void CheckIndex(int index)
    {
        if ((uint)index >= 4) throw new ArgumentOutOfRangeException();
    }
...
public unsafe struct int_array4 : IFixedArray<int>
{
    ...
    public static implicit operator Span<int>(int_array4 array) => array.AsSpan();
    public static implicit operator ReadOnlySpan<int>(int_array4 array) => array.AsReadOnlySpan();
    private static void CheckIndex(int index)
    {
        if ((uint)index >= 4) throw new ArgumentOutOfRangeException();
    }
...
public unsafe struct long_array4 : IFixedArray<long>
{
    ...
    public static implicit operator Span<long>(long_array4 array) => array.AsSpan();
    public static implicit operator ReadOnlySpan<long>(long_array4 array) => array.AsReadOnlySpan();
    private static void CheckIndex(int index)
    {
        if ((uint)index >= 4) throw new ArgumentOutOfRangeException();
    }
...
public unsafe struct uint_array4 : IFixedArray<uint>
{
    ...
    public static implicit operator Span<uint>(uint_array4 array) => array.AsSpan();
    public static implicit operator ReadOnlySpan<uint>(uint_array4 array) => array.AsReadOnlySpan();
    private static void CheckIndex(int index)
    {
        if ((uint)index >= 4) throw new ArgumentOutOfRangeException();
    }
...
public unsafe struct ulong_array4 : IFixedArray<ulong>
{
    ...
    public static implicit operator Span<ulong>(ulong_array4 array) => array.AsSpan();
    public static implicit operator ReadOnlySpan<ulong>(ulong_array4 array) => array.AsReadOnlySpan();
    private static void CheckIndex(int index)
    {
        if ((uint)index >= 4) throw new ArgumentOutOfRangeException();
    }
...
public unsafe struct ushort_array4 : IFixedArray<ushort>
{
    ...
    public static implicit operator Span<ushort>(ushort_array4 array) => array.AsSpan();
    public static implicit operator ReadOnlySpan<ushort>(ushort_array4 array) => array.AsReadOnlySpan();
    private static void CheckIndex(int index)
    {
        if ((uint)index >= 4) throw new ArgumentOutOfRangeException();
    }
...
public unsafe struct ushort_array4x32 : IFixedArray<ushort_array32>
{
    ...
    public readonly int Length => 4;
    #pragma warning disable CS9084
    ushort_array32 _0,_1,_2,_3;
    
    public ref ushort_array32 this[int i] 
    {
        get { CheckIndex(i); return ref Unsafe.Add(ref _0, i); }
    }
    public ref ushort_array32 this[uint i] 
    {
        get {  CheckIndex(i); return ref Unsafe.Add(ref _0, i); }
    }
    public ushort_array32[] ToArray()
    {
        var a = new ushort_array32[4];
        for (int i = 0; i < 4; i++) a[i] = this[i];
        return a;
    }
    ...
    [EditorBrowsable(EditorBrowsableState.Never)]
    public ref ushort_array32 GetPinnableReference() => ref _0;
    #pragma warning restore CS9084
    public Span<ushort_array32> AsSpan() { fixed(void* ptr = &_0) return new Span<ushort_array32>(ptr, 4); }
    public ReadOnlySpan<ushort_array32> AsReadOnlySpan() { fixed(void* ptr = &_0) return new ReadOnlySpan<ushort_array32>(ptr, 4); }
    public static implicit operator Span<ushort_array32>(ushort_array4x32 array) => array.AsSpan();
    public static implicit operator ReadOnlySpan<ushort_array32>(ushort_array4x32 array) => array.AsReadOnlySpan();
    private static void CheckIndex(int index)
    {
        if ((uint)index >= 4) throw new ArgumentOutOfRangeException();
    }
...
public unsafe struct ushort_array4x6 : IFixedArray<ushort_array6>
{
    ...
    public readonly int Length => 4;
    #pragma warning disable CS9084
    ushort_array6 _0,_1,_2,_3;
    
    public ref ushort_array6 this[int i] 
    {
        get { CheckIndex(i); return ref Unsafe.Add(ref _0, i); }
    }
    public ref ushort_array6 this[uint i] 
    {
        get {  CheckIndex(i); return ref Unsafe.Add(ref _0, i); }
    }
    public ushort_array6[] ToArray()
    {
        var a = new ushort_array6[4];
        for (int i = 0; i < 4; i++) a[i] = this[i];
        return a;
    }
    ...
    [EditorBrowsable(EditorBrowsableState.Never)]
    public ref ushort_array6 GetPinnableReference() => ref _0;
    #pragma warning restore CS9084
    public Span<ushort_array6> AsSpan() { fixed(void* ptr = &_0) return new Span<ushort_array6>(ptr, 4); }
    public ReadOnlySpan<ushort_array6> AsReadOnlySpan() { fixed(void* ptr = &_0) return new ReadOnlySpan<ushort_array6>(ptr, 4); }
    public static implicit operator Span<ushort_array6>(ushort_array4x6 array) => array.AsSpan();
    public static implicit operator ReadOnlySpan<ushort_array6>(ushort_array4x6 array) => array.AsReadOnlySpan();
    private static void CheckIndex(int index)
    {
        if ((uint)index >= 4) throw new ArgumentOutOfRangeException();
    }
...
public unsafe struct byte_array6 : IFixedArray<byte>
{
    ...
    public static implicit operator Span<byte>(byte_array6 array) => array.AsSpan();
    public static implicit operator ReadOnlySpan<byte>(byte_array6 array) => array.AsReadOnlySpan();
    private static void CheckIndex(int index)
    {
...
public unsafe struct ushort_array6 : IFixedArray<ushort>
{
    ...
    public static implicit operator Span<ushort>(ushort_array6 array) => array.AsSpan();
    public static implicit operator ReadOnlySpan<ushort>(ushort_array6 array) => array.AsReadOnlySpan();
    private static void CheckIndex(int index)
    {
        if ((uint)index >= 6) throw new ArgumentOutOfRangeException();
    }
...
public unsafe struct _AVCodecID_array7 : IFixedArray<_AVCodecID>
{
    ...
    public static implicit operator Span<_AVCodecID>(_AVCodecID_array7 array) => array.AsSpan();
    public static implicit operator ReadOnlySpan<_AVCodecID>(_AVCodecID_array7 array) => array.AsReadOnlySpan();
    private static void CheckIndex(int index)
    {
...
[StructLayout(LayoutKind.Sequential)]
public unsafe struct __cl_mem_ptrArray8 : IFixedPtrArray<__cl_mem>
{
    ...
    #pragma warning restore CS9084
    public static implicit operator Span<IntPtr>(__cl_mem_ptrArray8 array) => array.AsSpan();
    public static implicit operator ReadOnlySpan<IntPtr>(__cl_mem_ptrArray8 array) => array.AsReadOnlySpan();
    private static void CheckIndex(int index)
    {
...
[StructLayout(LayoutKind.Sequential)]
public unsafe struct _AVBufferRef_ptrArray8 : IFixedPtrArray<_AVBufferRef>
{
    public static readonly int Size = 8;
    public readonly int Length => 8;
    #pragma warning disable CS9084
    ...
    #pragma warning restore CS9084
    public static implicit operator Span<IntPtr>(_AVBufferRef_ptrArray8 array) => array.AsSpan();
    public static implicit operator ReadOnlySpan<IntPtr>(_AVBufferRef_ptrArray8 array) => array.AsReadOnlySpan();
    private static void CheckIndex(int index)
    {
        if ((uint)index >= 8) throw new ArgumentOutOfRangeException();
    }
...
[StructLayout(LayoutKind.Sequential)]
public unsafe struct _VkDeviceMemory_T_ptrArray8 : IFixedPtrArray<_VkDeviceMemory_T>
{
    public static readonly int Size = 8;
    public readonly int Length => 8;
    #pragma warning disable CS9084
    ...
    #pragma warning restore CS9084
    public static implicit operator Span<IntPtr>(_VkDeviceMemory_T_ptrArray8 array) => array.AsSpan();
    public static implicit operator ReadOnlySpan<IntPtr>(_VkDeviceMemory_T_ptrArray8 array) => array.AsReadOnlySpan();
    private static void CheckIndex(int index)
    {
        if ((uint)index >= 8) throw new ArgumentOutOfRangeException();
    }
...
public unsafe struct _VkFormat_array8 : IFixedArray<_VkFormat>
{
    ...
    public static implicit operator Span<_VkFormat>(_VkFormat_array8 array) => array.AsSpan();
    public static implicit operator ReadOnlySpan<_VkFormat>(_VkFormat_array8 array) => array.AsReadOnlySpan();
    private static void CheckIndex(int index)
    {
        if ((uint)index >= 8) throw new ArgumentOutOfRangeException();
    }
...
[StructLayout(LayoutKind.Sequential)]
public unsafe struct _VkImage_T_ptrArray8 : IFixedPtrArray<_VkImage_T>
{
    public static readonly int Size = 8;
    public readonly int Length => 8;
    #pragma warning disable CS9084
    ...
    #pragma warning restore CS9084
    public static implicit operator Span<IntPtr>(_VkImage_T_ptrArray8 array) => array.AsSpan();
    public static implicit operator ReadOnlySpan<IntPtr>(_VkImage_T_ptrArray8 array) => array.AsReadOnlySpan();
    private static void CheckIndex(int index)
    {
        if ((uint)index >= 8) throw new ArgumentOutOfRangeException();
    }
...
public unsafe struct _VkImageLayout_array8 : IFixedArray<_VkImageLayout>
{
    ...
    public static implicit operator Span<_VkImageLayout>(_VkImageLayout_array8 array) => array.AsSpan();
    public static implicit operator ReadOnlySpan<_VkImageLayout>(_VkImageLayout_array8 array) => array.AsReadOnlySpan();
    private static void CheckIndex(int index)
    {
        if ((uint)index >= 8) throw new ArgumentOutOfRangeException();
    }
...
[StructLayout(LayoutKind.Sequential)]
public unsafe struct _VkSemaphore_T_ptrArray8 : IFixedPtrArray<_VkSemaphore_T>
{
    public static readonly int Size = 8;
    public readonly int Length => 8;
    #pragma warning disable CS9084
    ...
    #pragma warning restore CS9084
    public static implicit operator Span<IntPtr>(_VkSemaphore_T_ptrArray8 array) => array.AsSpan();
    public static implicit operator ReadOnlySpan<IntPtr>(_VkSemaphore_T_ptrArray8 array) => array.AsReadOnlySpan();
    private static void CheckIndex(int index)
    {
        if ((uint)index >= 8) throw new ArgumentOutOfRangeException();
    }
...
[StructLayout(LayoutKind.Sequential)]
public unsafe struct byte_ptrArray8 : IFixedPtrArray<byte>
{
    public static readonly int Size = 8;
    public readonly int Length => 8;
    #pragma warning disable CS9084
    ...
    public ref byte* GetPinnableReference() => ref _0;
    #pragma warning restore CS9084
    public static implicit operator Span<IntPtr>(byte_ptrArray8 array) => array.AsSpan();
    public static implicit operator ReadOnlySpan<IntPtr>(byte_ptrArray8 array) => array.AsReadOnlySpan();
    private static void CheckIndex(int index)
    {
        if ((uint)index >= 8) throw new ArgumentOutOfRangeException();
    }
...
public unsafe struct byte_array8 : IFixedArray<byte>
{
    ...
    public static implicit operator Span<byte>(byte_array8 array) => array.AsSpan();
    public static implicit operator ReadOnlySpan<byte>(byte_array8 array) => array.AsReadOnlySpan();
    private static void CheckIndex(int index)
    {
        if ((uint)index >= 8) throw new ArgumentOutOfRangeException();
    }
...
public unsafe struct int_array8 : IFixedArray<int>
{
    ...
    public static implicit operator Span<int>(int_array8 array) => array.AsSpan();
    public static implicit operator ReadOnlySpan<int>(int_array8 array) => array.AsReadOnlySpan();
    private static void CheckIndex(int index)
    {
        if ((uint)index >= 8) throw new ArgumentOutOfRangeException();
    }
...
public unsafe struct long_array8 : IFixedArray<long>
{
    ...
    public static implicit operator Span<long>(long_array8 array) => array.AsSpan();
    public static implicit operator ReadOnlySpan<long>(long_array8 array) => array.AsReadOnlySpan();
    private static void CheckIndex(int index)
    {
        if ((uint)index >= 8) throw new ArgumentOutOfRangeException();
    }
...
public unsafe struct uint_array8 : IFixedArray<uint>
{
    ...
    public static implicit operator Span<uint>(uint_array8 array) => array.AsSpan();
    public static implicit operator ReadOnlySpan<uint>(uint_array8 array) => array.AsReadOnlySpan();
    private static void CheckIndex(int index)
    {
        if ((uint)index >= 8) throw new ArgumentOutOfRangeException();
    }
...
public unsafe struct ulong_array8 : IFixedArray<ulong>
{
    ...
    public static implicit operator Span<ulong>(ulong_array8 array) => array.AsSpan();
    public static implicit operator ReadOnlySpan<ulong>(ulong_array8 array) => array.AsReadOnlySpan();
    private static void CheckIndex(int index)
    {
        if ((uint)index >= 8) throw new ArgumentOutOfRangeException();
    }
...
public unsafe struct ushort_array8 : IFixedArray<ushort>
{
    ...
    public static implicit operator Span<ushort>(ushort_array8 array) => array.AsSpan();
    public static implicit operator ReadOnlySpan<ushort>(ushort_array8 array) => array.AsReadOnlySpan();
    private static void CheckIndex(int index)
    {
        if ((uint)index >= 8) throw new ArgumentOutOfRangeException();
    }
...
[StructLayout(LayoutKind.Sequential)]
public unsafe struct void_ptrArray8 : IFixedPtrArray
{
    public static readonly int Size = 8;
    public readonly int Length => 8;
    #pragma warning disable CS9084
    ...
    public ReadOnlySpan<IntPtr> AsReadOnlySpan() { fixed(void* ptr = &_0) return new ReadOnlySpan<IntPtr>(ptr, 8); }
    #pragma warning restore CS9084
    public static implicit operator Span<IntPtr>(void_ptrArray8 array) => array.AsSpan();
    public static implicit operator ReadOnlySpan<IntPtr>(void_ptrArray8 array) => array.AsReadOnlySpan();
    private static void CheckIndex(int index)
    {
        if ((uint)index >= 8) throw new ArgumentOutOfRangeException();
    }
...
public unsafe struct int_array9 : IFixedArray<int>
{
    ...
    public static implicit operator Span<int>(int_array9 array) => array.AsSpan();
    public static implicit operator ReadOnlySpan<int>(int_array9 array) => array.AsReadOnlySpan();
    private static void CheckIndex(int index)
    {
...
public unsafe struct _AVHDRPlusPercentile_array15 : IFixedArray<_AVHDRPlusPercentile>
{
    ...
    public static implicit operator Span<_AVHDRPlusPercentile>(_AVHDRPlusPercentile_array15 array) => array.AsSpan();
    public static implicit operator ReadOnlySpan<_AVHDRPlusPercentile>(_AVHDRPlusPercentile_array15 array) => array.AsReadOnlySpan();
    private static void CheckIndex(int index)
    {
...
public unsafe struct _AVRational_array15 : IFixedArray<_AVRational>
{
    ...
    public static implicit operator Span<_AVRational>(_AVRational_array15 array) => array.AsSpan();
    public static implicit operator ReadOnlySpan<_AVRational>(_AVRational_array15 array) => array.AsReadOnlySpan();
    private static void CheckIndex(int index)
    {
        if ((uint)index >= 15) throw new ArgumentOutOfRangeException();
    }
...
public unsafe struct byte_array16 : IFixedArray<byte>
{
    ...
    public static implicit operator Span<byte>(byte_array16 array) => array.AsSpan();
    public static implicit operator ReadOnlySpan<byte>(byte_array16 array) => array.AsReadOnlySpan();
    private static void CheckIndex(int index)
    {
...
public unsafe struct _AVRational_array25 : IFixedArray<_AVRational>
{
    ...
    public static implicit operator Span<_AVRational>(_AVRational_array25 array) => array.AsSpan();
    public static implicit operator ReadOnlySpan<_AVRational>(_AVRational_array25 array) => array.AsReadOnlySpan();
    private static void CheckIndex(int index)
    {
...
public unsafe struct _AVRational_array25x25 : IFixedArray<_AVRational_array25>
{
    ...
    public readonly int Length => 25;
    #pragma warning disable CS9084
    _AVRational_array25 _0,_1,_2,_3,_4,_5,_6,_7,_8,_9,_10,_11,_12,_13,_14,_15,_16,_17,_18,_19,_20,_21,_22,_23,_24;
    
    public ref _AVRational_array25 this[int i] 
    {
        get { CheckIndex(i); return ref Unsafe.Add(ref _0, i); }
    }
    public ref _AVRational_array25 this[uint i] 
    {
        get {  CheckIndex(i); return ref Unsafe.Add(ref _0, i); }
    }
    public _AVRational_array25[] ToArray()
    {
        var a = new _AVRational_array25[25];
        for (int i = 0; i < 25; i++) a[i] = this[i];
        return a;
    }
    ...
    [EditorBrowsable(EditorBrowsableState.Never)]
    public ref _AVRational_array25 GetPinnableReference() => ref _0;
    #pragma warning restore CS9084
    public Span<_AVRational_array25> AsSpan() { fixed(void* ptr = &_0) return new Span<_AVRational_array25>(ptr, 25); }
    public ReadOnlySpan<_AVRational_array25> AsReadOnlySpan() { fixed(void* ptr = &_0) return new ReadOnlySpan<_AVRational_array25>(ptr, 25); }
    public static implicit operator Span<_AVRational_array25>(_AVRational_array25x25 array) => array.AsSpan();
    public static implicit operator ReadOnlySpan<_AVRational_array25>(_AVRational_array25x25 array) => array.AsReadOnlySpan();
    private static void CheckIndex(int index)
    {
        if ((uint)index >= 25) throw new ArgumentOutOfRangeException();
    }
...
public unsafe struct ushort_array32 : IFixedArray<ushort>
{
    ...
    public static implicit operator Span<ushort>(ushort_array32 array) => array.AsSpan();
    public static implicit operator ReadOnlySpan<ushort>(ushort_array32 array) => array.AsReadOnlySpan();
    private static void CheckIndex(int index)
    {
...
public unsafe struct _AVVulkanDeviceQueueFamily_array64 : IFixedArray<_AVVulkanDeviceQueueFamily>
{
    ...
    public static implicit operator Span<_AVVulkanDeviceQueueFamily>(_AVVulkanDeviceQueueFamily_array64 array) => array.AsSpan();
    public static implicit operator ReadOnlySpan<_AVVulkanDeviceQueueFamily>(_AVVulkanDeviceQueueFamily_array64 array) => array.AsReadOnlySpan();
    private static void CheckIndex(int index)
    {
