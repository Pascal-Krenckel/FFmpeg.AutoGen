...
public static unsafe partial class ffmpeg
{
    ...
    public static int av_add_index_entry(_AVStream* @st, long @pos, long @timestamp, int @size, int @distance, int @flags) => vectors.av_add_index_entry(@st, @pos, @timestamp, @size, @distance, @flags);
    
    /// <summary>Add two rationals.</summary>
    /// <param name="b">First rational</param>
    /// <param name="c">Second rational</param>
    public static _AVRational av_add_q(_AVRational @b, _AVRational @c) => vectors.av_add_q(@b, @c);
    ...
    public static long av_add_stable(_AVRational @ts_tb, long @ts, _AVRational @inc_tb, long @inc) => vectors.av_add_stable(@ts_tb, @ts, @inc_tb, @inc);
    ...
    public static int av_append_packet(_AVIOContext* @s, _AVPacket* @pkt, int @size) => vectors.av_append_packet(@s, @pkt, @size);
    ...
    public static _AVAudioFifo* av_audio_fifo_alloc(_AVSampleFormat @sample_fmt, int @channels, int @nb_samples) => vectors.av_audio_fifo_alloc(@sample_fmt, @channels, @nb_samples);
    ...
    public static int av_audio_fifo_drain(_AVAudioFifo* @af, int @nb_samples) => vectors.av_audio_fifo_drain(@af, @nb_samples);
    
    /// <summary>Free an AVAudioFifo.</summary>
    /// <param name="af">AVAudioFifo to free</param>
    public static void av_audio_fifo_free(_AVAudioFifo* @af) => vectors.av_audio_fifo_free(@af);
    ...
    public static int av_audio_fifo_peek(_AVAudioFifo* @af, void** @data, int @nb_samples) => vectors.av_audio_fifo_peek(@af, @data, @nb_samples);
    ...
    public static int av_audio_fifo_peek_at(_AVAudioFifo* @af, void** @data, int @nb_samples, int @offset) => vectors.av_audio_fifo_peek_at(@af, @data, @nb_samples, @offset);
    
    /// <summary>Read data from an AVAudioFifo.</summary>
    /// <param name="af">AVAudioFifo to read from</param>
    /// <param name="data">audio data plane pointers</param>
    /// <param name="nb_samples">number of samples to read</param>
    public static int av_audio_fifo_read(_AVAudioFifo* @af, void** @data, int @nb_samples) => vectors.av_audio_fifo_read(@af, @data, @nb_samples);
    ...
    public static int av_audio_fifo_realloc(_AVAudioFifo* @af, int @nb_samples) => vectors.av_audio_fifo_realloc(@af, @nb_samples);
    
    /// <summary>Reset the AVAudioFifo buffer.</summary>
    /// <param name="af">AVAudioFifo to reset</param>
    public static void av_audio_fifo_reset(_AVAudioFifo* @af) => vectors.av_audio_fifo_reset(@af);
    ...
    public static int av_audio_fifo_size(_AVAudioFifo* @af) => vectors.av_audio_fifo_size(@af);
    
    /// <summary>Get the current number of samples in the AVAudioFifo available for writing.</summary>
    /// <param name="af">the AVAudioFifo to query</param>
    public static int av_audio_fifo_space(_AVAudioFifo* @af) => vectors.av_audio_fifo_space(@af);
    ...
    public static int av_audio_fifo_write(_AVAudioFifo* @af, void** @data, int @nb_samples) => vectors.av_audio_fifo_write(@af, @data, @nb_samples);
    ...
    public static int av_bsf_alloc(_AVBitStreamFilter* @filter, _AVBSFContext** @ctx) => vectors.av_bsf_alloc(@filter, @ctx);
    
    /// <summary>Reset the internal bitstream filter state. Should be called e.g. when seeking.</summary>
    public static void av_bsf_flush(_AVBSFContext* @ctx) => vectors.av_bsf_flush(@ctx);
    
    /// <summary>Free a bitstream filter context and everything associated with it; write NULL into the supplied pointer.</summary>
    public static void av_bsf_free(_AVBSFContext** @ctx) => vectors.av_bsf_free(@ctx);
    ...
    public static int av_bsf_list_append(_AVBSFList* @lst, _AVBSFContext* @bsf) => vectors.av_bsf_list_append(@lst, @bsf);
    ...
    public static int av_bsf_list_finalize(_AVBSFList** @lst, _AVBSFContext** @bsf) => vectors.av_bsf_list_finalize(@lst, @bsf);
    
    /// <summary>Free list of bitstream filters.</summary>
    /// <param name="lst">Pointer to pointer returned by av_bsf_list_alloc()</param>
    public static void av_bsf_list_free(_AVBSFList** @lst) => vectors.av_bsf_list_free(@lst);
    ...
    public static int av_bsf_receive_packet(_AVBSFContext* @ctx, _AVPacket* @pkt) => vectors.av_bsf_receive_packet(@ctx, @pkt);
    ...
    public static _AVBufferRef* av_buffer_allocz(ulong @size) => vectors.av_buffer_allocz(@size);
    ...
    public static _AVBufferRef* av_buffer_create(byte* @data, ulong @size, av_buffer_create_free_func @free, void* @opaque, int @flags) => vectors.av_buffer_create(@data, @size, @free, @opaque, @flags);
    ...
    public static void* av_buffer_get_opaque(_AVBufferRef* @buf) => vectors.av_buffer_get_opaque(@buf);
    
    public static int av_buffer_get_ref_count(_AVBufferRef* @buf) => vectors.av_buffer_get_ref_count(@buf);
    ...
    public static int av_buffer_is_writable(_AVBufferRef* @buf) => vectors.av_buffer_is_writable(@buf);
    ...
    public static int av_buffer_make_writable(_AVBufferRef** @buf) => vectors.av_buffer_make_writable(@buf);
    ...
    public static void* av_buffer_pool_buffer_get_opaque(_AVBufferRef* @ref) => vectors.av_buffer_pool_buffer_get_opaque(@ref);
    ...
    public static _AVBufferRef* av_buffer_pool_get(_AVBufferPool* @pool) => vectors.av_buffer_pool_get(@pool);
    ...
    public static _AVBufferPool* av_buffer_pool_init(ulong @size, av_buffer_pool_init_alloc_func @alloc) => vectors.av_buffer_pool_init(@size, @alloc);
    ...
    public static _AVBufferPool* av_buffer_pool_init2(ulong @size, void* @opaque, av_buffer_pool_init2_alloc_func @alloc, av_buffer_pool_init2_pool_free_func @pool_free) => vectors.av_buffer_pool_init2(@size, @opaque, @alloc, @pool_free);
    ...
    public static void av_buffer_pool_uninit(_AVBufferPool** @pool) => vectors.av_buffer_pool_uninit(@pool);
    ...
    public static int av_buffer_realloc(_AVBufferRef** @buf, ulong @size) => vectors.av_buffer_realloc(@buf, @size);
    
    /// <summary>Create a new reference to an AVBuffer.</summary>
    public static _AVBufferRef* av_buffer_ref(_AVBufferRef* @buf) => vectors.av_buffer_ref(@buf);
    ...
    public static int av_buffer_replace(_AVBufferRef** @dst, _AVBufferRef* @src) => vectors.av_buffer_replace(@dst, @src);
    ...
    public static void av_buffer_unref(_AVBufferRef** @buf) => vectors.av_buffer_unref(@buf);
    
    public static _AVAlphaMode av_buffersink_get_alpha_mode(_AVFilterContext* @ctx) => vectors.av_buffersink_get_alpha_mode(@ctx);
    
    public static int av_buffersink_get_ch_layout(_AVFilterContext* @ctx, _AVChannelLayout* @ch_layout) => vectors.av_buffersink_get_ch_layout(@ctx, @ch_layout);
    
    public static int av_buffersink_get_channels(_AVFilterContext* @ctx) => vectors.av_buffersink_get_channels(@ctx);
    
    public static _AVColorRange av_buffersink_get_color_range(_AVFilterContext* @ctx) => vectors.av_buffersink_get_color_range(@ctx);
    
    public static _AVColorSpace av_buffersink_get_colorspace(_AVFilterContext* @ctx) => vectors.av_buffersink_get_colorspace(@ctx);
    
    public static int av_buffersink_get_format(_AVFilterContext* @ctx) => vectors.av_buffersink_get_format(@ctx);
    ...
    public static int av_buffersink_get_frame(_AVFilterContext* @ctx, _AVFrame* @frame) => vectors.av_buffersink_get_frame(@ctx, @frame);
    ...
    public static int av_buffersink_get_frame_flags(_AVFilterContext* @ctx, _AVFrame* @frame, int @flags) => vectors.av_buffersink_get_frame_flags(@ctx, @frame, @flags);
    
    public static _AVRational av_buffersink_get_frame_rate(_AVFilterContext* @ctx) => vectors.av_buffersink_get_frame_rate(@ctx);
    
    public static int av_buffersink_get_h(_AVFilterContext* @ctx) => vectors.av_buffersink_get_h(@ctx);
    
    public static _AVBufferRef* av_buffersink_get_hw_frames_ctx(_AVFilterContext* @ctx) => vectors.av_buffersink_get_hw_frames_ctx(@ctx);
    
    public static _AVRational av_buffersink_get_sample_aspect_ratio(_AVFilterContext* @ctx) => vectors.av_buffersink_get_sample_aspect_ratio(@ctx);
    
    public static int av_buffersink_get_sample_rate(_AVFilterContext* @ctx) => vectors.av_buffersink_get_sample_rate(@ctx);
    ...
    public static int av_buffersink_get_samples(_AVFilterContext* @ctx, _AVFrame* @frame, int @nb_samples) => vectors.av_buffersink_get_samples(@ctx, @frame, @nb_samples);
    
    public static _AVFrameSideData** av_buffersink_get_side_data(_AVFilterContext* @ctx, int* @nb_side_data) => vectors.av_buffersink_get_side_data(@ctx, @nb_side_data);
    
    public static _AVRational av_buffersink_get_time_base(_AVFilterContext* @ctx) => vectors.av_buffersink_get_time_base(@ctx);
    
    /// <summary>Get the properties of the stream @{</summary>
    public static _AVMediaType av_buffersink_get_type(_AVFilterContext* @ctx) => vectors.av_buffersink_get_type(@ctx);
    
    public static int av_buffersink_get_w(_AVFilterContext* @ctx) => vectors.av_buffersink_get_w(@ctx);
    
    /// <summary>Set the frame size for an audio buffer sink.</summary>
    public static void av_buffersink_set_frame_size(_AVFilterContext* @ctx, uint @frame_size) => vectors.av_buffersink_set_frame_size(@ctx, @frame_size);
    ...
    public static int av_buffersrc_add_frame(_AVFilterContext* @ctx, _AVFrame* @frame) => vectors.av_buffersrc_add_frame(@ctx, @frame);
    ...
    public static int av_buffersrc_add_frame_flags(_AVFilterContext* @buffer_src, _AVFrame* @frame, int @flags) => vectors.av_buffersrc_add_frame_flags(@buffer_src, @frame, @flags);
    
    /// <summary>Close the buffer source after EOF.</summary>
    public static int av_buffersrc_close(_AVFilterContext* @ctx, long @pts, uint @flags) => vectors.av_buffersrc_close(@ctx, @pts, @flags);
    
    /// <summary>Get the number of failed requests.</summary>
    public static uint av_buffersrc_get_nb_failed_requests(_AVFilterContext* @buffer_src) => vectors.av_buffersrc_get_nb_failed_requests(@buffer_src);
    ...
    public static int av_buffersrc_get_status(_AVFilterContext* @ctx) => vectors.av_buffersrc_get_status(@ctx);
    
    /// <summary>Allocate a new AVBufferSrcParameters instance. It should be freed by the caller with av_free().</summary>
    public static _AVBufferSrcParameters* av_buffersrc_parameters_alloc() => vectors.av_buffersrc_parameters_alloc();
    ...
    public static int av_buffersrc_parameters_set(_AVFilterContext* @ctx, _AVBufferSrcParameters* @param) => vectors.av_buffersrc_parameters_set(@ctx, @param);
    ...
    public static int av_buffersrc_write_frame(_AVFilterContext* @ctx, _AVFrame* @frame) => vectors.av_buffersrc_write_frame(@ctx, @frame);
    ...
    public static int av_channel_description(byte* @buf, ulong @buf_size, _AVChannel @channel) => vectors.av_channel_description(@buf, @buf_size, @channel);
    
    /// <summary>bprint variant of av_channel_description().</summary>
    public static void av_channel_description_bprint(_AVBPrint* @bp, _AVChannel @channel_id) => vectors.av_channel_description_bprint(@bp, @channel_id);
    ...
    public static _AVChannel av_channel_layout_channel_from_index(_AVChannelLayout* @channel_layout, uint @idx) => vectors.av_channel_layout_channel_from_index(@channel_layout, @idx);
    ...
    /// <param name="channel_layout">input channel layout</param>
    public static int av_channel_layout_check(_AVChannelLayout* @channel_layout) => vectors.av_channel_layout_check(@channel_layout);
    ...
    public static int av_channel_layout_compare(_AVChannelLayout* @chl, _AVChannelLayout* @chl1) => vectors.av_channel_layout_compare(@chl, @chl1);
    ...
    public static int av_channel_layout_copy(_AVChannelLayout* @dst, _AVChannelLayout* @src) => vectors.av_channel_layout_copy(@dst, @src);
    ...
    public static int av_channel_layout_custom_init(_AVChannelLayout* @channel_layout, int @nb_channels) => vectors.av_channel_layout_custom_init(@channel_layout, @nb_channels);
    ...
    public static void av_channel_layout_default(_AVChannelLayout* @ch_layout, int @nb_channels) => vectors.av_channel_layout_default(@ch_layout, @nb_channels);
    ...
    /// <param name="buf">pre-allocated buffer where to put the generated string</param>
    /// <param name="buf_size">size in bytes of the buffer.</param>
    public static int av_channel_layout_describe(_AVChannelLayout* @channel_layout, byte* @buf, ulong @buf_size) => vectors.av_channel_layout_describe(@channel_layout, @buf, @buf_size);
    
    /// <summary>bprint variant of av_channel_layout_describe().</summary>
    public static int av_channel_layout_describe_bprint(_AVChannelLayout* @channel_layout, _AVBPrint* @bp) => vectors.av_channel_layout_describe_bprint(@channel_layout, @bp);
    ...
    public static int av_channel_layout_from_mask(_AVChannelLayout* @channel_layout, ulong @mask) => vectors.av_channel_layout_from_mask(@channel_layout, @mask);
    ...
    public static int av_channel_layout_index_from_channel(_AVChannelLayout* @channel_layout, _AVChannel @channel) => vectors.av_channel_layout_index_from_channel(@channel_layout, @channel);
    ...
    public static int av_channel_layout_retype(_AVChannelLayout* @channel_layout, _AVChannelOrder @order, int @flags) => vectors.av_channel_layout_retype(@channel_layout, @order, @flags);
    ...
    public static _AVChannelLayout* av_channel_layout_standard(void** @opaque) => vectors.av_channel_layout_standard(@opaque);
    ...
    public static ulong av_channel_layout_subset(_AVChannelLayout* @channel_layout, ulong @mask) => vectors.av_channel_layout_subset(@channel_layout, @mask);
    ...
    public static void av_channel_layout_uninit(_AVChannelLayout* @channel_layout) => vectors.av_channel_layout_uninit(@channel_layout);
    ...
    public static int av_channel_name(byte* @buf, ulong @buf_size, _AVChannel @channel) => vectors.av_channel_name(@buf, @buf_size, @channel);
    
    /// <summary>bprint variant of av_channel_name().</summary>
    public static void av_channel_name_bprint(_AVBPrint* @bp, _AVChannel @channel_id) => vectors.av_channel_name_bprint(@bp, @channel_id);
    ...
    public static int av_chroma_location_enum_to_pos(int* @xpos, int* @ypos, _AVChromaLocation @pos) => vectors.av_chroma_location_enum_to_pos(@xpos, @ypos, @pos);
    ...
    /// <param name="xpos">horizontal chroma sample position</param>
    /// <param name="ypos">vertical   chroma sample position</param>
    public static _AVChromaLocation av_chroma_location_pos_to_enum(int @xpos, int @ypos) => vectors.av_chroma_location_pos_to_enum(@xpos, @ypos);
    ...
    public static _AVCodecID av_codec_get_id(_AVCodecTag** @tags, uint @tag) => vectors.av_codec_get_id(@tags, @tag);
    ...
    public static uint av_codec_get_tag(_AVCodecTag** @tags, _AVCodecID @id) => vectors.av_codec_get_tag(@tags, @id);
    ...
    public static int av_codec_get_tag2(_AVCodecTag** @tags, _AVCodecID @id, uint* @tag) => vectors.av_codec_get_tag2(@tags, @id, @tag);
    
    /// <summary>Returns a non-zero number if codec is a decoder, zero otherwise</summary>
    public static int av_codec_is_decoder(_AVCodec* @codec) => vectors.av_codec_is_decoder(@codec);
    
    /// <summary>Returns a non-zero number if codec is an encoder, zero otherwise</summary>
    public static int av_codec_is_encoder(_AVCodec* @codec) => vectors.av_codec_is_encoder(@codec);
    
    /// <summary>Iterate over all registered codecs.</summary>
    /// <param name="opaque">a pointer where libavcodec will store the iteration state. Must point to NULL to start the iteration.</param>
    public static _AVCodec* av_codec_iterate(void** @opaque) => vectors.av_codec_iterate(@opaque);
    ...
    public static int av_compare_ts(long @ts_a, _AVRational @tb_a, long @ts_b, _AVRational @tb_b) => vectors.av_compare_ts(@ts_a, @tb_a, @ts_b, @tb_b);
    
    /// <summary>Allocate an AVContainerFifo instance for AVPacket.</summary>
    /// <param name="flags">currently unused</param>
    public static _AVContainerFifo* av_container_fifo_alloc_avpacket(uint @flags) => vectors.av_container_fifo_alloc_avpacket(@flags);
    ...
    public static _AVContentLightMetadata* av_content_light_metadata_alloc(ulong* @size) => vectors.av_content_light_metadata_alloc(@size);
    ...
    public static _AVContentLightMetadata* av_content_light_metadata_create_side_data(_AVFrame* @frame) => vectors.av_content_light_metadata_create_side_data(@frame);
    ...
    public static _AVCPBProperties* av_cpb_properties_alloc(ulong* @size) => vectors.av_cpb_properties_alloc(@size);
    ...
    public static _AVRational av_d2q(double @d, int @max) => vectors.av_d2q(@d, @max);
    
    /// <summary>Allocate an AVD3D11VAContext.</summary>
    public static _AVD3D11VAContext* av_d3d11va_alloc_context() => vectors.av_d3d11va_alloc_context();
    
    public static _AVClassCategory av_default_get_category(void* @ptr) => vectors.av_default_get_category(@ptr);
    ...
    public static _AVInputFormat* av_demuxer_iterate(void** @opaque) => vectors.av_demuxer_iterate(@opaque);
    ...
    public static int av_dict_copy(_AVDictionary** @dst, _AVDictionary* @src, int @flags) => vectors.av_dict_copy(@dst, @src, @flags);
    
    /// <summary>Get number of entries in dictionary.</summary>
    /// <param name="m">dictionary</param>
    public static int av_dict_count(_AVDictionary* @m) => vectors.av_dict_count(@m);
    
    /// <summary>Free all the memory allocated for an AVDictionary struct and all keys and values.</summary>
    public static void av_dict_free(_AVDictionary** @m) => vectors.av_dict_free(@m);
    ...
    public static int av_dict_get_string(_AVDictionary* @m, byte** @buffer, byte @key_val_sep, byte @pairs_sep) => vectors.av_dict_get_string(@m, @buffer, @key_val_sep, @pairs_sep);
    ...
    public static _AVDictionaryEntry* av_dict_iterate(_AVDictionary* @m, _AVDictionaryEntry* @prev) => vectors.av_dict_iterate(@m, @prev);
    ...
    /// <param name="b">First rational</param>
    /// <param name="c">Second rational</param>
    public static _AVRational av_div_q(_AVRational @b, _AVRational @c) => vectors.av_div_q(@b, @c);
    ...
    /// <param name="frame">The frame which side data is added to.</param>
    public static _AVDynamicHDRPlus* av_dynamic_hdr_plus_create_side_data(_AVFrame* @frame) => vectors.av_dynamic_hdr_plus_create_side_data(@frame);
    ...
    public static int av_dynamic_hdr_plus_from_t35(_AVDynamicHDRPlus* @s, byte* @data, ulong @size) => vectors.av_dynamic_hdr_plus_from_t35(@s, @data, @size);
    ...
    public static _AVFilter* av_filter_iterate(void** @opaque) => vectors.av_filter_iterate(@opaque);
    ...
    public static _AVPixelFormat av_find_best_pix_fmt_of_2(_AVPixelFormat @dst_pix_fmt1, _AVPixelFormat @dst_pix_fmt2, _AVPixelFormat @src_pix_fmt, int @has_alpha, int* @loss_ptr) => vectors.av_find_best_pix_fmt_of_2(@dst_pix_fmt1, @dst_pix_fmt2, @src_pix_fmt, @has_alpha, @loss_ptr);
    ...
    public static int av_find_best_stream(_AVFormatContext* @ic, _AVMediaType @type, int @wanted_stream_nb, int @related_stream, _AVCodec** @decoder_ret, int @flags) => vectors.av_find_best_stream(@ic, @type, @wanted_stream_nb, @related_stream, @decoder_ret, @flags);
    
    public static int av_find_default_stream_index(_AVFormatContext* @s) => vectors.av_find_default_stream_index(@s);
    ...
    public static int av_find_nearest_q_idx(_AVRational @q, _AVRational* @q_list) => vectors.av_find_nearest_q_idx(@q, @q_list);
    ...
    public static _AVProgram* av_find_program_from_stream(_AVFormatContext* @ic, _AVProgram* @last, int @s) => vectors.av_find_program_from_stream(@ic, @last, @s);
    ...
    public static _AVFrame* av_frame_alloc() => vectors.av_frame_alloc();
    ...
    public static int av_frame_apply_cropping(_AVFrame* @frame, int @flags) => vectors.av_frame_apply_cropping(@frame, @flags);
    
    /// <summary>Create a new frame that references the same data as src.</summary>
    public static _AVFrame* av_frame_clone(_AVFrame* @src) => vectors.av_frame_clone(@src);
    
    /// <summary>Copy the frame data from src to dst.</summary>
    public static int av_frame_copy(_AVFrame* @dst, _AVFrame* @src) => vectors.av_frame_copy(@dst, @src);
    
    /// <summary>Copy only &quot;metadata&quot; fields from src to dst.</summary>
    public static int av_frame_copy_props(_AVFrame* @dst, _AVFrame* @src) => vectors.av_frame_copy_props(@dst, @src);
    ...
    public static void av_frame_free(_AVFrame** @frame) => vectors.av_frame_free(@frame);
    ...
    public static int av_frame_get_buffer(_AVFrame* @frame, int @align) => vectors.av_frame_get_buffer(@frame, @align);
    ...
    public static _AVBufferRef* av_frame_get_plane_buffer(_AVFrame* @frame, int @plane) => vectors.av_frame_get_plane_buffer(@frame, @plane);
    ...
    public static _AVFrameSideData* av_frame_get_side_data(_AVFrame* @frame, _AVFrameSideDataType @type) => vectors.av_frame_get_side_data(@frame, @type);
    
    /// <summary>Check if the frame data is writable.</summary>
    public static int av_frame_is_writable(_AVFrame* @frame) => vectors.av_frame_is_writable(@frame);
    
    /// <summary>Ensure that the frame data is writable, avoiding data copy if possible.</summary>
    public static int av_frame_make_writable(_AVFrame* @frame) => vectors.av_frame_make_writable(@frame);
    
    /// <summary>Move everything contained in src to dst and reset src.</summary>
    public static void av_frame_move_ref(_AVFrame* @dst, _AVFrame* @src) => vectors.av_frame_move_ref(@dst, @src);
    ...
    public static _AVFrameSideData* av_frame_new_side_data(_AVFrame* @frame, _AVFrameSideDataType @type, ulong @size) => vectors.av_frame_new_side_data(@frame, @type, @size);
    ...
    public static _AVFrameSideData* av_frame_new_side_data_from_buf(_AVFrame* @frame, _AVFrameSideDataType @type, _AVBufferRef* @buf) => vectors.av_frame_new_side_data_from_buf(@frame, @type, @buf);
    
    /// <summary>Set up a new reference to the data described by the source frame.</summary>
    public static int av_frame_ref(_AVFrame* @dst, _AVFrame* @src) => vectors.av_frame_ref(@dst, @src);
    
    /// <summary>Remove and free all side data instances of the given type.</summary>
    public static void av_frame_remove_side_data(_AVFrame* @frame, _AVFrameSideDataType @type) => vectors.av_frame_remove_side_data(@frame, @type);
    ...
    public static int av_frame_replace(_AVFrame* @dst, _AVFrame* @src) => vectors.av_frame_replace(@dst, @src);
    ...
    public static _AVFrameSideData* av_frame_side_data_add(_AVFrameSideData*** @sd, int* @nb_sd, _AVFrameSideDataType @type, _AVBufferRef** @buf, uint @flags) => vectors.av_frame_side_data_add(@sd, @nb_sd, @type, @buf, @flags);
    ...
    /// <param name="flags">Some combination of AV_FRAME_SIDE_DATA_FLAG_* flags, or 0.</param>
    public static int av_frame_side_data_clone(_AVFrameSideData*** @sd, int* @nb_sd, _AVFrameSideData* @src, uint @flags) => vectors.av_frame_side_data_clone(@sd, @nb_sd, @src, @flags);
    
    /// <summary>Returns side data descriptor corresponding to a given side data type, NULL when not available.</summary>
    public static _AVSideDataDescriptor* av_frame_side_data_desc(_AVFrameSideDataType @type) => vectors.av_frame_side_data_desc(@type);
    ...
    public static void av_frame_side_data_free(_AVFrameSideData*** @sd, int* @nb_sd) => vectors.av_frame_side_data_free(@sd, @nb_sd);
    ...
    public static _AVFrameSideData* av_frame_side_data_get_c(_AVFrameSideData** @sd, int @nb_sd, _AVFrameSideDataType @type) => vectors.av_frame_side_data_get_c(@sd, @nb_sd, @type);
    
    /// <summary>Returns a string identifying the side data type</summary>
    public static string av_frame_side_data_name(_AVFrameSideDataType @type) => vectors.av_frame_side_data_name(@type);
    ...
    /// <param name="size">size of the side data</param>
    /// <param name="flags">Some combination of AV_FRAME_SIDE_DATA_FLAG_* flags, or 0.</param>
    public static _AVFrameSideData* av_frame_side_data_new(_AVFrameSideData*** @sd, int* @nb_sd, _AVFrameSideDataType @type, ulong @size, uint @flags) => vectors.av_frame_side_data_new(@sd, @nb_sd, @type, @size, @flags);
    
    /// <summary>Remove and free all side data instances of the given type from an array.</summary>
    public static void av_frame_side_data_remove(_AVFrameSideData*** @sd, int* @nb_sd, _AVFrameSideDataType @type) => vectors.av_frame_side_data_remove(@sd, @nb_sd, @type);
    ...
    public static void av_frame_side_data_remove_by_props(_AVFrameSideData*** @sd, int* @nb_sd, int @props) => vectors.av_frame_side_data_remove_by_props(@sd, @nb_sd, @props);
    
    /// <summary>Unreference all the buffers referenced by frame and reset the frame fields.</summary>
    public static void av_frame_unref(_AVFrame* @frame) => vectors.av_frame_unref(@frame);
    ...
    public static _AVRational av_gcd_q(_AVRational @a, _AVRational @b, int @max_den, _AVRational @def) => vectors.av_gcd_q(@a, @b, @max_den, @def);
    ...
    public static _AVSampleFormat av_get_alt_sample_fmt(_AVSampleFormat @sample_fmt, int @planar) => vectors.av_get_alt_sample_fmt(@sample_fmt, @planar);
    ...
    public static int av_get_bits_per_pixel(_AVPixFmtDescriptor* @pixdesc) => vectors.av_get_bits_per_pixel(@pixdesc);
    
    /// <summary>Return codec bits per sample.</summary>
    /// <param name="codec_id">the codec</param>
    public static int av_get_bits_per_sample(_AVCodecID @codec_id) => vectors.av_get_bits_per_sample(@codec_id);
    
    /// <summary>Return number of bytes per sample.</summary>
    /// <param name="sample_fmt">the sample format</param>
    public static int av_get_bytes_per_sample(_AVSampleFormat @sample_fmt) => vectors.av_get_bytes_per_sample(@sample_fmt);
    ...
    /// <param name="codec_id">the codec</param>
    public static int av_get_exact_bits_per_sample(_AVCodecID @codec_id) => vectors.av_get_exact_bits_per_sample(@codec_id);
    ...
    public static int av_get_output_timestamp(_AVFormatContext* @s, int @stream, long* @dts, long* @wall) => vectors.av_get_output_timestamp(@s, @stream, @dts, @wall);
    
    /// <summary>Get the packed alternative form of the given sample format.</summary>
    public static _AVSampleFormat av_get_packed_sample_fmt(_AVSampleFormat @sample_fmt) => vectors.av_get_packed_sample_fmt(@sample_fmt);
    ...
    public static int av_get_packet(_AVIOContext* @s, _AVPacket* @pkt, int @size) => vectors.av_get_packet(@s, @pkt, @size);
    ...
    public static int av_get_padded_bits_per_pixel(_AVPixFmtDescriptor* @pixdesc) => vectors.av_get_padded_bits_per_pixel(@pixdesc);
    ...
    public static _AVCodecID av_get_pcm_codec(_AVSampleFormat @fmt, int @be) => vectors.av_get_pcm_codec(@fmt, @be);
    ...
    public static byte av_get_picture_type_char(_AVPictureType @pict_type) => vectors.av_get_picture_type_char(@pict_type);
    ...
    /// <param name="src_pix_fmt">source pixel format</param>
    /// <param name="has_alpha">Whether the source pixel format alpha channel is used.</param>
    public static int av_get_pix_fmt_loss(_AVPixelFormat @dst_pix_fmt, _AVPixelFormat @src_pix_fmt, int @has_alpha) => vectors.av_get_pix_fmt_loss(@dst_pix_fmt, @src_pix_fmt, @has_alpha);
    
    /// <summary>Return the short name for a pixel format, NULL in case pix_fmt is unknown.</summary>
    public static string av_get_pix_fmt_name(_AVPixelFormat @pix_fmt) => vectors.av_get_pix_fmt_name(@pix_fmt);
    ...
    public static byte* av_get_pix_fmt_string(byte* @buf, int @buf_size, _AVPixelFormat @pix_fmt) => vectors.av_get_pix_fmt_string(@buf, @buf_size, @pix_fmt);
    
    /// <summary>Get the planar alternative form of the given sample format.</summary>
    public static _AVSampleFormat av_get_planar_sample_fmt(_AVSampleFormat @sample_fmt) => vectors.av_get_planar_sample_fmt(@sample_fmt);
    ...
    public static string av_get_profile_name(_AVCodec* @codec, int @profile) => vectors.av_get_profile_name(@codec, @profile);
    ...
    public static byte* av_get_sample_fmt_string(byte* @buf, int @buf_size, _AVSampleFormat @sample_fmt) => vectors.av_get_sample_fmt_string(@buf, @buf_size, @sample_fmt);
    
    /// <summary>Return the fractional representation of the internal time base.</summary>
    public static _AVRational av_get_time_base_q() => vectors.av_get_time_base_q();
    ...
    public static int av_grow_packet(_AVPacket* @pkt, int @grow_by) => vectors.av_grow_packet(@pkt, @grow_by);
    ...
    public static _AVRational av_guess_frame_rate(_AVFormatContext* @ctx, _AVStream* @stream, _AVFrame* @frame) => vectors.av_guess_frame_rate(@ctx, @stream, @frame);
    ...
    public static _AVRational av_guess_sample_aspect_ratio(_AVFormatContext* @format, _AVStream* @stream, _AVFrame* @frame) => vectors.av_guess_sample_aspect_ratio(@format, @stream, @frame);
    ...
    public static void av_hex_dump(__iobuf* @f, byte* @buf, int @size) => vectors.av_hex_dump(@f, @buf, @size);
    ...
    public static _AVBufferRef* av_hwdevice_ctx_alloc(_AVHWDeviceType @type) => vectors.av_hwdevice_ctx_alloc(@type);
    ...
    public static int av_hwdevice_ctx_create_derived(_AVBufferRef** @dst_ctx, _AVHWDeviceType @type, _AVBufferRef* @src_ctx, int @flags) => vectors.av_hwdevice_ctx_create_derived(@dst_ctx, @type, @src_ctx, @flags);
    ...
    /// <param name="flags">Currently unused; should be set to zero.</param>
    public static int av_hwdevice_ctx_create_derived_opts(_AVBufferRef** @dst_ctx, _AVHWDeviceType @type, _AVBufferRef* @src_ctx, _AVDictionary* @options, int @flags) => vectors.av_hwdevice_ctx_create_derived_opts(@dst_ctx, @type, @src_ctx, @options, @flags);
    ...
    public static int av_hwdevice_ctx_init(_AVBufferRef* @ref) => vectors.av_hwdevice_ctx_init(@ref);
    ...
    public static _AVHWFramesConstraints* av_hwdevice_get_hwframe_constraints(_AVBufferRef* @ref, void* @hwconfig) => vectors.av_hwdevice_get_hwframe_constraints(@ref, @hwconfig);
    
    /// <summary>Get the string name of an AVHWDeviceType.</summary>
    /// <param name="type">Type from enum AVHWDeviceType.</param>
    public static string av_hwdevice_get_type_name(_AVHWDeviceType @type) => vectors.av_hwdevice_get_type_name(@type);
    ...
    public static void* av_hwdevice_hwconfig_alloc(_AVBufferRef* @device_ctx) => vectors.av_hwdevice_hwconfig_alloc(@device_ctx);
    ...
    public static _AVHWDeviceType av_hwdevice_iterate_types(_AVHWDeviceType @prev) => vectors.av_hwdevice_iterate_types(@prev);
    ...
    public static void av_hwframe_constraints_free(_AVHWFramesConstraints** @constraints) => vectors.av_hwframe_constraints_free(@constraints);
    ...
    public static _AVBufferRef* av_hwframe_ctx_alloc(_AVBufferRef* @device_ctx) => vectors.av_hwframe_ctx_alloc(@device_ctx);
    ...
    public static int av_hwframe_ctx_create_derived(_AVBufferRef** @derived_frame_ctx, _AVPixelFormat @format, _AVBufferRef* @derived_device_ctx, _AVBufferRef* @source_frame_ctx, int @flags) => vectors.av_hwframe_ctx_create_derived(@derived_frame_ctx, @format, @derived_device_ctx, @source_frame_ctx, @flags);
    ...
    public static int av_hwframe_ctx_init(_AVBufferRef* @ref) => vectors.av_hwframe_ctx_init(@ref);
    ...
    /// <param name="flags">currently unused, should be set to zero</param>
    public static int av_hwframe_get_buffer(_AVBufferRef* @hwframe_ctx, _AVFrame* @frame, int @flags) => vectors.av_hwframe_get_buffer(@hwframe_ctx, @frame, @flags);
    ...
    public static int av_hwframe_map(_AVFrame* @dst, _AVFrame* @src, int @flags) => vectors.av_hwframe_map(@dst, @src, @flags);
    ...
    /// <param name="flags">currently unused, should be set to zero</param>
    public static int av_hwframe_transfer_data(_AVFrame* @dst, _AVFrame* @src, int @flags) => vectors.av_hwframe_transfer_data(@dst, @src, @flags);
    ...
    /// <param name="flags">currently unused, should be set to zero</param>
    public static int av_hwframe_transfer_get_formats(_AVBufferRef* @hwframe_ctx, _AVHWFrameTransferDirection @dir, _AVPixelFormat** @formats, int @flags) => vectors.av_hwframe_transfer_get_formats(@hwframe_ctx, @dir, @formats, @flags);
    ...
    public static int av_image_alloc(ref byte_ptrArray4 @pointers, ref int_array4 @linesizes, int @w, int @h, _AVPixelFormat @pix_fmt, int @align) => vectors.av_image_alloc(ref @pointers, ref @linesizes, @w, @h, @pix_fmt, @align);
    ...
    public static int av_image_check_sar(uint @w, uint @h, _AVRational @sar) => vectors.av_image_check_sar(@w, @h, @sar);
    ...
    /// <param name="log_offset">the offset to sum to the log level for logging with log_ctx</param>
    /// <param name="log_ctx">the parent logging context, it may be NULL</param>
    public static int av_image_check_size2(uint @w, uint @h, long @max_pixels, _AVPixelFormat @pix_fmt, int @log_offset, void* @log_ctx) => vectors.av_image_check_size2(@w, @h, @max_pixels, @pix_fmt, @log_offset, @log_ctx);
    ...
    public static void av_image_copy(ref byte_ptrArray4 @dst_data, in int_array4 @dst_linesizes, in byte_ptrArray4 @src_data, in int_array4 @src_linesizes, _AVPixelFormat @pix_fmt, int @width, int @height) => vectors.av_image_copy(ref @dst_data, @dst_linesizes, @src_data, @src_linesizes, @pix_fmt, @width, @height);
    ...
    public static int av_image_copy_to_buffer(byte* @dst, int @dst_size, in byte_ptrArray4 @src_data, in int_array4 @src_linesize, _AVPixelFormat @pix_fmt, int @width, int @height, int @align) => vectors.av_image_copy_to_buffer(@dst, @dst_size, @src_data, @src_linesize, @pix_fmt, @width, @height, @align);
    ...
    public static void av_image_copy_uc_from(ref byte_ptrArray4 @dst_data, in long_array4 @dst_linesizes, in byte_ptrArray4 @src_data, in long_array4 @src_linesizes, _AVPixelFormat @pix_fmt, int @width, int @height) => vectors.av_image_copy_uc_from(ref @dst_data, @dst_linesizes, @src_data, @src_linesizes, @pix_fmt, @width, @height);
    ...
    public static int av_image_fill_arrays(ref byte_ptrArray4 @dst_data, ref int_array4 @dst_linesize, byte* @src, _AVPixelFormat @pix_fmt, int @width, int @height, int @align) => vectors.av_image_fill_arrays(ref @dst_data, ref @dst_linesize, @src, @pix_fmt, @width, @height, @align);
    ...
    /// <param name="width">the width of the image in pixels</param>
    /// <param name="height">the height of the image in pixels</param>
    public static int av_image_fill_black(ref byte_ptrArray4 @dst_data, in long_array4 @dst_linesize, _AVPixelFormat @pix_fmt, _AVColorRange @range, int @width, int @height) => vectors.av_image_fill_black(ref @dst_data, @dst_linesize, @pix_fmt, @range, @width, @height);
    ...
    /// <param name="height">the height of the image in pixels</param>
    /// <param name="flags">currently unused</param>
    public static int av_image_fill_color(ref byte_ptrArray4 @dst_data, in long_array4 @dst_linesize, _AVPixelFormat @pix_fmt, in uint_array4 @color, int @width, int @height, int @flags) => vectors.av_image_fill_color(ref @dst_data, @dst_linesize, @pix_fmt, @color, @width, @height, @flags);
    ...
    /// <param name="pix_fmt">the AVPixelFormat of the image</param>
    /// <param name="width">width of the image in pixels</param>
    public static int av_image_fill_linesizes(ref int_array4 @linesizes, _AVPixelFormat @pix_fmt, int @width) => vectors.av_image_fill_linesizes(ref @linesizes, @pix_fmt, @width);
    ...
    public static void av_image_fill_max_pixsteps(ref int_array4 @max_pixsteps, ref int_array4 @max_pixstep_comps, _AVPixFmtDescriptor* @pixdesc) => vectors.av_image_fill_max_pixsteps(ref @max_pixsteps, ref @max_pixstep_comps, @pixdesc);
    ...
    public static int av_image_fill_plane_sizes(ref ulong_array4 @size, _AVPixelFormat @pix_fmt, int @height, in long_array4 @linesizes) => vectors.av_image_fill_plane_sizes(ref @size, @pix_fmt, @height, @linesizes);
    ...
    /// <param name="linesizes">the array containing the linesize for each plane, should be filled by av_image_fill_linesizes()</param>
    public static int av_image_fill_pointers(ref byte_ptrArray4 @data, _AVPixelFormat @pix_fmt, int @height, byte* @ptr, in int_array4 @linesizes) => vectors.av_image_fill_pointers(ref @data, @pix_fmt, @height, @ptr, @linesizes);
    ...
    public static int av_image_get_buffer_size(_AVPixelFormat @pix_fmt, int @width, int @height, int @align) => vectors.av_image_get_buffer_size(@pix_fmt, @width, @height, @align);
    
    /// <summary>Compute the size of an image line with format pix_fmt and width width for the plane plane.</summary>
    public static int av_image_get_linesize(_AVPixelFormat @pix_fmt, int @width, int @plane) => vectors.av_image_get_linesize(@pix_fmt, @width, @plane);
    ...
    public static int av_index_search_timestamp(_AVStream* @st, long @timestamp, int @flags) => vectors.av_index_search_timestamp(@st, @timestamp, @flags);
    ...
    public static void av_init_packet(_AVPacket* @pkt) => vectors.av_init_packet(@pkt);
    
    /// <summary>Audio input devices iterator.</summary>
    public static _AVInputFormat* av_input_audio_device_next(_AVInputFormat* @d) => vectors.av_input_audio_device_next(@d);
    ...
    public static int av_interleaved_write_frame(_AVFormatContext* @s, _AVPacket* @pkt) => vectors.av_interleaved_write_frame(@s, @pkt);
    
    /// <summary>Write an uncoded frame to an output media file.</summary>
    public static int av_interleaved_write_uncoded_frame(_AVFormatContext* @s, int @stream_index, _AVFrame* @frame) => vectors.av_interleaved_write_uncoded_frame(@s, @stream_index, @frame);
    ...
    public static _AVMasteringDisplayMetadata* av_mastering_display_metadata_alloc() => vectors.av_mastering_display_metadata_alloc();
    
    /// <summary>Allocate an AVMasteringDisplayMetadata structure and set its fields to default values. The resulting struct can be freed using av_freep().</summary>
    public static _AVMasteringDisplayMetadata* av_mastering_display_metadata_alloc_size(ulong* @size) => vectors.av_mastering_display_metadata_alloc_size(@size);
    
    /// <summary>Allocate a complete AVMasteringDisplayMetadata and add it to the frame.</summary>
    /// <param name="frame">The frame which side data is added to.</param>
    public static _AVMasteringDisplayMetadata* av_mastering_display_metadata_create_side_data(_AVFrame* @frame) => vectors.av_mastering_display_metadata_create_side_data(@frame);
    ...
    public static int av_mime_codec_str(_AVCodecParameters* @par, _AVRational @frame_rate, _AVBPrint* @out) => vectors.av_mime_codec_str(@par, @frame_rate, @out);
    
    /// <summary>Multiply two rationals.</summary>
    /// <param name="b">First rational</param>
    /// <param name="c">Second rational</param>
    public static _AVRational av_mul_q(_AVRational @b, _AVRational @c) => vectors.av_mul_q(@b, @c);
    
    /// <summary>Iterate over all registered muxers.</summary>
    /// <param name="opaque">a pointer where libavformat will store the iteration state. Must point to NULL to start the iteration.</param>
    public static _AVOutputFormat* av_muxer_iterate(void** @opaque) => vectors.av_muxer_iterate(@opaque);
    ...
    public static int av_nearer_q(_AVRational @q, _AVRational @q1, _AVRational @q2) => vectors.av_nearer_q(@q, @q1, @q2);
    ...
    public static int av_new_packet(_AVPacket* @pkt, int @size) => vectors.av_new_packet(@pkt, @size);
    
    public static _AVProgram* av_new_program(_AVFormatContext* @s, int @id) => vectors.av_new_program(@s, @id);
    ...
    public static _AVClass* av_opt_child_class_iterate(_AVClass* @parent, void** @iter) => vectors.av_opt_child_class_iterate(@parent, @iter);
    ...
    public static _AVOption* av_opt_find(void* @obj, string @name, string @unit, int @opt_flags, int @search_flags) => vectors.av_opt_find(@obj, @name, @unit, @opt_flags, @search_flags);
    ...
    public static void av_opt_freep_ranges(_AVOptionRanges** @ranges) => vectors.av_opt_freep_ranges(@ranges);
    ...
    public static int av_opt_is_set_to_default(void* @obj, _AVOption* @o) => vectors.av_opt_is_set_to_default(@obj, @o);
    ...
    public static int av_opt_set_dict(void* @obj, _AVDictionary** @options) => vectors.av_opt_set_dict(@obj, @options);
    ...
    public static _AVOutputFormat* av_output_audio_device_next(_AVOutputFormat* @d) => vectors.av_output_audio_device_next(@d);
    
    /// <summary>Video output devices iterator.</summary>
    public static _AVOutputFormat* av_output_video_device_next(_AVOutputFormat* @d) => vectors.av_output_video_device_next(@d);
    ...
    public static int av_packet_add_side_data(_AVPacket* @pkt, _AVPacketSideDataType @type, byte* @data, ulong @size) => vectors.av_packet_add_side_data(@pkt, @type, @data, @size);
    ...
    public static _AVPacket* av_packet_alloc() => vectors.av_packet_alloc();
    
    /// <summary>Create a new packet that references the same data as src.</summary>
    public static _AVPacket* av_packet_clone(_AVPacket* @src) => vectors.av_packet_clone(@src);
    ...
    public static int av_packet_copy_props(_AVPacket* @dst, _AVPacket* @src) => vectors.av_packet_copy_props(@dst, @src);
    ...
    public static void av_packet_free(_AVPacket** @pkt) => vectors.av_packet_free(@pkt);
    
    /// <summary>Convenience function to free all the side data stored. All the other fields stay untouched.</summary>
    /// <param name="pkt">packet</param>
    public static void av_packet_free_side_data(_AVPacket* @pkt) => vectors.av_packet_free_side_data(@pkt);
    ...
    public static int av_packet_from_data(_AVPacket* @pkt, byte* @data, int @size) => vectors.av_packet_from_data(@pkt, @data, @size);
    ...
    public static byte* av_packet_get_side_data(_AVPacket* @pkt, _AVPacketSideDataType @type, ulong* @size) => vectors.av_packet_get_side_data(@pkt, @type, @size);
    ...
    public static int av_packet_make_refcounted(_AVPacket* @pkt) => vectors.av_packet_make_refcounted(@pkt);
    ...
    public static int av_packet_make_writable(_AVPacket* @pkt) => vectors.av_packet_make_writable(@pkt);
    
    /// <summary>Move every field in src to dst and reset src.</summary>
    /// <param name="dst">Destination packet</param>
    /// <param name="src">Source packet, will be reset</param>
    public static void av_packet_move_ref(_AVPacket* @dst, _AVPacket* @src) => vectors.av_packet_move_ref(@dst, @src);
    
    /// <summary>Allocate new information of a packet.</summary>
    /// <param name="pkt">packet</param>
    /// <param name="type">side information type</param>
    /// <param name="size">side information size</param>
    public static byte* av_packet_new_side_data(_AVPacket* @pkt, _AVPacketSideDataType @type, ulong @size) => vectors.av_packet_new_side_data(@pkt, @type, @size);
    ...
    public static byte* av_packet_pack_dictionary(_AVDictionary* @dict, ulong* @size) => vectors.av_packet_pack_dictionary(@dict, @size);
    ...
    /// <param name="src">Source packet</param>
    public static int av_packet_ref(_AVPacket* @dst, _AVPacket* @src) => vectors.av_packet_ref(@dst, @src);
    ...
    public static void av_packet_rescale_ts(_AVPacket* @pkt, _AVRational @tb_src, _AVRational @tb_dst) => vectors.av_packet_rescale_ts(@pkt, @tb_src, @tb_dst);
    
    /// <summary>Shrink the already allocated side data buffer</summary>
    /// <param name="pkt">packet</param>
    /// <param name="type">side information type</param>
    /// <param name="size">new side information size</param>
    public static int av_packet_shrink_side_data(_AVPacket* @pkt, _AVPacketSideDataType @type, ulong @size) => vectors.av_packet_shrink_side_data(@pkt, @type, @size);
    ...
    public static _AVPacketSideData* av_packet_side_data_add(_AVPacketSideData** @sd, int* @nb_sd, _AVPacketSideDataType @type, void* @data, ulong @size, int @flags) => vectors.av_packet_side_data_add(@sd, @nb_sd, @type, @data, @size, @flags);
    
    /// <summary>Convenience function to free all the side data stored in an array, and the array itself.</summary>
    /// <param name="sd">pointer to array of side data to free. Will be set to NULL upon return.</param>
    /// <param name="nb_sd">pointer to an integer containing the number of entries in the array. Will be set to 0 upon return.</param>
    public static void av_packet_side_data_free(_AVPacketSideData** @sd, int* @nb_sd) => vectors.av_packet_side_data_free(@sd, @nb_sd);
    ...
    public static int av_packet_side_data_from_frame(_AVPacketSideData** @sd, int* @nb_sd, _AVFrameSideData* @src, uint @flags) => vectors.av_packet_side_data_from_frame(@sd, @nb_sd, @src, @flags);
    ...
    /// <param name="type">desired side information type</param>
    public static _AVPacketSideData* av_packet_side_data_get(_AVPacketSideData* @sd, int @nb_sd, _AVPacketSideDataType @type) => vectors.av_packet_side_data_get(@sd, @nb_sd, @type);
    
    public static string av_packet_side_data_name(_AVPacketSideDataType @type) => vectors.av_packet_side_data_name(@type);
    
    /// <summary>Allocate a new packet side data.</summary>
    /// <param name="type">side data type</param>
    /// <param name="size">desired side data size</param>
    /// <param name="flags">currently unused. Must be zero</param>
    public static _AVPacketSideData* av_packet_side_data_new(_AVPacketSideData** @psd, int* @pnb_sd, _AVPacketSideDataType @type, ulong @size, int @flags) => vectors.av_packet_side_data_new(@psd, @pnb_sd, @type, @size, @flags);
    ...
    /// <param name="type">side information type</param>
    public static void av_packet_side_data_remove(_AVPacketSideData* @sd, int* @nb_sd, _AVPacketSideDataType @type) => vectors.av_packet_side_data_remove(@sd, @nb_sd, @type);
    ...
    /// <param name="flags">Some combination of AV_FRAME_SIDE_DATA_FLAG_* flags, or 0.</param>
    public static int av_packet_side_data_to_frame(_AVFrameSideData*** @sd, int* @nb_sd, _AVPacketSideData* @src, uint @flags) => vectors.av_packet_side_data_to_frame(@sd, @nb_sd, @src, @flags);
    ...
    public static int av_packet_unpack_dictionary(byte* @data, ulong @size, _AVDictionary** @dict) => vectors.av_packet_unpack_dictionary(@data, @size, @dict);
    
    /// <summary>Wipe the packet.</summary>
    /// <param name="pkt">The packet to be unreferenced.</param>
    public static void av_packet_unref(_AVPacket* @pkt) => vectors.av_packet_unref(@pkt);
    ...
    /// <param name="opaque">a pointer where libavcodec will store the iteration state. Must point to NULL to start the iteration.</param>
    public static _AVCodecParser* av_parser_iterate(void** @opaque) => vectors.av_parser_iterate(@opaque);
    ...
    public static int av_parser_parse2(_AVCodecParserContext* @s, _AVCodecContext* @avctx, byte** @poutbuf, int* @poutbuf_size, byte* @buf, int @buf_size, long @pts, long @dts, long @pos) => vectors.av_parser_parse2(@s, @avctx, @poutbuf, @poutbuf_size, @buf, @buf_size, @pts, @dts, @pos);
    
    /// <summary>Returns number of planes in pix_fmt, a negative AVERROR if pix_fmt is not a valid pixel format.</summary>
    public static int av_pix_fmt_count_planes(_AVPixelFormat @pix_fmt) => vectors.av_pix_fmt_count_planes(@pix_fmt);
    
    /// <summary>Returns a pixel format descriptor for provided pixel format or NULL if this pixel format is unknown.</summary>
    public static _AVPixFmtDescriptor* av_pix_fmt_desc_get(_AVPixelFormat @pix_fmt) => vectors.av_pix_fmt_desc_get(@pix_fmt);
    ...
    public static _AVPixelFormat av_pix_fmt_desc_get_id(_AVPixFmtDescriptor* @desc) => vectors.av_pix_fmt_desc_get_id(@desc);
    ...
    public static _AVPixFmtDescriptor* av_pix_fmt_desc_next(_AVPixFmtDescriptor* @prev) => vectors.av_pix_fmt_desc_next(@prev);
    ...
    public static int av_pix_fmt_get_chroma_sub_sample(_AVPixelFormat @pix_fmt, int* @h_shift, int* @v_shift) => vectors.av_pix_fmt_get_chroma_sub_sample(@pix_fmt, @h_shift, @v_shift);
    
    /// <summary>Utility function to swap the endianness of a pixel format.</summary>
    /// <param name="pix_fmt">the pixel format</param>
    public static _AVPixelFormat av_pix_fmt_swap_endianness(_AVPixelFormat @pix_fmt) => vectors.av_pix_fmt_swap_endianness(@pix_fmt);
    ...
    public static void av_pkt_dump_log2(void* @avcl, int @level, _AVPacket* @pkt, int @dump_payload, _AVStream* @st) => vectors.av_pkt_dump_log2(@avcl, @level, @pkt, @dump_payload, @st);
    ...
    /// <param name="dump_payload">True if the payload must be displayed, too.</param>
    /// <param name="st">AVStream that the packet belongs to</param>
    public static void av_pkt_dump2(__iobuf* @f, _AVPacket* @pkt, int @dump_payload, _AVStream* @st) => vectors.av_pkt_dump2(@f, @pkt, @dump_payload, @st);
    ...
    public static _AVInputFormat* av_probe_input_format(_AVProbeData* @pd, int @is_opened) => vectors.av_probe_input_format(@pd, @is_opened);
    ...
    public static _AVInputFormat* av_probe_input_format2(_AVProbeData* @pd, int @is_opened, int* @score_max) => vectors.av_probe_input_format2(@pd, @is_opened, @score_max);
    ...
    public static uint av_q2intfloat(_AVRational @q) => vectors.av_q2intfloat(@q);
    ...
    public static int av_read_frame(_AVFormatContext* @s, _AVPacket* @pkt) => vectors.av_read_frame(@s, @pkt);
    
    public static void av_read_image_line(ushort* @dst, in byte_ptrArray4 @data, in int_array4 @linesize, _AVPixFmtDescriptor* @desc, int @x, int @y, int @c, int @w, int @read_pal_component) => vectors.av_read_image_line(@dst, @data, @linesize, @desc, @x, @y, @c, @w, @read_pal_component);
    ...
    public static void av_read_image_line2(void* @dst, in byte_ptrArray4 @data, in int_array4 @linesize, _AVPixFmtDescriptor* @desc, int @x, int @y, int @c, int @w, int @read_pal_component, int @dst_element_size) => vectors.av_read_image_line2(@dst, @data, @linesize, @desc, @x, @y, @c, @w, @read_pal_component, @dst_element_size);
    
    /// <summary>Pause a network-based stream (e.g. RTSP stream).</summary>
    public static int av_read_pause(_AVFormatContext* @s) => vectors.av_read_pause(@s);
    
    /// <summary>Start playing a network-based stream (e.g. RTSP stream) at the current position.</summary>
    public static int av_read_play(_AVFormatContext* @s) => vectors.av_read_play(@s);
    ...
    public static long av_rescale_delta(_AVRational @in_tb, long @in_ts, _AVRational @fs_tb, int @duration, long* @last, _AVRational @out_tb) => vectors.av_rescale_delta(@in_tb, @in_ts, @fs_tb, @duration, @last, @out_tb);
    
    /// <summary>Rescale a 64-bit integer by 2 rational numbers.</summary>
    public static long av_rescale_q(long @a, _AVRational @bq, _AVRational @cq) => vectors.av_rescale_q(@a, @bq, @cq);
    
    /// <summary>Rescale a 64-bit integer by 2 rational numbers with specified rounding.</summary>
    public static long av_rescale_q_rnd(long @a, _AVRational @bq, _AVRational @cq, _AVRounding @rnd) => vectors.av_rescale_q_rnd(@a, @bq, @cq, @rnd);
    
    /// <summary>Rescale a 64-bit integer with specified rounding.</summary>
    public static long av_rescale_rnd(long @a, long @b, long @c, _AVRounding @rnd) => vectors.av_rescale_rnd(@a, @b, @c, @rnd);
    
    /// <summary>Check if the sample format is planar.</summary>
    /// <param name="sample_fmt">the sample format to inspect</param>
    public static int av_sample_fmt_is_planar(_AVSampleFormat @sample_fmt) => vectors.av_sample_fmt_is_planar(@sample_fmt);
    ...
    public static int av_samples_alloc(byte** @audio_data, int* @linesize, int @nb_channels, int @nb_samples, _AVSampleFormat @sample_fmt, int @align) => vectors.av_samples_alloc(@audio_data, @linesize, @nb_channels, @nb_samples, @sample_fmt, @align);
    ...
    public static int av_samples_alloc_array_and_samples(byte*** @audio_data, int* @linesize, int @nb_channels, int @nb_samples, _AVSampleFormat @sample_fmt, int @align) => vectors.av_samples_alloc_array_and_samples(@audio_data, @linesize, @nb_channels, @nb_samples, @sample_fmt, @align);
    ...
    public static int av_samples_copy(byte** @dst, byte** @src, int @dst_offset, int @src_offset, int @nb_samples, int @nb_channels, _AVSampleFormat @sample_fmt) => vectors.av_samples_copy(@dst, @src, @dst_offset, @src_offset, @nb_samples, @nb_channels, @sample_fmt);
    ...
    /// <param name="sample_fmt">the sample format</param>
    /// <param name="align">buffer size alignment (0 = default, 1 = no alignment)</param>
    public static int av_samples_fill_arrays(byte** @audio_data, int* @linesize, byte* @buf, int @nb_channels, int @nb_samples, _AVSampleFormat @sample_fmt, int @align) => vectors.av_samples_fill_arrays(@audio_data, @linesize, @buf, @nb_channels, @nb_samples, @sample_fmt, @align);
    ...
    /// <param name="sample_fmt">the sample format</param>
    /// <param name="align">buffer size alignment (0 = default, 1 = no alignment)</param>
    public static int av_samples_get_buffer_size(int* @linesize, int @nb_channels, int @nb_samples, _AVSampleFormat @sample_fmt, int @align) => vectors.av_samples_get_buffer_size(@linesize, @nb_channels, @nb_samples, @sample_fmt, @align);
    ...
    /// <param name="nb_channels">number of audio channels</param>
    /// <param name="sample_fmt">audio sample format</param>
    public static int av_samples_set_silence(byte** @audio_data, int @offset, int @nb_samples, int @nb_channels, _AVSampleFormat @sample_fmt) => vectors.av_samples_set_silence(@audio_data, @offset, @nb_samples, @nb_channels, @sample_fmt);
    ...
    public static int av_sdp_create(_AVFormatContext** @ac, int @n_files, byte* @buf, int @size) => vectors.av_sdp_create(@ac, @n_files, @buf, @size);
    ...
    public static int av_seek_frame(_AVFormatContext* @s, int @stream_index, long @timestamp, int @flags) => vectors.av_seek_frame(@s, @stream_index, @timestamp, @flags);
    ...
    public static void av_shrink_packet(_AVPacket* @pkt, int @size) => vectors.av_shrink_packet(@pkt, @size);
    ...
    public static _AVClass* av_stream_group_get_class() => vectors.av_stream_group_get_class();
    ...
    /// <param name="b">First rational</param>
    /// <param name="c">Second rational</param>
    public static _AVRational av_sub_q(_AVRational @b, _AVRational @c) => vectors.av_sub_q(@b, @c);
    ...
    public static int av_timecode_check_frame_rate(_AVRational @rate) => vectors.av_timecode_check_frame_rate(@rate);
    ...
    public static uint av_timecode_get_smpte(_AVRational @rate, int @drop, int @hh, int @mm, int @ss, int @ff) => vectors.av_timecode_get_smpte(@rate, @drop, @hh, @mm, @ss, @ff);
    ...
    public static uint av_timecode_get_smpte_from_framenum(_AVTimecode* @tc, int @framenum) => vectors.av_timecode_get_smpte_from_framenum(@tc, @framenum);
    ...
    public static int av_timecode_init(_AVTimecode* @tc, _AVRational @rate, int @flags, int @frame_start, void* @log_ctx) => vectors.av_timecode_init(@tc, @rate, @flags, @frame_start, @log_ctx);
    ...
    /// <param name="log_ctx">a pointer to an arbitrary struct of which the first field is a pointer to an AVClass struct (used for av_log)</param>
    public static int av_timecode_init_from_components(_AVTimecode* @tc, _AVRational @rate, int @flags, int @hh, int @mm, int @ss, int @ff, void* @log_ctx) => vectors.av_timecode_init_from_components(@tc, @rate, @flags, @hh, @mm, @ss, @ff, @log_ctx);
    ...
    public static byte* av_timecode_make_smpte_tc_string2(byte* @buf, _AVRational @rate, uint @tcsmpte, int @prevent_df, int @skip_field) => vectors.av_timecode_make_smpte_tc_string2(@buf, @rate, @tcsmpte, @prevent_df, @skip_field);
    
    /// <summary>Load timecode string in buf.</summary>
    /// <param name="tc">timecode data correctly initialized</param>
    /// <param name="buf">destination buffer, must be at least AV_TIMECODE_STR_SIZE long</param>
    /// <param name="framenum">frame number</param>
    public static byte* av_timecode_make_string(_AVTimecode* @tc, byte* @buf, int @framenum) => vectors.av_timecode_make_string(@tc, @buf, @framenum);
    
    public static void av_tree_destroy(_AVTreeNode* @t) => vectors.av_tree_destroy(@t);
    ...
    public static void av_tree_enumerate(_AVTreeNode* @t, void* @opaque, av_tree_enumerate_cmp_func @cmp, av_tree_enumerate_enu_func @enu) => vectors.av_tree_enumerate(@t, @opaque, @cmp, @enu);
    ...
    public static void* av_tree_find(_AVTreeNode* @root, void* @key, av_tree_find_cmp_func @cmp, ref void_ptrArray2 @next) => vectors.av_tree_find(@root, @key, @cmp, ref @next);
    ...
    public static void* av_tree_insert(_AVTreeNode** @rootp, void* @key, av_tree_insert_cmp_func @cmp, _AVTreeNode** @next) => vectors.av_tree_insert(@rootp, @key, @cmp, @next);
    
    /// <summary>Allocate an AVTreeNode.</summary>
    public static _AVTreeNode* av_tree_node_alloc() => vectors.av_tree_node_alloc();
    ...
    public static int av_write_frame(_AVFormatContext* @s, _AVPacket* @pkt) => vectors.av_write_frame(@s, @pkt);
    
    public static void av_write_image_line(ushort* @src, ref byte_ptrArray4 @data, in int_array4 @linesize, _AVPixFmtDescriptor* @desc, int @x, int @y, int @c, int @w) => vectors.av_write_image_line(@src, ref @data, @linesize, @desc, @x, @y, @c, @w);
    ...
    public static void av_write_image_line2(void* @src, ref byte_ptrArray4 @data, in int_array4 @linesize, _AVPixFmtDescriptor* @desc, int @x, int @y, int @c, int @w, int @src_element_size) => vectors.av_write_image_line2(@src, ref @data, @linesize, @desc, @x, @y, @c, @w, @src_element_size);
    
    /// <summary>Write the stream trailer to an output media file and free the file private data.</summary>
    /// <param name="s">media file handle</param>
    public static int av_write_trailer(_AVFormatContext* @s) => vectors.av_write_trailer(@s);
    
    /// <summary>Write an uncoded frame to an output media file.</summary>
    public static int av_write_uncoded_frame(_AVFormatContext* @s, int @stream_index, _AVFrame* @frame) => vectors.av_write_uncoded_frame(@s, @stream_index, @frame);
    
    /// <summary>Test whether a muxer supports uncoded frame.</summary>
    public static int av_write_uncoded_frame_query(_AVFormatContext* @s, int @stream_index) => vectors.av_write_uncoded_frame_query(@s, @stream_index);
    ...
    public static void avcodec_align_dimensions(_AVCodecContext* @s, int* @width, int* @height) => vectors.avcodec_align_dimensions(@s, @width, @height);
    ...
    public static void avcodec_align_dimensions2(_AVCodecContext* @s, int* @width, int* @height, ref int_array8 @linesize_align) => vectors.avcodec_align_dimensions2(@s, @width, @height, ref @linesize_align);
    ...
    public static _AVCodecContext* avcodec_alloc_context3(_AVCodec* @codec) => vectors.avcodec_alloc_context3(@codec);
    ...
    public static int avcodec_decode_subtitle2(_AVCodecContext* @avctx, _AVSubtitle* @sub, int* @got_sub_ptr, _AVPacket* @avpkt) => vectors.avcodec_decode_subtitle2(@avctx, @sub, @got_sub_ptr, @avpkt);
    
    public static int avcodec_default_execute(_AVCodecContext* @c, avcodec_default_execute_func_func @func, void* @arg, int* @ret, int @count, int @size) => vectors.avcodec_default_execute(@c, @func, @arg, @ret, @count, @size);
    
    public static int avcodec_default_execute2(_AVCodecContext* @c, avcodec_default_execute2_func_func @func, void* @arg, int* @ret, int @count) => vectors.avcodec_default_execute2(@c, @func, @arg, @ret, @count);
    ...
    public static int avcodec_default_get_buffer2(_AVCodecContext* @s, _AVFrame* @frame, int @flags) => vectors.avcodec_default_get_buffer2(@s, @frame, @flags);
    ...
    public static int avcodec_default_get_encode_buffer(_AVCodecContext* @s, _AVPacket* @pkt, int @flags) => vectors.avcodec_default_get_encode_buffer(@s, @pkt, @flags);
    
    public static _AVPixelFormat avcodec_default_get_format(_AVCodecContext* @s, _AVPixelFormat* @fmt) => vectors.avcodec_default_get_format(@s, @fmt);
    
    /// <summary>Returns descriptor for given codec ID or NULL if no descriptor exists.</summary>
    public static _AVCodecDescriptor* avcodec_descriptor_get(_AVCodecID @id) => vectors.avcodec_descriptor_get(@id);
    ...
    /// <summary>@{</summary>
    public static int avcodec_encode_subtitle(_AVCodecContext* @avctx, byte* @buf, int @buf_size, _AVSubtitle* @sub) => vectors.avcodec_encode_subtitle(@avctx, @buf, @buf_size, @sub);
    ...
    public static int avcodec_fill_audio_frame(_AVFrame* @frame, int @nb_channels, _AVSampleFormat @sample_fmt, byte* @buf, int @buf_size, int @align) => vectors.avcodec_fill_audio_frame(@frame, @nb_channels, @sample_fmt, @buf, @buf_size, @align);
    ...
    public static _AVPixelFormat avcodec_find_best_pix_fmt_of_list(_AVPixelFormat* @pix_fmt_list, _AVPixelFormat @src_pix_fmt, int @has_alpha, int* @loss_ptr) => vectors.avcodec_find_best_pix_fmt_of_list(@pix_fmt_list, @src_pix_fmt, @has_alpha, @loss_ptr);
    
    /// <summary>Find a registered decoder with a matching codec ID.</summary>
    /// <param name="id">AVCodecID of the requested decoder</param>
    public static _AVCodec* avcodec_find_decoder(_AVCodecID @id) => vectors.avcodec_find_decoder(@id);
    ...
    public static void avcodec_free_context(_AVCodecContext** @avctx) => vectors.avcodec_free_context(@avctx);
    ...
    public static _AVClass* avcodec_get_class() => vectors.avcodec_get_class();
    
    /// <summary>Retrieve supported hardware configurations for a codec.</summary>
    public static _AVCodecHWConfig* avcodec_get_hw_config(_AVCodec* @codec, int @index) => vectors.avcodec_get_hw_config(@codec, @index);
    ...
    public static int avcodec_get_hw_frames_parameters(_AVCodecContext* @avctx, _AVBufferRef* @device_ref, _AVPixelFormat @hw_pix_fmt, _AVBufferRef** @out_frames_ref) => vectors.avcodec_get_hw_frames_parameters(@avctx, @device_ref, @hw_pix_fmt, @out_frames_ref);
    
    /// <summary>Get the name of a codec.</summary>
    public static string avcodec_get_name(_AVCodecID @id) => vectors.avcodec_get_name(@id);
    ...
    public static _AVClass* avcodec_get_subtitle_rect_class() => vectors.avcodec_get_subtitle_rect_class();
    ...
    public static int avcodec_get_supported_config(_AVCodecContext* @avctx, _AVCodec* @codec, _AVCodecConfig @config, uint @flags, void** @out_configs, int* @out_num_configs) => vectors.avcodec_get_supported_config(@avctx, @codec, @config, @flags, @out_configs, @out_num_configs);
    
    /// <summary>Get the type of the given codec.</summary>
    public static _AVMediaType avcodec_get_type(_AVCodecID @codec_id) => vectors.avcodec_get_type(@codec_id);
    
    /// <summary>Returns a positive value if s is open (i.e. avcodec_open2() was called on it), 0 otherwise.</summary>
    public static int avcodec_is_open(_AVCodecContext* @s) => vectors.avcodec_is_open(@s);
    ...
    public static int avcodec_parameters_from_context(_AVCodecParameters* @par, _AVCodecContext* @codec) => vectors.avcodec_parameters_from_context(@par, @codec);
    ...
    public static int avcodec_parameters_to_context(_AVCodecContext* @codec, _AVCodecParameters* @par) => vectors.avcodec_parameters_to_context(@codec, @par);
    ...
    public static uint avcodec_pix_fmt_to_codec_tag(_AVPixelFormat @pix_fmt) => vectors.avcodec_pix_fmt_to_codec_tag(@pix_fmt);
    
    /// <summary>Return a name for the specified profile, if available.</summary>
    /// <param name="codec_id">the ID of the codec to which the requested profile belongs</param>
    /// <param name="profile">the profile value for which a name is requested</param>
    public static string avcodec_profile_name(_AVCodecID @codec_id, int @profile) => vectors.avcodec_profile_name(@codec_id, @profile);
    
    /// <summary>Alias for `avcodec_receive_frame_flags(avctx, frame, 0)`.</summary>
    public static int avcodec_receive_frame(_AVCodecContext* @avctx, _AVFrame* @frame) => vectors.avcodec_receive_frame(@avctx, @frame);
    ...
    public static int avcodec_receive_frame_flags(_AVCodecContext* @avctx, _AVFrame* @frame, uint @flags) => vectors.avcodec_receive_frame_flags(@avctx, @frame, @flags);
    ...
    public static int avcodec_receive_packet(_AVCodecContext* @avctx, _AVPacket* @avpkt) => vectors.avcodec_receive_packet(@avctx, @avpkt);
    ...
    public static int avcodec_send_frame(_AVCodecContext* @avctx, _AVFrame* @frame) => vectors.avcodec_send_frame(@avctx, @frame);
    ...
    public static int avcodec_send_packet(_AVCodecContext* @avctx, _AVPacket* @avpkt) => vectors.avcodec_send_packet(@avctx, @avpkt);
    
    /// <summary>@}</summary>
    public static void avcodec_string(byte* @buf, int @buf_size, _AVCodecContext* @enc, int @encode) => vectors.avcodec_string(@buf, @buf_size, @enc, @encode);
    ...
    public static int avdevice_app_to_dev_control_message(_AVFormatContext* @s, _AVAppToDevMessageType @type, void* @data, ulong @data_size) => vectors.avdevice_app_to_dev_control_message(@s, @type, @data, @data_size);
    ...
    /// <param name="data_size">size of message data.</param>
    public static int avdevice_dev_to_app_control_message(_AVFormatContext* @s, _AVDevToAppMessageType @type, void* @data, ulong @data_size) => vectors.avdevice_dev_to_app_control_message(@s, @type, @data, @data_size);
    ...
    public static void avdevice_free_list_devices(_AVDeviceInfoList** @device_list) => vectors.avdevice_free_list_devices(@device_list);
    ...
    public static int avdevice_list_devices(_AVFormatContext* @s, _AVDeviceInfoList** @device_list) => vectors.avdevice_list_devices(@s, @device_list);
    ...
    public static uint avfilter_filter_pad_count(_AVFilter* @filter, int @is_output) => vectors.avfilter_filter_pad_count(@filter, @is_output);
    ...
    public static void avfilter_free(_AVFilterContext* @filter) => vectors.avfilter_free(@filter);
    ...
    /// <summary>Allocate a filter graph.</summary>
    public static _AVFilterGraph* avfilter_graph_alloc() => vectors.avfilter_graph_alloc();
    ...
    /// <param name="graphctx">the filter graph</param>
    /// <param name="log_ctx">context used for logging</param>
    public static int avfilter_graph_config(_AVFilterGraph* @graphctx, void* @log_ctx) => vectors.avfilter_graph_config(@graphctx, @log_ctx);
    ...
    public static int avfilter_graph_parse(_AVFilterGraph* @graph, string @filters, _AVFilterInOut* @inputs, _AVFilterInOut* @outputs, void* @log_ctx) => vectors.avfilter_graph_parse(@graph, @filters, @inputs, @outputs, @log_ctx);
    ...
    public static int avfilter_graph_segment_apply(_AVFilterGraphSegment* @seg, int @flags, _AVFilterInOut** @inputs, _AVFilterInOut** @outputs) => vectors.avfilter_graph_segment_apply(@seg, @flags, @inputs, @outputs);
    
    /// <summary>Apply parsed options to filter instances in a graph segment.</summary>
    /// <param name="seg">the filtergraph segment to process</param>
    /// <param name="flags">reserved for future use, caller must set to 0 for now</param>
    public static int avfilter_graph_segment_apply_opts(_AVFilterGraphSegment* @seg, int @flags) => vectors.avfilter_graph_segment_apply_opts(@seg, @flags);
    
    /// <summary>Create filters specified in a graph segment.</summary>
    /// <param name="seg">the filtergraph segment to process</param>
    /// <param name="flags">reserved for future use, caller must set to 0 for now</param>
    public static int avfilter_graph_segment_create_filters(_AVFilterGraphSegment* @seg, int @flags) => vectors.avfilter_graph_segment_create_filters(@seg, @flags);
    ...
    public static void avfilter_graph_segment_free(_AVFilterGraphSegment** @seg) => vectors.avfilter_graph_segment_free(@seg);
    
    /// <summary>Initialize all filter instances in a graph segment.</summary>
    /// <param name="seg">the filtergraph segment to process</param>
    /// <param name="flags">reserved for future use, caller must set to 0 for now</param>
    public static int avfilter_graph_segment_init(_AVFilterGraphSegment* @seg, int @flags) => vectors.avfilter_graph_segment_init(@seg, @flags);
    ...
    public static int avfilter_graph_segment_link(_AVFilterGraphSegment* @seg, int @flags, _AVFilterInOut** @inputs, _AVFilterInOut** @outputs) => vectors.avfilter_graph_segment_link(@seg, @flags, @inputs, @outputs);
    ...
    public static void avfilter_graph_set_auto_convert(_AVFilterGraph* @graph, uint @flags) => vectors.avfilter_graph_set_auto_convert(@graph, @flags);
    
    /// <summary>Initialize a filter with the supplied dictionary of options.</summary>
    /// <param name="ctx">uninitialized filter context to initialize</param>
    /// <param name="options">An AVDictionary filled with options for this filter. On return this parameter will be destroyed and replaced with a dict containing options that were not found. This dictionary must be freed by the caller. May be NULL, then this function is equivalent to avfilter_init_str() with the second parameter set to NULL.</param>
    public static int avfilter_init_dict(_AVFilterContext* @ctx, _AVDictionary** @options) => vectors.avfilter_init_dict(@ctx, @options);
    ...
    public static void avfilter_inout_free(_AVFilterInOut** @inout) => vectors.avfilter_inout_free(@inout);
    ...
    public static int avfilter_insert_filter(_AVFilterLink* @link, _AVFilterContext* @filt, uint @filt_srcpad_idx, uint @filt_dstpad_idx) => vectors.avfilter_insert_filter(@link, @filt, @filt_srcpad_idx, @filt_dstpad_idx);
    ...
    /// <param name="dst">the destination filter</param>
    /// <param name="dstpad">index of the input pad on the destination filter</param>
    public static int avfilter_link(_AVFilterContext* @src, uint @srcpad, _AVFilterContext* @dst, uint @dstpad) => vectors.avfilter_link(@src, @srcpad, @dst, @dstpad);
    
    /// <summary>Get the hardware frames context of a filter link.</summary>
    /// <param name="link">an AVFilterLink</param>
    public static _AVBufferRef* avfilter_link_get_hw_frames_ctx(_AVFilterLink* @link) => vectors.avfilter_link_get_hw_frames_ctx(@link);
    
    /// <summary>Get the name of an AVFilterPad.</summary>
    /// <param name="pads">an array of AVFilterPads</param>
    /// <param name="pad_idx">index of the pad in the array; it is the caller&apos;s responsibility to ensure the index is valid</param>
    public static string avfilter_pad_get_name(_AVFilterPad* @pads, int @pad_idx) => vectors.avfilter_pad_get_name(@pads, @pad_idx);
    
    /// <summary>Get the type of an AVFilterPad.</summary>
    /// <param name="pads">an array of AVFilterPads</param>
    /// <param name="pad_idx">index of the pad in the array; it is the caller&apos;s responsibility to ensure the index is valid</param>
    public static _AVMediaType avfilter_pad_get_type(_AVFilterPad* @pads, int @pad_idx) => vectors.avfilter_pad_get_type(@pads, @pad_idx);
    ...
    public static _AVFormatContext* avformat_alloc_context() => vectors.avformat_alloc_context();
    ...
    public static int avformat_find_stream_info(_AVFormatContext* @ic, _AVDictionary** @options) => vectors.avformat_find_stream_info(@ic, @options);
    ...
    /// <param name="s">media file handle</param>
    public static int avformat_flush(_AVFormatContext* @s) => vectors.avformat_flush(@s);
    
    /// <summary>Free an AVFormatContext and all its streams.</summary>
    /// <param name="s">context to free</param>
    public static void avformat_free_context(_AVFormatContext* @s) => vectors.avformat_free_context(@s);
    ...
    public static _AVClass* avformat_get_class() => vectors.avformat_get_class();
    
    /// <summary>Returns the table mapping MOV FourCCs for audio to AVCodecID.</summary>
    public static _AVCodecTag* avformat_get_mov_audio_tags() => vectors.avformat_get_mov_audio_tags();
    
    /// <summary>Returns the table mapping MOV FourCCs for video to libavcodec AVCodecID.</summary>
    public static _AVCodecTag* avformat_get_mov_video_tags() => vectors.avformat_get_mov_video_tags();
    
    /// <summary>Returns the table mapping RIFF FourCCs for audio to AVCodecID.</summary>
    public static _AVCodecTag* avformat_get_riff_audio_tags() => vectors.avformat_get_riff_audio_tags();
    ...
    public static _AVCodecTag* avformat_get_riff_video_tags() => vectors.avformat_get_riff_video_tags();
    
    /// <summary>Get the index entry count for the given AVStream.</summary>
    /// <param name="st">stream</param>
    public static int avformat_index_get_entries_count(_AVStream* @st) => vectors.avformat_index_get_entries_count(@st);
    ...
    public static _AVIndexEntry* avformat_index_get_entry(_AVStream* @st, int @idx) => vectors.avformat_index_get_entry(@st, @idx);
    ...
    public static _AVIndexEntry* avformat_index_get_entry_from_timestamp(_AVStream* @st, long @wanted_timestamp, int @flags) => vectors.avformat_index_get_entry_from_timestamp(@st, @wanted_timestamp, @flags);
    ...
    public static int avformat_init_output(_AVFormatContext* @s, _AVDictionary** @options) => vectors.avformat_init_output(@s, @options);
    ...
    public static _AVStream* avformat_new_stream(_AVFormatContext* @s, _AVCodec* @c) => vectors.avformat_new_stream(@s, @c);
    ...
    public static int avformat_query_codec(_AVOutputFormat* @ofmt, _AVCodecID @codec_id, int @std_compliance) => vectors.avformat_query_codec(@ofmt, @codec_id, @std_compliance);
    
    public static int avformat_queue_attached_pictures(_AVFormatContext* @s) => vectors.avformat_queue_attached_pictures(@s);
    ...
    public static int avformat_receive_command_reply(_AVFormatContext* @s, _AVFormatCommandID @id, void** @data_out) => vectors.avformat_receive_command_reply(@s, @id, @data_out);
    ...
    public static int avformat_seek_file(_AVFormatContext* @s, int @stream_index, long @min_ts, long @ts, long @max_ts, int @flags) => vectors.avformat_seek_file(@s, @stream_index, @min_ts, @ts, @max_ts, @flags);
    ...
    public static int avformat_send_command(_AVFormatContext* @s, _AVFormatCommandID @id, void* @data) => vectors.avformat_send_command(@s, @id, @data);
    ...
    public static int avformat_stream_group_add_stream(_AVStreamGroup* @stg, _AVStream* @st) => vectors.avformat_stream_group_add_stream(@stg, @st);
    
    /// <summary>Add a new empty stream group to a media file.</summary>
    /// <param name="s">media file handle</param>
    public static _AVStreamGroup* avformat_stream_group_create(_AVFormatContext* @s, _AVStreamGroupParamsType @type, _AVDictionary** @options) => vectors.avformat_stream_group_create(@s, @type, @options);
    ...
    /// <param name="s">Media file handle, must be allocated with avformat_alloc_context(). Its &quot;oformat&quot; field must be set to the desired output format; Its &quot;pb&quot; field must be set to an already opened ::AVIOContext.</param>
    /// <param name="options">An ::AVDictionary filled with AVFormatContext and muxer-private options. On return this parameter will be destroyed and replaced with a dict containing options that were not found. May be NULL.</param>
    public static int avformat_write_header(_AVFormatContext* @s, _AVDictionary** @options) => vectors.avformat_write_header(@s, @options);
    ...
    public static int avio_accept(_AVIOContext* @s, _AVIOContext** @c) => vectors.avio_accept(@s, @c);
    ...
    public static int avio_close_dir(_AVIODirContext** @s) => vectors.avio_close_dir(@s);
    ...
    public static int avio_close_dyn_buf(_AVIOContext* @s, byte** @pbuffer) => vectors.avio_close_dyn_buf(@s, @pbuffer);
    ...
    public static int avio_closep(_AVIOContext** @s) => vectors.avio_closep(@s);
    ...
    public static void avio_context_free(_AVIOContext** @s) => vectors.avio_context_free(@s);
    ...
    public static int avio_feof(_AVIOContext* @s) => vectors.avio_feof(@s);
    ...
    public static void avio_free_directory_entry(_AVIODirEntry** @entry) => vectors.avio_free_directory_entry(@entry);
    ...
    /// <param name="s">IO context</param>
    /// <param name="pbuffer">pointer to a byte buffer</param>
    public static int avio_get_dyn_buf(_AVIOContext* @s, byte** @pbuffer) => vectors.avio_get_dyn_buf(@s, @pbuffer);
    ...
    public static int avio_get_str(_AVIOContext* @pb, int @maxlen, byte* @buf, int @buflen) => vectors.avio_get_str(@pb, @maxlen, @buf, @buflen);
    
    public static int avio_get_str16be(_AVIOContext* @pb, int @maxlen, byte* @buf, int @buflen) => vectors.avio_get_str16be(@pb, @maxlen, @buf, @buflen);
    ...
    public static int avio_get_str16le(_AVIOContext* @pb, int @maxlen, byte* @buf, int @buflen) => vectors.avio_get_str16le(@pb, @maxlen, @buf, @buflen);
    ...
    public static int avio_handshake(_AVIOContext* @c) => vectors.avio_handshake(@c);
    ...
    public static int avio_open_dyn_buf(_AVIOContext** @s) => vectors.avio_open_dyn_buf(@s);
    ...
    public static int avio_pause(_AVIOContext* @h, int @pause) => vectors.avio_pause(@h, @pause);
    ...
    public static void avio_print_string_array(_AVIOContext* @s, byte*[] @strings) => vectors.avio_print_string_array(@s, @strings);
    
    /// <summary>Write a NULL terminated array of strings to the context. Usually you don&apos;t need to use this function directly but its macro wrapper, avio_print.</summary>
    public static void avio_print_string_array(_AVIOContext* @s, byte** @strings) => vectors.avio_print_string_array_ptr(@s, @strings);
    ...
    public static uint avio_rb16(_AVIOContext* @s) => vectors.avio_rb16(@s);
    
    public static uint avio_rb24(_AVIOContext* @s) => vectors.avio_rb24(@s);
    
    public static uint avio_rb32(_AVIOContext* @s) => vectors.avio_rb32(@s);
    
    public static ulong avio_rb64(_AVIOContext* @s) => vectors.avio_rb64(@s);
    
    /// <summary>Read size bytes from AVIOContext into buf.</summary>
    public static int avio_read(_AVIOContext* @s, byte* @buf, int @size) => vectors.avio_read(@s, @buf, @size);
    
    /// <summary>Get next directory entry.</summary>
    /// <param name="s">directory read context.</param>
    /// <param name="next">next entry or NULL when no more entries.</param>
    public static int avio_read_dir(_AVIODirContext* @s, _AVIODirEntry** @next) => vectors.avio_read_dir(@s, @next);
    ...
    public static int avio_read_partial(_AVIOContext* @s, byte* @buf, int @size) => vectors.avio_read_partial(@s, @buf, @size);
    
    /// <summary>Read contents of h into print buffer, up to max_size bytes, or up to EOF.</summary>
    public static int avio_read_to_bprint(_AVIOContext* @h, _AVBPrint* @pb, ulong @max_size) => vectors.avio_read_to_bprint(@h, @pb, @max_size);
    
    public static uint avio_rl16(_AVIOContext* @s) => vectors.avio_rl16(@s);
    
    public static uint avio_rl24(_AVIOContext* @s) => vectors.avio_rl24(@s);
    
    public static uint avio_rl32(_AVIOContext* @s) => vectors.avio_rl32(@s);
    
    public static ulong avio_rl64(_AVIOContext* @s) => vectors.avio_rl64(@s);
    
    /// <summary>fseek() equivalent for AVIOContext.</summary>
    public static long avio_seek(_AVIOContext* @s, long @offset, int @whence) => vectors.avio_seek(@s, @offset, @whence);
    ...
    public static long avio_seek_time(_AVIOContext* @h, int @stream_index, long @timestamp, int @flags) => vectors.avio_seek_time(@h, @stream_index, @timestamp, @flags);
    
    /// <summary>Get the filesize.</summary>
    public static long avio_size(_AVIOContext* @s) => vectors.avio_size(@s);
    
    /// <summary>Skip given number of bytes forward</summary>
    public static long avio_skip(_AVIOContext* @s, long @offset) => vectors.avio_skip(@s, @offset);
    ...
    public static void avio_wb16(_AVIOContext* @s, uint @val) => vectors.avio_wb16(@s, @val);
    
    public static void avio_wb24(_AVIOContext* @s, uint @val) => vectors.avio_wb24(@s, @val);
    
    public static void avio_wb32(_AVIOContext* @s, uint @val) => vectors.avio_wb32(@s, @val);
    
    public static void avio_wb64(_AVIOContext* @s, ulong @val) => vectors.avio_wb64(@s, @val);
    
    public static void avio_wl16(_AVIOContext* @s, uint @val) => vectors.avio_wl16(@s, @val);
    
    public static void avio_wl24(_AVIOContext* @s, uint @val) => vectors.avio_wl24(@s, @val);
    
    public static void avio_wl32(_AVIOContext* @s, uint @val) => vectors.avio_wl32(@s, @val);
    
    public static void avio_wl64(_AVIOContext* @s, ulong @val) => vectors.avio_wl64(@s, @val);
    
    public static void avio_write(_AVIOContext* @s, byte* @buf, int @size) => vectors.avio_write(@s, @buf, @size);
    ...
    public static void avio_write_marker(_AVIOContext* @s, long @time, _AVIODataMarkerType @type) => vectors.avio_write_marker(@s, @time, @type);
    
    /// <summary>Free all allocated data in the given subtitle struct.</summary>
    /// <param name="sub">AVSubtitle to free.</param>
    public static void avsubtitle_free(_AVSubtitle* @sub) => vectors.avsubtitle_free(@sub);
    ...
    public static _SwrContext* swr_alloc() => vectors.swr_alloc();
    ...
    public static int swr_alloc_set_opts2(_SwrContext** @ps, _AVChannelLayout* @out_ch_layout, _AVSampleFormat @out_sample_fmt, int @out_sample_rate, _AVChannelLayout* @in_ch_layout, _AVSampleFormat @in_sample_fmt, int @in_sample_rate, int @log_offset, void* @log_ctx) => vectors.swr_alloc_set_opts2(@ps, @out_ch_layout, @out_sample_fmt, @out_sample_rate, @in_ch_layout, @in_sample_fmt, @in_sample_rate, @log_offset, @log_ctx);
    ...
    public static int swr_build_matrix2(_AVChannelLayout* @in_layout, _AVChannelLayout* @out_layout, double @center_mix_level, double @surround_mix_level, double @lfe_mix_level, double @maxval, double @rematrix_volume, double* @matrix, long @stride, _AVMatrixEncoding @matrix_encoding, void* @log_context) => vectors.swr_build_matrix2(@in_layout, @out_layout, @center_mix_level, @surround_mix_level, @lfe_mix_level, @maxval, @rematrix_volume, @matrix, @stride, @matrix_encoding, @log_context);
    
    /// <summary>Closes the context so that swr_is_initialized() returns 0.</summary>
    /// <param name="s">Swr context to be closed</param>
    public static void swr_close(_SwrContext* @s) => vectors.swr_close(@s);
    ...
    public static int swr_config_frame(_SwrContext* @swr, _AVFrame* @out, _AVFrame* @in) => vectors.swr_config_frame(@swr, @out, @in);
    ...
    public static int swr_convert(_SwrContext* @s, byte** @out, int @out_count, byte** @in, int @in_count) => vectors.swr_convert(@s, @out, @out_count, @in, @in_count);
    ...
    public static int swr_convert_frame(_SwrContext* @swr, _AVFrame* @output, _AVFrame* @input) => vectors.swr_convert_frame(@swr, @output, @input);
    ...
    public static int swr_drop_output(_SwrContext* @s, int @count) => vectors.swr_drop_output(@s, @count);
    ...
    public static void swr_free(_SwrContext** @s) => vectors.swr_free(@s);
    ...
    public static _AVClass* swr_get_class() => vectors.swr_get_class();
    ...
    public static long swr_get_delay(_SwrContext* @s, long @base) => vectors.swr_get_delay(@s, @base);
    ...
    public static int swr_get_out_samples(_SwrContext* @s, int @in_samples) => vectors.swr_get_out_samples(@s, @in_samples);
    
    /// <summary>Initialize context after user parameters have been set.</summary>
    /// <param name="s">Swr context to initialize</param>
    public static int swr_init(_SwrContext* @s) => vectors.swr_init(@s);
    
    /// <summary>Injects the specified number of silence samples.</summary>
    /// <param name="s">allocated Swr context</param>
    /// <param name="count">number of samples to be dropped</param>
    public static int swr_inject_silence(_SwrContext* @s, int @count) => vectors.swr_inject_silence(@s, @count);
    
    /// <summary>Check whether an swr context has been initialized or not.</summary>
    /// <param name="s">Swr context to check</param>
    public static int swr_is_initialized(_SwrContext* @s) => vectors.swr_is_initialized(@s);
    ...
    public static long swr_next_pts(_SwrContext* @s, long @pts) => vectors.swr_next_pts(@s, @pts);
    ...
    public static int swr_set_channel_mapping(_SwrContext* @s, int* @channel_map) => vectors.swr_set_channel_mapping(@s, @channel_map);
    ...
    public static int swr_set_compensation(_SwrContext* @s, int @sample_delta, int @compensation_distance) => vectors.swr_set_compensation(@s, @sample_delta, @compensation_distance);
    ...
    public static int swr_set_matrix(_SwrContext* @s, double* @matrix, int @stride) => vectors.swr_set_matrix(@s, @matrix, @stride);
    ...
    public static _SwsContext* sws_alloc_context() => vectors.sws_alloc_context();
    
    /// <summary>Allocate and return an uninitialized vector with length coefficients.</summary>
    public static _SwsVector* sws_allocVec(int @length) => vectors.sws_allocVec(@length);
    ...
    public static void sws_frame_end(_SwsContext* @c) => vectors.sws_frame_end(@c);
    ...
    public static int sws_frame_setup(_SwsContext* @ctx, _AVFrame* @dst, _AVFrame* @src) => vectors.sws_frame_setup(@ctx, @dst, @src);
    ...
    public static int sws_frame_start(_SwsContext* @c, _AVFrame* @dst, _AVFrame* @src) => vectors.sws_frame_start(@c, @dst, @src);
    
    /// <summary>Free the context and everything associated with it, and write NULL to the provided pointer.</summary>
    public static void sws_free_context(_SwsContext** @ctx) => vectors.sws_free_context(@ctx);
    
    /// <summary>Free the swscaler context swsContext. If swsContext is NULL, then does nothing.</summary>
    public static void sws_freeContext(_SwsContext* @swsContext) => vectors.sws_freeContext(@swsContext);
    
    public static void sws_freeFilter(_SwsFilter* @filter) => vectors.sws_freeFilter(@filter);
    
    public static void sws_freeVec(_SwsVector* @a) => vectors.sws_freeVec(@a);
    ...
    public static _AVClass* sws_get_class() => vectors.sws_get_class();
    
    /// <summary>Check if context can be reused, otherwise reallocate a new one.</summary>
    public static _SwsContext* sws_getCachedContext(_SwsContext* @context, int @srcW, int @srcH, _AVPixelFormat @srcFormat, int @dstW, int @dstH, _AVPixelFormat @dstFormat, int @flags, _SwsFilter* @srcFilter, _SwsFilter* @dstFilter, double* @param) => vectors.sws_getCachedContext(@context, @srcW, @srcH, @srcFormat, @dstW, @dstH, @dstFormat, @flags, @srcFilter, @dstFilter, @param);
    ...
    public static int sws_getColorspaceDetails(_SwsContext* @c, int** @inv_table, int* @srcRange, int** @table, int* @dstRange, int* @brightness, int* @contrast, int* @saturation) => vectors.sws_getColorspaceDetails(@c, @inv_table, @srcRange, @table, @dstRange, @brightness, @contrast, @saturation);
    ...
    public static _SwsContext* sws_getContext(int @srcW, int @srcH, _AVPixelFormat @srcFormat, int @dstW, int @dstH, _AVPixelFormat @dstFormat, int @flags, _SwsFilter* @srcFilter, _SwsFilter* @dstFilter, double* @param) => vectors.sws_getContext(@srcW, @srcH, @srcFormat, @dstW, @dstH, @dstFormat, @flags, @srcFilter, @dstFilter, @param);
    
    public static _SwsFilter* sws_getDefaultFilter(float @lumaGBlur, float @chromaGBlur, float @lumaSharpen, float @chromaSharpen, float @chromaHShift, float @chromaVShift, int @verbose) => vectors.sws_getDefaultFilter(@lumaGBlur, @chromaGBlur, @lumaSharpen, @chromaSharpen, @chromaHShift, @chromaVShift, @verbose);
    
    /// <summary>Return a normalized Gaussian curve used to filter stuff quality = 3 is high quality, lower is lower quality.</summary>
    public static _SwsVector* sws_getGaussianVec(double @variance, double @quality) => vectors.sws_getGaussianVec(@variance, @quality);
    
    /// <summary>Initialize the swscaler context sws_context.</summary>
    public static int sws_init_context(_SwsContext* @sws_context, _SwsFilter* @srcFilter, _SwsFilter* @dstFilter) => vectors.sws_init_context(@sws_context, @srcFilter, @dstFilter);
    ...
    public static int sws_is_noop(_AVFrame* @dst, _AVFrame* @src) => vectors.sws_is_noop(@dst, @src);
    
    /// <summary>Returns a positive value if an endianness conversion for pix_fmt is supported, 0 otherwise.</summary>
    /// <param name="pix_fmt">the pixel format</param>
    public static int sws_isSupportedEndiannessConversion(_AVPixelFormat @pix_fmt) => vectors.sws_isSupportedEndiannessConversion(@pix_fmt);
    
    /// <summary>Return a positive value if pix_fmt is a supported input format, 0 otherwise.</summary>
    public static int sws_isSupportedInput(_AVPixelFormat @pix_fmt) => vectors.sws_isSupportedInput(@pix_fmt);
    
    /// <summary>Return a positive value if pix_fmt is a supported output format, 0 otherwise.</summary>
    public static int sws_isSupportedOutput(_AVPixelFormat @pix_fmt) => vectors.sws_isSupportedOutput(@pix_fmt);
    
    /// <summary>Scale all the coefficients of a so that their sum equals height.</summary>
    public static void sws_normalizeVec(_SwsVector* @a, double @height) => vectors.sws_normalizeVec(@a, @height);
    ...
    public static int sws_receive_slice(_SwsContext* @c, uint @slice_start, uint @slice_height) => vectors.sws_receive_slice(@c, @slice_start, @slice_height);
    ...
    /// <param name="c">The scaling context</param>
    public static uint sws_receive_slice_alignment(_SwsContext* @c) => vectors.sws_receive_slice_alignment(@c);
    ...
    public static int sws_scale(_SwsContext* @c, byte*[] @srcSlice, int[] @srcStride, int @srcSliceY, int @srcSliceH, byte*[] @dst, int[] @dstStride) => vectors.sws_scale(@c, @srcSlice, @srcStride, @srcSliceY, @srcSliceH, @dst, @dstStride);
    ...
    /// <param name="dst">the array containing the pointers to the planes of the destination image</param>
    /// <param name="dstStride">the array containing the strides for each plane of the destination image</param>
    public static int sws_scale(_SwsContext* @c, byte** @srcSlice, int* @srcStride, int @srcSliceY, int @srcSliceH, byte** @dst, int* @dstStride) => vectors.sws_scale_ptr(@c, @srcSlice, @srcStride, @srcSliceY, @srcSliceH, @dst, @dstStride);
    ...
    public static int sws_scale_frame(_SwsContext* @c, _AVFrame* @dst, _AVFrame* @src) => vectors.sws_scale_frame(@c, @dst, @src);
    
    /// <summary>Scale all the coefficients of a by the scalar value.</summary>
    public static void sws_scaleVec(_SwsVector* @a, double @scalar) => vectors.sws_scaleVec(@a, @scalar);
    ...
    public static int sws_send_slice(_SwsContext* @c, uint @slice_start, uint @slice_height) => vectors.sws_send_slice(@c, @slice_start, @slice_height);
    ...
    public static int sws_setColorspaceDetails(_SwsContext* @c, in int_array4 @inv_table, int @srcRange, in int_array4 @table, int @dstRange, int @brightness, int @contrast, int @saturation) => vectors.sws_setColorspaceDetails(@c, @inv_table, @srcRange, @table, @dstRange, @brightness, @contrast, @saturation);
    ...
    /// <param name="output">If 0, test if compatible with the source/input frame; otherwise, with the destination/output frame.</param>
    public static int sws_test_primaries(_AVColorPrimaries @primaries, int @output) => vectors.sws_test_primaries(@primaries, @output);
    ...
    /// <param name="output">If 0, test if compatible with the source/input frame; otherwise, with the destination/output frame.</param>
    public static int sws_test_transfer(_AVColorTransferCharacteristic @trc, int @output) => vectors.sws_test_transfer(@trc, @output);
