...
public static partial class ffmpeg
{
    ...
    public static unsafe string TAG_TO_STRING(uint tag) => System.Text.Encoding.ASCII.GetString((byte*)&tag, 4);
    ...
    public static TimeSpan av_q2TimeSpan(_AVRational @a) => TimeSpan.FromTicks((long)a.num * 10_000_000 / a.den);
}
