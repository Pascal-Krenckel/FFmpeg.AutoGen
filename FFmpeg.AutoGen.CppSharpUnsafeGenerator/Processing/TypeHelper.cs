...
{
    public static string GetTypeName(Type type) => type switch
    {
    ...
    private static string GetTypeName(TypedefType type) => type.Declaration.Type switch
    {
    ...
    private static string GetTypeName(PrimitiveType type) => type switch
    {
