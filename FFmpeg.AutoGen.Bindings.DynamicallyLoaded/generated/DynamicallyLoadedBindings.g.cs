...
public static unsafe partial class DynamicallyLoadedBindings
{
    ...
    public unsafe static void Initialize()
    {
        ...
        vectors.av_image_alloc = (ref byte_ptr4 @pointers, ref int4 @linesizes, int @w, int @h, _AVPixelFormat @pix_fmt, int @align) =>
        {
        ...
        vectors.av_image_copy = (ref byte_ptr4 @dst_data, in int4 @dst_linesizes, in byte_ptr4 @src_data, in int4 @src_linesizes, _AVPixelFormat @pix_fmt, int @width, int @height) =>
        {
        ...
        vectors.av_image_copy_to_buffer = (byte* @dst, int @dst_size, in byte_ptr4 @src_data, in int4 @src_linesize, _AVPixelFormat @pix_fmt, int @width, int @height, int @align) =>
        {
        ...
        vectors.av_image_copy_uc_from = (ref byte_ptr4 @dst_data, in long4 @dst_linesizes, in byte_ptr4 @src_data, in long4 @src_linesizes, _AVPixelFormat @pix_fmt, int @width, int @height) =>
        {
        ...
        vectors.av_image_fill_arrays = (ref byte_ptr4 @dst_data, ref int4 @dst_linesize, byte* @src, _AVPixelFormat @pix_fmt, int @width, int @height, int @align) =>
        {
        ...
        vectors.av_image_fill_black = (ref byte_ptr4 @dst_data, in long4 @dst_linesize, _AVPixelFormat @pix_fmt, _AVColorRange @range, int @width, int @height) =>
        {
        ...
        vectors.av_image_fill_color = (ref byte_ptr4 @dst_data, in long4 @dst_linesize, _AVPixelFormat @pix_fmt, in uint4 @color, int @width, int @height, int @flags) =>
        {
        ...
        vectors.av_image_fill_linesizes = (ref int4 @linesizes, _AVPixelFormat @pix_fmt, int @width) =>
        {
        ...
        vectors.av_image_fill_max_pixsteps = (ref int4 @max_pixsteps, ref int4 @max_pixstep_comps, _AVPixFmtDescriptor* @pixdesc) =>
        {
        ...
        vectors.av_image_fill_plane_sizes = (ref ulong4 @size, _AVPixelFormat @pix_fmt, int @height, in long4 @linesizes) =>
        {
        ...
        vectors.av_image_fill_pointers = (ref byte_ptr4 @data, _AVPixelFormat @pix_fmt, int @height, byte* @ptr, in int4 @linesizes) =>
        {
        ...
        vectors.av_read_image_line = (ushort* @dst, in byte_ptr4 @data, in int4 @linesize, _AVPixFmtDescriptor* @desc, int @x, int @y, int @c, int @w, int @read_pal_component) =>
        {
        ...
        vectors.av_read_image_line2 = (void* @dst, in byte_ptr4 @data, in int4 @linesize, _AVPixFmtDescriptor* @desc, int @x, int @y, int @c, int @w, int @read_pal_component, int @dst_element_size) =>
        {
        ...
        vectors.av_tree_find = (_AVTreeNode* @root, void* @key, av_tree_find_cmp_func @cmp, ref void_ptr2 @next) =>
        {
        ...
        vectors.av_write_image_line = (ushort* @src, ref byte_ptr4 @data, in int4 @linesize, _AVPixFmtDescriptor* @desc, int @x, int @y, int @c, int @w) =>
        {
        ...
        vectors.av_write_image_line2 = (void* @src, ref byte_ptr4 @data, in int4 @linesize, _AVPixFmtDescriptor* @desc, int @x, int @y, int @c, int @w, int @src_element_size) =>
        {
        ...
        vectors.avcodec_align_dimensions2 = (_AVCodecContext* @s, int* @width, int* @height, ref int8 @linesize_align) =>
        {
        ...
        vectors.sws_setColorspaceDetails = (_SwsContext* @c, in int4 @inv_table, int @srcRange, in int4 @table, int @dstRange, int @brightness, int @contrast, int @saturation) =>
        {
